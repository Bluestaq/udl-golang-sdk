...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *ObservationMonoradarHistoryService) Query(ctx context.Context, query ObservationMonoradarHistoryQueryParams, opts ...option.RequestOption) (res *[]MonoRadarFull, err error) {
	opts = append(r.Options[:], opts...)
