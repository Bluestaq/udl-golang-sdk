...
func (r *SurfaceService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
type SurfaceListResponse struct {
	...
	JSON struct {
		...
		Type                  resp.Field
		ID                    resp.Field
		AltSiteID             resp.Field
		Condition             resp.Field
		CreatedAt             resp.Field
		CreatedBy             resp.Field
		DdtWtKip              resp.Field
		DdtWtKipMod           resp.Field
		DdtWtKipModNote       resp.Field
		DdtWtKn               resp.Field
		DdWtKip               resp.Field
		DdWtKipMod            resp.Field
		DdWtKipModNote        resp.Field
		DdWtKn                resp.Field
		EndLat                resp.Field
		EndLon                resp.Field
		IDSite                resp.Field
		...
		LengthM               resp.Field
		Lighting              resp.Field
		LightsAprch           resp.Field
		LightsCl              resp.Field
		LightsOls             resp.Field
		LightsPapi            resp.Field
		LightsReil            resp.Field
		LightsRwy             resp.Field
		LightsSeqfl           resp.Field
		LightsTdzl            resp.Field
		LightsUnkn            resp.Field
		LightsVasi            resp.Field
		Material              resp.Field
		Obstacle              resp.Field
		Origin                resp.Field
		OrigNetwork           resp.Field
		Pcn                   resp.Field
		PointReference        resp.Field
		Primary               resp.Field
		RawWbc                resp.Field
		SbttWtKip             resp.Field
		SbttWtKipMod          resp.Field
		SbttWtKipModNote      resp.Field
		SbttWtKn              resp.Field
		StartLat              resp.Field
		StartLon              resp.Field
		StWtKip               resp.Field
		StWtKipMod            resp.Field
		StWtKipModNote        resp.Field
		StWtKn                resp.Field
		SWtKip                resp.Field
		SWtKipMod             resp.Field
		SWtKipModNote         resp.Field
		SWtKn                 resp.Field
		TdtWtkip              resp.Field
		TdtWtKipMod           resp.Field
		TdtWtKipModNote       resp.Field
		TdtWtKn               resp.Field
		TrtWtKip              resp.Field
		TrtWtKipMod           resp.Field
		TrtWtKipModNote       resp.Field
		TrtWtKn               resp.Field
		TtWtKip               resp.Field
		TtWtKipMod            resp.Field
		TtWtKipModNote        resp.Field
		TtWtKn                resp.Field
		TWtKip                resp.Field
		TWtKipMod             resp.Field
		TWtKipModNote         resp.Field
		TWtKn                 resp.Field
		WidthFt               resp.Field
		WidthM                resp.Field
...
type SurfaceGetResponse struct {
	...
	JSON struct {
		...
		StWtKipModNote        resp.Field
		StWtKn                resp.Field
		SurfaceObstructions   resp.Field
		SWtKip                resp.Field
		SWtKipMod             resp.Field
		SWtKipModNote         resp.Field
		SWtKn                 resp.Field
