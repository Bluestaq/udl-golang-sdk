...
type SurfaceQueryhelpResponse struct {
	...
	Parameters            []SurfaceQueryhelpResponseParameter `json:"parameters"`
...
type SurfaceQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SurfaceQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SurfaceQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
