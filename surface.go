...
type SurfaceListResponse struct {
	...
	DataMode SurfaceListResponseDataMode `json:"dataMode" api:"required"`
...
type SurfaceGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "EXERCISE", "SIMULATED".
	DataMode SurfaceGetResponseDataMode `json:"dataMode" api:"required"`
	// The surface name or identifier.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SurfaceTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "EXERCISE", "SIMULATED".
	DataMode SurfaceTupleResponseDataMode `json:"dataMode" api:"required"`
	// The surface name or identifier.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SurfaceNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "EXERCISE", "SIMULATED".
	DataMode SurfaceNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The surface name or identifier.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SurfaceUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "EXERCISE", "SIMULATED".
	DataMode SurfaceUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The surface name or identifier.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
