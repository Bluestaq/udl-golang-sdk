...
// AirOperationAircraftSortyHistoryService contains methods and other services that
// help with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewAirOperationAircraftSortyHistoryService] method instead.
type AirOperationAircraftSortyHistoryService struct {
	Options []option.RequestOption
}

// NewAirOperationAircraftSortyHistoryService generates a new service that applies
// the given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewAirOperationAircraftSortyHistoryService(opts ...option.RequestOption) (r AirOperationAircraftSortyHistoryService) {
	r = AirOperationAircraftSortyHistoryService{}
	r.Options = opts
	return
}
...
// URLQuery serializes [AirOperationAircraftSortyHistoryListParams]'s query
// parameters as `url.Values`.
func (r AirOperationAircraftSortyHistoryListParams) URLQuery() (v url.Values, err error) {
