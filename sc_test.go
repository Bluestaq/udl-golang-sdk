...
func TestScDelete(t *testing.T) {
	...
	err := client.Scs.Delete(context.TODO(), unifieddatalibrary.ScDeleteParams{
		ID: "id",
	})
	if err != nil {
...
func TestScAllowableFileExtensions(t *testing.T) {
	...
	_, err := client.Scs.AllowableFileExtensions(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestScAllowableFileMimes(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Scs.AllowableFileMimes(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestScCopy(t *testing.T) {
	...
	_, err := client.Scs.Copy(context.TODO(), unifieddatalibrary.ScCopyParams{
		ID:         "id",
...
func TestScDownload(t *testing.T) {
...
func TestScFileDownloadWithOptionalParams(t *testing.T) {
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(200)
		w.Write([]byte("abc"))
	}))
	...
	resp, err := client.Scs.FileDownload(context.TODO(), unifieddatalibrary.ScFileDownloadParams{
		ID:          "id",
...
func TestScFileUploadWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestScMove(t *testing.T) {
	...
	_, err := client.Scs.Move(context.TODO(), unifieddatalibrary.ScMoveParams{
		ID:         "id",
		TargetPath: "targetPath",
	})
	if err != nil {
...
func TestScRename(t *testing.T) {
	...
	err := client.Scs.Rename(context.TODO(), unifieddatalibrary.ScRenameParams{
		ID:      "id",
		NewName: "newName",
	})
	if err != nil {
...
func TestScSearchWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Scs.Search(context.TODO(), unifieddatalibrary.ScSearchParams{
		Path:            "path",
		Count:           unifieddatalibrary.Int(0),
		Offset:          unifieddatalibrary.Int(0),
		ContentCriteria: unifieddatalibrary.String("contentCriteria"),
		MetaDataCriteria: map[string][]string{
			"CREATED_AT": {"< 2022-06-14T07:48:11.302Z"},
		},
		NonRangeCriteria: map[string][]string{
			"foo": {"string"},
		},
		RangeCriteria: map[string][]string{
			"foo": {"string"},
		},
