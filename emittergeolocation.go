...
type EmitterGeolocationGetResponse struct {
	...
	DataMode EmitterGeolocationGetResponseDataMode `json:"dataMode" api:"required"`
	// Type of the signal of interest of this Emitter Geo Location (e.g. RF).
	SignalOfInterestType string `json:"signalOfInterestType" api:"required"`
	// Source of the data.
...
type EmitterGeolocationListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EmitterGeolocationListResponseDataMode `json:"dataMode" api:"required"`
	// Type of the signal of interest of this Emitter Geo Location (e.g. RF).
	SignalOfInterestType string `json:"signalOfInterestType" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EmitterGeolocationTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EmitterGeolocationTupleResponseDataMode `json:"dataMode" api:"required"`
	// Type of the signal of interest of this Emitter Geo Location (e.g. RF).
	SignalOfInterestType string `json:"signalOfInterestType" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EmitterGeolocationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EmitterGeolocationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Type of the signal of interest of this Emitter Geo Location (e.g. RF).
	SignalOfInterestType string `json:"signalOfInterestType" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
