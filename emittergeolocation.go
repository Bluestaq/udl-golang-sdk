...
type EmitterGeolocationQueryHelpResponse struct {
	...
	Parameters            []EmitterGeolocationQueryHelpResponseParameter `json:"parameters"`
...
type EmitterGeolocationQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r EmitterGeolocationQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *EmitterGeolocationQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
