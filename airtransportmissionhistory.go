...
func (f AirTransportMissionHistoryListParams) IsPresent() bool {
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f AirTransportMissionHistoryAodrParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f AirTransportMissionHistoryCountParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
