...
type SensorObservationTypeQueryhelpResponse struct {
	...
	Parameters            []SensorObservationTypeQueryhelpResponseParameter `json:"parameters"`
...
type SensorObservationTypeQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SensorObservationTypeQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SensorObservationTypeQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
