...
type OnorbitthrusterListResponse struct {
	...
	DataMode OnorbitthrusterListResponseDataMode `json:"dataMode" api:"required"`
	// ID of the Engine.
...
type OnorbitthrusterNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitthrusterNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the Engine.
	IDEngine string `json:"idEngine" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
...
type OnorbitthrusterUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitthrusterUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the Engine.
	IDEngine string `json:"idEngine" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
