...
func (r *OnorbitthrusterService) Get(ctx context.Context, id string, query OnorbitthrusterGetParams, opts ...option.RequestOption) (res *OnorbitthrusterGetResponse, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
		err = errors.New("missing required id parameter")
		return
...
type OnorbitthrusterGetResponse struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitthrusterGetResponseDataMode `json:"dataMode,required"`
	// ID of the Engine.
	IDEngine string `json:"idEngine,required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit,required"`
...
// Returns the unmodified JSON received from the API
func (r OnorbitthrusterGetResponse) RawJSON() string { return r.JSON.raw }
func (r *OnorbitthrusterGetResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type OnorbitthrusterGetResponseDataMode string

const (
	OnorbitthrusterGetResponseDataModeReal      OnorbitthrusterGetResponseDataMode = "REAL"
	OnorbitthrusterGetResponseDataModeTest      OnorbitthrusterGetResponseDataMode = "TEST"
	OnorbitthrusterGetResponseDataModeSimulated OnorbitthrusterGetResponseDataMode = "SIMULATED"
	OnorbitthrusterGetResponseDataModeExercise  OnorbitthrusterGetResponseDataMode = "EXERCISE"
)
...
type OnorbitthrusterNewParams struct {
	...
	// Known launch vehicle engines and their performance characteristics and limits. A
	// launch vehicle has 1 to many engines per stage.
	Engine OnorbitthrusterNewParamsEngine `json:"engine,omitzero"`
	paramObj
}
...
type OnorbitthrusterNewParamsEngine struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
func (r *OnorbitthrusterNewParamsEngine) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[OnorbitthrusterNewParamsEngine](
...
//
// The properties ClassificationMarking, DataMode, Name, Source are required.
type OnorbitthrusterUpdateParamsEngine struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
func (r *OnorbitthrusterUpdateParamsEngine) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[OnorbitthrusterUpdateParamsEngine](
		"dataMode", "REAL", "TEST", "SIMULATED", "EXERCISE",
	)
}
