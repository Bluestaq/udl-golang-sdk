...
func TestIrNewWithOptionalParams(t *testing.T) {
	...
	err := client.Ir.New(context.TODO(), unifieddatalibrary.IrNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.IrNewParamsDataModeTest,
		Name:                  "Example name",
		Source:                "Bluestaq",
		ID:                    unifieddatalibrary.String("IR-ID"),
...
func TestIrUpdateWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Ir.Update(
		context.TODO(),
		"id",
		unifieddatalibrary.IrUpdateParams{
			ClassificationMarking: "U",
			DataMode:              unifieddatalibrary.IrUpdateParamsDataModeTest,
			Name:                  "Example name",
			Source:                "Bluestaq",
			ID:                    unifieddatalibrary.String("IR-ID"),
			Description:           unifieddatalibrary.String("Example description"),
...
func TestIrListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ir.List(context.TODO(), unifieddatalibrary.IrListParams{
...
func TestIrDelete(t *testing.T) {
	...
	err := client.Ir.Delete(context.TODO(), "id")
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestIrCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ir.Count(context.TODO(), unifieddatalibrary.IrCountParams{
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
	if err != nil {
...
func TestIrGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ir.Get(
		context.TODO(),
		"id",
		unifieddatalibrary.IrGetParams{
			FirstResult: unifieddatalibrary.Int(0),
			MaxResults:  unifieddatalibrary.Int(0),
		},
	)
...
func TestIrQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ir.Queryhelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestIrTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ir.Tuple(context.TODO(), unifieddatalibrary.IrTupleParams{
		Columns:     "columns",
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
