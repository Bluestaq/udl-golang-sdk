...
func TestObservationMonoradarListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Observations.Monoradar.List(context.TODO(), unifieddatalibrary.ObservationMonoradarListParams{
		Ts:          time.Now(),
...
func TestObservationMonoradarCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Observations.Monoradar.Count(context.TODO(), unifieddatalibrary.ObservationMonoradarCountParams{
		Ts:          time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestObservationMonoradarNewBulk(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Observations.Monoradar.NewBulk(context.TODO(), unifieddatalibrary.ObservationMonoradarNewBulkParams{
		Body: []unifieddatalibrary.ObservationMonoradarNewBulkParamsBody{{
...
func TestObservationMonoradarQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestObservationMonoradarTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Observations.Monoradar.Tuple(context.TODO(), unifieddatalibrary.ObservationMonoradarTupleParams{
		Columns:     "columns",
		Ts:          time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
