...
func TestCollectRequestNewWithOptionalParams(t *testing.T) {
	...
	err := client.CollectRequests.New(context.TODO(), unifieddatalibrary.CollectRequestNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.CollectRequestNewParamsDataModeTest,
		Source:                "Bluestaq",
		StartTime:             time.Now(),
		Type:                  "DWELL",
		...
		Elset: unifieddatalibrary.CollectRequestNewParamsElset{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			Epoch:                 time.Now(),
			Source:                "Bluestaq",
		...
		StateVector: unifieddatalibrary.CollectRequestNewParamsStateVector{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			Epoch:                 time.Now(),
			Source:                "Bluestaq",
			...
			MissionCenter:         unifieddatalibrary.String("Mission Center A"),
...
func TestCollectRequestGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.CollectRequests.Get(
		context.TODO(),
		"id",
		unifieddatalibrary.CollectRequestGetParams{
...
func TestCollectRequestListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.CollectRequests.List(context.TODO(), unifieddatalibrary.CollectRequestListParams{
		StartTime:   time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestCollectRequestCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.CollectRequests.Count(context.TODO(), unifieddatalibrary.CollectRequestCountParams{
		StartTime:   time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestCollectRequestNewBulk(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.CollectRequests.NewBulk(context.TODO(), unifieddatalibrary.CollectRequestNewBulkParams{
		Body: []unifieddatalibrary.CollectRequestNewBulkParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			Source:                "Bluestaq",
			StartTime:             time.Now(),
			...
			Eccentricity:          unifieddatalibrary.Float(1.1),
			El:                    unifieddatalibrary.Float(1.1),
			Elset: unifieddatalibrary.CollectRequestNewBulkParamsBodyElset{
				ClassificationMarking: "U",
				DataMode:              "TEST",
				Epoch:                 time.Now(),
				Source:                "Bluestaq",
			...
			SrchInc:         unifieddatalibrary.Float(1.1),
			SrchPattern:     unifieddatalibrary.String("SCAN"),
			StateVector: unifieddatalibrary.CollectRequestNewBulkParamsBodyStateVector{
				ClassificationMarking: "U",
				DataMode:              "TEST",
				Epoch:                 time.Now(),
				Source:                "Bluestaq",
...
func TestCollectRequestQueryHelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestCollectRequestTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.CollectRequests.Tuple(context.TODO(), unifieddatalibrary.CollectRequestTupleParams{
		Columns:     "columns",
		StartTime:   time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
...
func TestCollectRequestUnvalidatedPublish(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.CollectRequests.UnvalidatedPublish(context.TODO(), unifieddatalibrary.CollectRequestUnvalidatedPublishParams{
		Body: []unifieddatalibrary.CollectRequestUnvalidatedPublishParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			Source:                "Bluestaq",
			StartTime:             time.Now(),
			...
			Eccentricity:          unifieddatalibrary.Float(1.1),
			El:                    unifieddatalibrary.Float(1.1),
			Elset: unifieddatalibrary.CollectRequestUnvalidatedPublishParamsBodyElset{
				ClassificationMarking: "U",
				DataMode:              "TEST",
				Epoch:                 time.Now(),
				Source:                "Bluestaq",
			...
			SrchInc:         unifieddatalibrary.Float(1.1),
			SrchPattern:     unifieddatalibrary.String("SCAN"),
			StateVector: unifieddatalibrary.CollectRequestUnvalidatedPublishParamsBodyStateVector{
				ClassificationMarking: "U",
				DataMode:              "TEST",
				Epoch:                 time.Now(),
				Source:                "Bluestaq",
