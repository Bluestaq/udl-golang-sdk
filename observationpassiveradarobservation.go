...
type ObservationPassiveRadarObservationQueryhelpResponse struct {
	...
	Parameters            []ObservationPassiveRadarObservationQueryhelpResponseParameter `json:"parameters"`
...
type ObservationPassiveRadarObservationQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ObservationPassiveRadarObservationQueryhelpResponseParameter) RawJSON() string {
	return r.JSON.raw
}
func (r *ObservationPassiveRadarObservationQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
