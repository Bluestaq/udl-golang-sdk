...
// parameter.
func (r *SgiService) Get(ctx context.Context, id string, query SgiGetParams, opts ...option.RequestOption) (res *SgiFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
		err = errors.New("missing required id parameter")
		return
...
func (r *SgiService) GetDataByEffectiveAsOfDate(ctx context.Context, query SgiGetDataByEffectiveAsOfDateParams, opts ...option.RequestOption) (res *SgiFull, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *SgiService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// hours ago.
func (r *SgiService) Tuple(ctx context.Context, query SgiTupleParams, opts ...option.RequestOption) (res *[]SgiFull, err error) {
	opts = append(r.Options[:], opts...)
	path := "udl/sgi/tuple"
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, query, &res, opts...)
	return
