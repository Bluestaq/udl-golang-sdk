...
type SgiListResponse struct {
	...
	DataMode SgiListResponseDataMode `json:"dataMode" api:"required"`
	...
	EffectiveDate time.Time `json:"effectiveDate" api:"required" format:"date-time"`
	...
	// this data record.
	SgiDate time.Time `json:"sgiDate" api:"required" format:"date-time"`
	// Source of the data.
...
type SgiGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SgiGetResponseDataMode `json:"dataMode" api:"required"`
	// ISO8601 UTC Time the data was received and processed from the source. Typically
	// a source provides data for a date window with each transmission including past,
	// present, and future predicted values.
	EffectiveDate time.Time `json:"effectiveDate" api:"required" format:"date-time"`
...
type SgiGetDataByEffectiveAsOfDateResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SgiGetDataByEffectiveAsOfDateResponseDataMode `json:"dataMode" api:"required"`
	// ISO8601 UTC Time the data was received and processed from the source. Typically
	// a source provides data for a date window with each transmission including past,
	// present, and future predicted values.
	EffectiveDate time.Time `json:"effectiveDate" api:"required" format:"date-time"`
...
type SgiTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SgiTupleResponseDataMode `json:"dataMode" api:"required"`
	// ISO8601 UTC Time the data was received and processed from the source. Typically
	// a source provides data for a date window with each transmission including past,
	// present, and future predicted values.
	EffectiveDate time.Time `json:"effectiveDate" api:"required" format:"date-time"`
...
type SgiNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SgiNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ISO8601 UTC Time the data was received and processed from the source. Typically
	// a source provides data for a date window with each transmission including past,
	// present, and future predicted values.
	EffectiveDate time.Time `json:"effectiveDate" api:"required" format:"date-time"`
...
type SgiUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SgiUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ISO8601 UTC Time the data was received and processed from the source. Typically
	// a source provides data for a date window with each transmission including past,
	// present, and future predicted values.
	EffectiveDate time.Time `json:"effectiveDate" api:"required" format:"date-time"`
