...
type SgiQueryhelpResponse struct {
	...
	Parameters            []SgiQueryhelpResponseParameter `json:"parameters"`
...
type SgiQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SgiQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SgiQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
