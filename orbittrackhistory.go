...
func (r *OrbittrackHistoryService) List(ctx context.Context, query OrbittrackHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[OrbittrackFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *OrbittrackHistoryService) ListAutoPaging(ctx context.Context, query OrbittrackHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[OrbittrackFull] {
