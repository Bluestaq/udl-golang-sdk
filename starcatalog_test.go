...
func TestStarCatalogNewWithOptionalParams(t *testing.T) {
	...
	err := client.StarCatalog.New(context.TODO(), unifieddatalibrary.StarCatalogNewParams{
		...
		AllWisew1Mag:          unifieddatalibrary.Float(15.782),
		AllWisew1MagUnc:       unifieddatalibrary.Float(0.042),
		AllWisew2Mag:          unifieddatalibrary.Float(16.523),
		AllWisew2MagUnc:       unifieddatalibrary.Float(0.021),
		AllWisew3Mag:          unifieddatalibrary.Float(11.541),
		AllWisew3MagUnc:       unifieddatalibrary.Float(0.159),
		AllWisew4Mag:          unifieddatalibrary.Float(9.007),
		AllWisew4MagUnc:       unifieddatalibrary.Float(0.468),
