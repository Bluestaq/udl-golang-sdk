...
func (r *SkyimageryHistoryService) List(ctx context.Context, query SkyimageryHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[SkyimageryFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *SkyimageryHistoryService) ListAutoPaging(ctx context.Context, query SkyimageryHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[SkyimageryFull] {
