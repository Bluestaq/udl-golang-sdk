...
type AirTaskingOrderFull struct {
	...
	DataMode AirTaskingOrderFullDataMode `json:"dataMode" api:"required"`
...
type AirTransportMissionFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirTransportMissionFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type AircraftFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AircraftFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type AircraftsortieFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AircraftsortieFullDataMode `json:"dataMode" api:"required"`
...
type AircraftstatusFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AircraftstatusFullDataMode `json:"dataMode" api:"required"`
	// Unique identifier of the aircraft.
...
type AircraftstatusremarkFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AircraftstatusremarkFullDataMode `json:"dataMode" api:"required"`
...
type AirfieldFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldFullDataMode `json:"dataMode" api:"required"`
...
type AirfieldslotFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldslotFullDataMode `json:"dataMode" api:"required"`
	// Name of this slot.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AirfieldslotconsumptionFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldslotconsumptionFullDataMode `json:"dataMode" api:"required"`
...
type AirfieldstatusFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldstatusFullDataMode `json:"dataMode" api:"required"`
...
type AirloadplanFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirloadplanFullDataMode `json:"dataMode" api:"required"`
	// The current estimated time that the aircraft is planned to depart, in ISO 8601
	// UTC format with millisecond precision.
...
type AirspacecontrolorderFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirspacecontrolorderFullDataMode `json:"dataMode" api:"required"`
	// Specifies the unique operation or exercise name, nickname, or codeword assigned
	// to a joint exercise or operation plan.
...
type AIsFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AIsFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AnalyticImageryFull struct {
	...
	DataMode AnalyticImageryFullDataMode `json:"dataMode" api:"required"`
...
type AntennaDetailsFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AntennaDetailsFullDataMode `json:"dataMode" api:"required"`
...
type AntennaFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AntennaFullDataMode `json:"dataMode" api:"required"`
	// Antenna name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AntennaIngestParam struct {
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	// REAL: Data collected or produced that pertains to real-world objects, events,
	// and analysis.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AntennaIngestDataMode `json:"dataMode,omitzero" api:"required"`
	// Antenna name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
func (r AntennaIngestParam) MarshalJSON() (data []byte, err error) {
	type shadow AntennaIngestParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *AntennaIngestParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// SIMULATED: Synthetic data generated by a model to mimic real-world datasets.
type AntennaIngestDataMode string

const (
	AntennaIngestDataModeReal      AntennaIngestDataMode = "REAL"
	AntennaIngestDataModeTest      AntennaIngestDataMode = "TEST"
	AntennaIngestDataModeSimulated AntennaIngestDataMode = "SIMULATED"
	AntennaIngestDataModeExercise  AntennaIngestDataMode = "EXERCISE"
)
...
type AttitudedataFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AttitudedataFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AttitudesetFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AttitudesetFullDataMode `json:"dataMode" api:"required"`
...
type BatteryFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatteryFullDataMode `json:"dataMode" api:"required"`
	// Battery name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
//
// The properties DataMode, Name, Source are required.
type BatteryIngestParam struct {
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	// REAL: Data collected or produced that pertains to real-world objects, events,
	// and analysis.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatteryIngestDataMode `json:"dataMode,omitzero" api:"required"`
	// Battery name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
func (r BatteryIngestParam) MarshalJSON() (data []byte, err error) {
	type shadow BatteryIngestParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *BatteryIngestParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// SIMULATED: Synthetic data generated by a model to mimic real-world datasets.
type BatteryIngestDataMode string

const (
	BatteryIngestDataModeReal      BatteryIngestDataMode = "REAL"
	BatteryIngestDataModeTest      BatteryIngestDataMode = "TEST"
	BatteryIngestDataModeSimulated BatteryIngestDataMode = "SIMULATED"
	BatteryIngestDataModeExercise  BatteryIngestDataMode = "EXERCISE"
)
...
type BatterydetailsFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatterydetailsFullDataMode `json:"dataMode" api:"required"`
...
type BeamFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BeamFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type BeamcontourFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BeamcontourFullDataMode `json:"dataMode" api:"required"`
	// ID of the beam.
	...
	Type BeamcontourFullType `json:"type" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type BusFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BusFullDataMode `json:"dataMode" api:"required"`
	// Name of this bus.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type ChannelFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ChannelFullDataMode `json:"dataMode" api:"required"`
...
type CollectRequestFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CollectRequestFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type CollectResponseFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CollectResponseFullDataMode `json:"dataMode" api:"required"`
...
type CommFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CommFullDataMode `json:"dataMode" api:"required"`
...
type ConjunctionFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ConjunctionFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type CountryFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CountryFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type CrewFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CrewFullDataMode `json:"dataMode" api:"required"`
...
type DiplomaticclearanceFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DiplomaticclearanceFullDataMode `json:"dataMode" api:"required"`
...
type DriftHistoryAbridged struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DriftHistoryAbridgedDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type DriftHistoryFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DriftHistoryFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type Engine struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EngineDataMode `json:"dataMode" api:"required"`
	// Engine name/variant.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EngineDetailsFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EngineDetailsFullDataMode `json:"dataMode" api:"required"`
...
type EngineIngestParam struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EngineIngestDataMode `json:"dataMode,omitzero" api:"required"`
	// Engine name/variant.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
func (r EngineIngestParam) MarshalJSON() (data []byte, err error) {
	type shadow EngineIngestParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *EngineIngestParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// SIMULATED: Synthetic data generated by a model to mimic real-world datasets.
type EngineIngestDataMode string

const (
	EngineIngestDataModeReal      EngineIngestDataMode = "REAL"
	EngineIngestDataModeTest      EngineIngestDataMode = "TEST"
	EngineIngestDataModeSimulated EngineIngestDataMode = "SIMULATED"
	EngineIngestDataModeExercise  EngineIngestDataMode = "EXERCISE"
)
...
type EntityFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EntityFullDataMode `json:"dataMode" api:"required"`
	// Unique entity name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	...
	Type EntityFullType `json:"type" api:"required"`
	// The country code. This value is typically the ISO 3166 Alpha-2 two-character
	// country code, however it can also represent various consortiums that do not
	// appear in the ISO document. The code must correspond to an existing country in
	// the UDL’s country API. Call udl/country/{code} to get any associated FIPS code,
...
type EoObservationFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EoObservationFullDataMode `json:"dataMode" api:"required"`
...
type EoObservationFullEoobservationDetails struct {
	...
	// should be assumed.
	ImageBoreRaDec []float64 `json:"imageBoreRaDec"`
	...
	ImageBoreVector []float64 `json:"imageBoreVector"`
	...
	JSON struct {
		...
		Ifov                                 respjson.Field
		ImageBoreRaDec                       respjson.Field
		ImageBoreVector                      respjson.Field
		ImageCorners                         respjson.Field
		ImageFovHeight                       respjson.Field
		ImageFovWidth                        respjson.Field
		ImageHorizVector                     respjson.Field
		ImageVertVector                      respjson.Field
...
type EopFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EopFullDataMode `json:"dataMode" api:"required"`
...
type EphemerisFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EphemerisFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EvacFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EvacFullDataMode `json:"dataMode" api:"required"`
	...
	Type EvacFullType `json:"type" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type EventEvolutionFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EventEvolutionFullDataMode `json:"dataMode" api:"required"`
...
type FlightPlanFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode FlightPlanFullDataMode `json:"dataMode" api:"required"`
...
type LocationAbridged struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LocationAbridgedDataMode `json:"dataMode" api:"required"`
	// Location name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LocationFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LocationFullDataMode `json:"dataMode" api:"required"`
	// Location name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type NotificationFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode NotificationFullDataMode `json:"dataMode" api:"required"`
...
type OnboardnavigationFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnboardnavigationFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type OnorbitAntennaFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitAntennaFullDataMode `json:"dataMode" api:"required"`
	// ID of the antenna.
	IDAntenna string `json:"idAntenna" api:"required"`
...
type OnorbitBatteryFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitBatteryFullDataMode `json:"dataMode" api:"required"`
	// ID of the battery.
	IDBattery string `json:"idBattery" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
...
type OnorbitDetailsFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitDetailsFullDataMode `json:"dataMode" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type OnorbitFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitFullDataMode `json:"dataMode" api:"required"`
	// Satellite/Catalog number of the target on-orbit object.
	SatNo int64 `json:"satNo" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type OnorbitSolarArrayFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitSolarArrayFullDataMode `json:"dataMode" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
...
type OnorbitThrusterFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitThrusterFullDataMode `json:"dataMode" api:"required"`
	// ID of the Engine.
	IDEngine string `json:"idEngine" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
...
type OnorbitthrusterstatusFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitthrusterstatusFullDataMode `json:"dataMode" api:"required"`
...
type OperatingUnitRemarkFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OperatingUnitRemarkFullDataMode `json:"dataMode" api:"required"`
...
type OperatingunitFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OperatingunitFullDataMode `json:"dataMode" api:"required"`
...
type OrganizationDetailsFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrganizationDetailsFullDataMode `json:"dataMode" api:"required"`
...
type OrganizationFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrganizationFullDataMode `json:"dataMode" api:"required"`
	// Organization name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type RfBandFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfBandFullDataMode `json:"dataMode" api:"required"`
...
type SolarArrayDetailsFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SolarArrayDetailsFullDataMode `json:"dataMode" api:"required"`
...
type SolarArrayFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SolarArrayFullDataMode `json:"dataMode" api:"required"`
	// Solar Array name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
//
// The properties DataMode, Name, Source are required.
type SolarArrayIngestParam struct {
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	// REAL: Data collected or produced that pertains to real-world objects, events,
	// and analysis.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SolarArrayIngestDataMode `json:"dataMode,omitzero" api:"required"`
	// Solar Array name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
func (r SolarArrayIngestParam) MarshalJSON() (data []byte, err error) {
	type shadow SolarArrayIngestParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *SolarArrayIngestParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// SIMULATED: Synthetic data generated by a model to mimic real-world datasets.
type SolarArrayIngestDataMode string

const (
	SolarArrayIngestDataModeReal      SolarArrayIngestDataMode = "REAL"
	SolarArrayIngestDataModeTest      SolarArrayIngestDataMode = "TEST"
	SolarArrayIngestDataModeSimulated SolarArrayIngestDataMode = "SIMULATED"
	SolarArrayIngestDataModeExercise  SolarArrayIngestDataMode = "EXERCISE"
)
...
type SortiePprFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SortiePprFullDataMode `json:"dataMode" api:"required"`
...
type StateVectorFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode StateVectorFullDataMode `json:"dataMode" api:"required"`
	// Time of validity for state vector in ISO 8601 UTC datetime format, with
	// microsecond precision.
	Epoch time.Time `json:"epoch" api:"required" format:"date-time"`
	// Source of the data.
...
type StatusFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode StatusFullDataMode `json:"dataMode" api:"required"`
...
type SubStatusFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SubStatusFullDataMode `json:"dataMode" api:"required"`
	...
	//
	// Any of "FMC", "NMC", "PMC", "UNK".
	Status SubStatusFullStatus `json:"status" api:"required"`
	...
	Type SubStatusFullType `json:"type" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
	// Time the row was created in the database, auto-populated by the system.
	CreatedAt time.Time `json:"createdAt" format:"date-time"`
...
// Type are required.
type SubStatusIngestParam struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SubStatusIngestDataMode `json:"dataMode,omitzero" api:"required"`
	// Descriptions and/or comments associated with the sub-status.
	Notes string `json:"notes" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	...
	//
	// Any of "FMC", "NMC", "PMC", "UNK".
	Status SubStatusIngestStatus `json:"status,omitzero" api:"required"`
	// Id of the parent status.
	StatusID string `json:"statusId" api:"required"`
	// Parent entity's sub-system or capability status: mwCap, mdCap, ssCap, etc.
	//
	// Any of "mwCap", "ssCap", "mdCap".
	Type SubStatusIngestType `json:"type,omitzero" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID param.Opt[string] `json:"id,omitzero"`
	// Originating system or organization which produced the data, if different from
	// the source. The origin may be different than the source if the source was a
...
func (r SubStatusIngestParam) MarshalJSON() (data []byte, err error) {
	type shadow SubStatusIngestParam
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *SubStatusIngestParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// SIMULATED: Synthetic data generated by a model to mimic real-world datasets.
type SubStatusIngestDataMode string

const (
	SubStatusIngestDataModeReal      SubStatusIngestDataMode = "REAL"
	SubStatusIngestDataModeTest      SubStatusIngestDataMode = "TEST"
	SubStatusIngestDataModeSimulated SubStatusIngestDataMode = "SIMULATED"
	SubStatusIngestDataModeExercise  SubStatusIngestDataMode = "EXERCISE"
)

// Status of the sub-system/capability, e.g. FMC, NMC, PMC, UNK.
type SubStatusIngestStatus string

const (
	SubStatusIngestStatusFmc SubStatusIngestStatus = "FMC"
	SubStatusIngestStatusNmc SubStatusIngestStatus = "NMC"
	SubStatusIngestStatusPmc SubStatusIngestStatus = "PMC"
	SubStatusIngestStatusUnk SubStatusIngestStatus = "UNK"
)

// Parent entity's sub-system or capability status: mwCap, mdCap, ssCap, etc.
type SubStatusIngestType string

const (
	SubStatusIngestTypeMwCap SubStatusIngestType = "mwCap"
	SubStatusIngestTypeSSCap SubStatusIngestType = "ssCap"
	SubStatusIngestTypeMdCap SubStatusIngestType = "mdCap"
)
