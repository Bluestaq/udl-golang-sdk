...
type AntennaIngestParam struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AntennaIngestDataMode `json:"dataMode,omitzero,required"`
	// Antenna name.
	Name string `json:"name,required"`
	// Source of the data.
	Source string `json:"source,required"`
...
type BatteryIngestParam struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatteryIngestDataMode `json:"dataMode,omitzero,required"`
	// Battery name.
	Name string `json:"name,required"`
	// Source of the data.
	Source string `json:"source,required"`
...
type EngineIngestParam struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EngineIngestDataMode `json:"dataMode,omitzero,required"`
	// Engine name/variant.
	Name string `json:"name,required"`
	// Source of the data.
	Source string `json:"source,required"`
...
type SolarArrayIngestParam struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SolarArrayIngestDataMode `json:"dataMode,omitzero,required"`
	// Solar Array name.
	Name string `json:"name,required"`
	// Source of the data.
	Source string `json:"source,required"`
...
type SubStatusIngestParam struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SubStatusIngestDataMode `json:"dataMode,omitzero,required"`
	// Descriptions and/or comments associated with the sub-status.
	Notes string `json:"notes,required"`
	// Source of the data.
	Source string `json:"source,required"`
	...
	//
	// Any of "FMC", "NMC", "PMC", "UNK".
	Status SubStatusIngestStatus `json:"status,omitzero,required"`
	// Id of the parent status.
	StatusID string `json:"statusId,required"`
	// Parent entity's sub-system or capability status: mwCap, mdCap, ssCap, etc.
	//
	// Any of "mwCap", "ssCap", "mdCap".
	Type SubStatusIngestType `json:"type,omitzero,required"`
	// Unique identifier of the record, auto-generated by the system.
	ID param.Opt[string] `json:"id,omitzero"`
	// Originating system or organization which produced the data, if different from
	// the source. The origin may be different than the source if the source was a
