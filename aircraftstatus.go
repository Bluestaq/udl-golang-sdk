...
type AircraftStatusQueryhelpResponse struct {
	...
	Parameters            []AircraftStatusQueryhelpResponseParameter `json:"parameters"`
...
type AircraftStatusQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AircraftStatusQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AircraftStatusQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
