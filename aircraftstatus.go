...
type AircraftstatusAbridged struct {
	...
	DataMode AircraftstatusAbridgedDataMode `json:"dataMode" api:"required"`
	// Unique identifier of the aircraft.
	IDAircraft string `json:"idAircraft" api:"required"`
	// Source of the data.
...
type AircraftStatusNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AircraftStatusNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the aircraft.
	IDAircraft string `json:"idAircraft" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AircraftStatusUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AircraftStatusUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the aircraft.
	IDAircraft string `json:"idAircraft" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
