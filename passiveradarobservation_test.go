...
func TestPassiveradarobservationNewWithOptionalParams(t *testing.T) {
	...
	err := client.Passiveradarobservation.New(context.TODO(), unifieddatalibrary.PassiveradarobservationNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.PassiveradarobservationNewParamsDataModeTest,
		ObTime:                time.Now(),
		Source:                "Bluestaq",
...
func TestPassiveradarobservationListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Passiveradarobservation.List(context.TODO(), unifieddatalibrary.PassiveradarobservationListParams{
		ObTime:      time.Now(),
...
func TestPassiveradarobservationCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Passiveradarobservation.Count(context.TODO(), unifieddatalibrary.PassiveradarobservationCountParams{
		ObTime:      time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestPassiveradarobservationNewBulk(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Passiveradarobservation.NewBulk(context.TODO(), unifieddatalibrary.PassiveradarobservationNewBulkParams{
		Body: []unifieddatalibrary.PassiveradarobservationNewBulkParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			ObTime:                time.Now(),
			Source:                "Bluestaq",
...
func TestPassiveradarobservationFileNew(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Passiveradarobservation.FileNew(context.TODO(), unifieddatalibrary.PassiveradarobservationFileNewParams{
		Body: []unifieddatalibrary.PassiveradarobservationFileNewParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			ObTime:                time.Now(),
			Source:                "Bluestaq",
...
func TestPassiveradarobservationGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Passiveradarobservation.Get(
		context.TODO(),
		"id",
		unifieddatalibrary.PassiveradarobservationGetParams{
			FirstResult: unifieddatalibrary.Int(0),
			MaxResults:  unifieddatalibrary.Int(0),
		},
	)
...
func TestPassiveradarobservationQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Passiveradarobservation.Queryhelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestPassiveradarobservationTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Passiveradarobservation.Tuple(context.TODO(), unifieddatalibrary.PassiveradarobservationTupleParams{
		Columns:     "columns",
		ObTime:      time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
