...
func (r *IsrCollectionService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *IsrCollectionQueryhelpResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type IsrCollectionCriticalTimesFull struct {
	...
	EarliestImagingTime time.Time `json:"earliestImagingTime" api:"required" format:"date-time"`
	// Critical stop time to collect an image for this requirement.
	LatestImagingTime time.Time `json:"latestImagingTime" api:"required" format:"date-time"`
...
type IsrCollectionListResponse struct {
	...
	DataMode IsrCollectionListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type IsrCollectionTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode IsrCollectionTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
