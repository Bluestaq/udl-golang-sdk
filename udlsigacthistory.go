...
// UdlSigactHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlSigactHistoryService] method instead.
type UdlSigactHistoryService struct {
	Options []option.RequestOption
}

// NewUdlSigactHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlSigactHistoryService(opts ...option.RequestOption) (r UdlSigactHistoryService) {
	r = UdlSigactHistoryService{}
	r.Options = opts
	return
}
...
type SigactFull struct {
	...
	DataMode SigactFullDataMode `json:"dataMode,required"`
	...
	RelatedDocs []SigactFullRelatedDoc `json:"relatedDocs"`
	// The reporting unit.
...
func (r SigactFull) RawJSON() string { return r.JSON.raw }
func (r *SigactFull) UnmarshalJSON(data []byte) error {
...
type SigactFullRelatedDoc struct {
	// List of data sources related to this document.
	DataSourceRefs []SigactFullRelatedDocDataSourceRef `json:"dataSourceRefs"`
...
// Returns the unmodified JSON received from the API
func (r SigactFullRelatedDoc) RawJSON() string { return r.JSON.raw }
func (r *SigactFullRelatedDoc) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SigactFullRelatedDocDataSourceRef struct {
	// Data source id.
...
// Returns the unmodified JSON received from the API
func (r SigactFullRelatedDocDataSourceRef) RawJSON() string { return r.JSON.raw }
func (r *SigactFullRelatedDocDataSourceRef) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
