...
type SwirQueryhelpResponse struct {
	...
	Parameters            []SwirQueryhelpResponseParameter `json:"parameters"`
...
type SwirQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SwirQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SwirQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
