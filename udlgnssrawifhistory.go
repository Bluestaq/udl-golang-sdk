...
// UdlGnssrawifHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlGnssrawifHistoryService] method instead.
type UdlGnssrawifHistoryService struct {
	Options []option.RequestOption
}

// NewUdlGnssrawifHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlGnssrawifHistoryService(opts ...option.RequestOption) (r UdlGnssrawifHistoryService) {
	r = UdlGnssrawifHistoryService{}
	r.Options = opts
	return
}
...
type GnssRawIfFull struct {
	...
	DataMode GnssRawIfFullDataMode `json:"dataMode,required"`
...
func (r GnssRawIfFull) RawJSON() string { return r.JSON.raw }
func (r *GnssRawIfFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type GnssRawIfFullDataMode string

const (
	GnssRawIfFullDataModeReal      GnssRawIfFullDataMode = "REAL"
	GnssRawIfFullDataModeTest      GnssRawIfFullDataMode = "TEST"
	GnssRawIfFullDataModeSimulated GnssRawIfFullDataMode = "SIMULATED"
	GnssRawIfFullDataModeExercise  GnssRawIfFullDataMode = "EXERCISE"
)
