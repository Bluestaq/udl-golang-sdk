...
func (r *ObservationRadarobservationHistoryService) List(ctx context.Context, query ObservationRadarobservationHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[RadarobservationFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *ObservationRadarobservationHistoryService) ListAutoPaging(ctx context.Context, query ObservationRadarobservationHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[RadarobservationFull] {
