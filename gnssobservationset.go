...
type GnssObservationsetQueryhelpResponse struct {
	...
	Parameters            []GnssObservationsetQueryhelpResponseParameter `json:"parameters"`
...
type GnssObservationsetQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r GnssObservationsetQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *GnssObservationsetQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
