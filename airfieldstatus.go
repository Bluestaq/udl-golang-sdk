...
type AirfieldstatusAbridged struct {
	...
	DataMode AirfieldstatusAbridgedDataMode `json:"dataMode" api:"required"`
	// Unique identifier of the Airfield for which this status is referencing.
	IDAirfield string `json:"idAirfield" api:"required"`
	// Source of the data.
...
type AirfieldStatusNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldStatusNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the Airfield for which this status is referencing.
	IDAirfield string `json:"idAirfield" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AirfieldStatusUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldStatusUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the Airfield for which this status is referencing.
	IDAirfield string `json:"idAirfield" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
