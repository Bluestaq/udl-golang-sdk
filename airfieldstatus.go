...
// as a path parameter.
func (r *AirfieldStatusService) Get(ctx context.Context, id string, query AirfieldStatusGetParams, opts ...option.RequestOption) (res *shared.AirfieldstatusFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
func (r *AirfieldStatusService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *AirfieldStatusQueryhelpResponse, err error) {
	opts = append(r.Options[:], opts...)
...
// hours ago.
func (r *AirfieldStatusService) Tuple(ctx context.Context, query AirfieldStatusTupleParams, opts ...option.RequestOption) (res *[]shared.AirfieldstatusFull, err error) {
	opts = append(r.Options[:], opts...)
...
type AirfieldStatusQueryhelpResponse struct {
	AodrSupported         bool                                       `json:"aodrSupported"`
	ClassificationMarking string                                     `json:"classificationMarking"`
	Description           string                                     `json:"description"`
	HistorySupported      bool                                       `json:"historySupported"`
	Name                  string                                     `json:"name"`
	Parameters            []AirfieldStatusQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r AirfieldStatusQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *AirfieldStatusQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AirfieldStatusQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AirfieldStatusQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AirfieldStatusQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (r *AirfieldStatusNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (r *AirfieldStatusUpdateParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
