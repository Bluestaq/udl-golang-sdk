...
type H3GeoListResponse struct {
	...
	DataMode H3GeoListResponseDataMode `json:"dataMode" api:"required"`
	// The number of cells associated with this H3 Geo data set. At this time, UDL
	// supports up to 50,000 cells.
	NumCells int64 `json:"numCells" api:"required"`
	// Source of the data.
...
type H3GeoGetResponse struct {
	...
	Cells []H3GeoGetResponseCell `json:"cells" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode H3GeoGetResponseDataMode `json:"dataMode" api:"required"`
	// The number of cells associated with this H3 Geo data set. At this time, UDL
	// supports up to 50,000 cells.
	NumCells int64 `json:"numCells" api:"required"`
	// Source of the data.
...
type H3GeoTupleResponse struct {
	// The collection of hex cells contained in this H3 data set. The number of cells
	// is a function of the specified resolution.
	Cells []H3GeoTupleResponseCell `json:"cells" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode H3GeoTupleResponseDataMode `json:"dataMode" api:"required"`
	// The number of cells associated with this H3 Geo data set. At this time, UDL
	// supports up to 50,000 cells.
	NumCells int64 `json:"numCells" api:"required"`
	// Source of the data.
...
type H3GeoNewParams struct {
	// The collection of hex cells contained in this H3 data set. The number of cells
	// is a function of the specified resolution.
	Cells []H3GeoNewParamsCell `json:"cells,omitzero" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode H3GeoNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The number of cells associated with this H3 Geo data set. At this time, UDL
	// supports up to 50,000 cells.
	NumCells int64 `json:"numCells" api:"required"`
	// Source of the data.
