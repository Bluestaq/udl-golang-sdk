...
type H3GeoQueryhelpResponse struct {
	...
	Parameters            []H3GeoQueryhelpResponseParameter `json:"parameters"`
...
type H3GeoQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r H3GeoQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *H3GeoQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
