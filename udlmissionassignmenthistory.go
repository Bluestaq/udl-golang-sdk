...
// UdlMissionassignmentHistoryService contains methods and other services that help
// with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlMissionassignmentHistoryService] method instead.
type UdlMissionassignmentHistoryService struct {
	Options []option.RequestOption
}

// NewUdlMissionassignmentHistoryService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewUdlMissionassignmentHistoryService(opts ...option.RequestOption) (r UdlMissionassignmentHistoryService) {
	r = UdlMissionassignmentHistoryService{}
	r.Options = opts
	return
}
...
type MissionAssignmentFull struct {
	...
	DataMode MissionAssignmentFullDataMode `json:"dataMode,required"`
...
func (r MissionAssignmentFull) RawJSON() string { return r.JSON.raw }
func (r *MissionAssignmentFull) UnmarshalJSON(data []byte) error {
