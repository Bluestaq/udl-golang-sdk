...
type PersonnelrecoveryQueryhelpResponse struct {
	...
	Parameters            []PersonnelrecoveryQueryhelpResponseParameter `json:"parameters"`
...
type PersonnelrecoveryQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r PersonnelrecoveryQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *PersonnelrecoveryQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
