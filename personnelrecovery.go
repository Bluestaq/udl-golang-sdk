...
type PersonnelRecoveryFullL struct {
	...
	DataMode PersonnelRecoveryFullLDataMode `json:"dataMode" api:"required"`
...
type PersonnelrecoveryListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode PersonnelrecoveryListResponseDataMode `json:"dataMode" api:"required"`
	// Time stamp of the original personnel recovery message, in ISO 8601 UTC format.
	MsgTime time.Time `json:"msgTime" api:"required" format:"date-time"`
	// WGS-84 latitude of the pickup location, in degrees. -90 to 90 degrees (negative
	// values south of equator).
...
type PersonnelrecoveryNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode PersonnelrecoveryNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Time stamp of the original personnel recovery message, in ISO 8601 UTC format.
	MsgTime time.Time `json:"msgTime" api:"required" format:"date-time"`
	// WGS-84 latitude of the pickup location, in degrees. -90 to 90 degrees (negative
	// values south of equator).
