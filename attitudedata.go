...
type AttitudeDataQueryHelpResponse struct {
	...
	Parameters            []AttitudeDataQueryHelpResponseParameter `json:"parameters"`
...
func (r AttitudeDataQueryHelpResponse) RawJSON() string { return r.JSON.raw }
func (r *AttitudeDataQueryHelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AttitudeDataQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AttitudeDataQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AttitudeDataQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
