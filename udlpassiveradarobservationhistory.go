...
// UdlPassiveradarobservationHistoryService contains methods and other services
// that help with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlPassiveradarobservationHistoryService] method instead.
type UdlPassiveradarobservationHistoryService struct {
	Options []option.RequestOption
}

// NewUdlPassiveradarobservationHistoryService generates a new service that applies
// the given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewUdlPassiveradarobservationHistoryService(opts ...option.RequestOption) (r UdlPassiveradarobservationHistoryService) {
	r = UdlPassiveradarobservationHistoryService{}
	r.Options = opts
	return
}
...
type PassiveradarobservationFull struct {
	...
	DataMode PassiveradarobservationFullDataMode `json:"dataMode,required"`
...
func (r PassiveradarobservationFull) RawJSON() string { return r.JSON.raw }
func (r *PassiveradarobservationFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type PassiveradarobservationFullDataMode string

const (
	PassiveradarobservationFullDataModeReal      PassiveradarobservationFullDataMode = "REAL"
	PassiveradarobservationFullDataModeTest      PassiveradarobservationFullDataMode = "TEST"
	PassiveradarobservationFullDataModeSimulated PassiveradarobservationFullDataMode = "SIMULATED"
	PassiveradarobservationFullDataModeExercise  PassiveradarobservationFullDataMode = "EXERCISE"
)
