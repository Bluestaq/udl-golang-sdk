...
type OrganizationQueryhelpResponse struct {
	...
	Parameters            []OrganizationQueryhelpResponseParameter `json:"parameters"`
...
type OrganizationQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r OrganizationQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *OrganizationQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
