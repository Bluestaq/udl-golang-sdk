...
type OrganizationListResponse struct {
	...
	DataMode OrganizationListResponseDataMode `json:"dataMode" api:"required"`
	// Organization name.
...
type OrganizationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrganizationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Organization name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type OrganizationUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrganizationUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Organization name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
