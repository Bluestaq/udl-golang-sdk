...
func (r *GroundImageryHistoryService) Query(ctx context.Context, query GroundImageryHistoryQueryParams, opts ...option.RequestOption) (res *[]GroundImageryFull, err error) {
	opts = append(r.Options[:], opts...)
