...
func TestMissionAssignmentHistoryListWithOptionalParams(t *testing.T) {
	...
	_, err := client.MissionAssignment.History.List(context.TODO(), unifieddatalibrary.MissionAssignmentHistoryListParams{
		Ts:          time.Now(),
