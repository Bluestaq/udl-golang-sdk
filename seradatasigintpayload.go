...
func (r *SeradataSigintPayloadService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *SeradataSigintPayloadQueryhelpResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type SeradataSigintPayloadListResponse struct {
	...
	DataMode SeradataSigintPayloadListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type SeradataSigintPayloadGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSigintPayloadGetResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeradataSigintPayloadQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r SeradataSigintPayloadQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *SeradataSigintPayloadQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type SeradataSigintPayloadTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSigintPayloadTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeradataSigintPayloadNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSigintPayloadNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
func (r *SeradataSigintPayloadNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type SeradataSigintPayloadUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSigintPayloadUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
func (r *SeradataSigintPayloadUpdateParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
