...
type SeradataSigintPayloadQueryhelpResponse struct {
	...
	Name                  string                                            `json:"name"`
	Parameters            []SeradataSigintPayloadQueryhelpResponseParameter `json:"parameters"`
...
type SeradataSigintPayloadQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SeradataSigintPayloadQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SeradataSigintPayloadQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
