...
// UdlOnorbitthrusterstatusHistoryService contains methods and other services that
// help with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlOnorbitthrusterstatusHistoryService] method instead.
type UdlOnorbitthrusterstatusHistoryService struct {
	Options []option.RequestOption
}

// NewUdlOnorbitthrusterstatusHistoryService generates a new service that applies
// the given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewUdlOnorbitthrusterstatusHistoryService(opts ...option.RequestOption) (r UdlOnorbitthrusterstatusHistoryService) {
	r = UdlOnorbitthrusterstatusHistoryService{}
	r.Options = opts
	return
}
...
func (r *UdlOnorbitthrusterstatusHistoryService) List(ctx context.Context, query UdlOnorbitthrusterstatusHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[OnorbitthrusterstatusFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *UdlOnorbitthrusterstatusHistoryService) ListAutoPaging(ctx context.Context, query UdlOnorbitthrusterstatusHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[OnorbitthrusterstatusFull] {
...
type UdlOnorbitthrusterstatusHistoryListParams struct {
...
func (f UdlOnorbitthrusterstatusHistoryListParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

// URLQuery serializes [UdlOnorbitthrusterstatusHistoryListParams]'s query
// parameters as `url.Values`.
func (r UdlOnorbitthrusterstatusHistoryListParams) URLQuery() (v url.Values, err error) {
