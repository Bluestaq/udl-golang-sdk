...
func (r *ObservationRfobservationHistoryService) List(ctx context.Context, query ObservationRfobservationHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[RfobservationdetailsFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *ObservationRfobservationHistoryService) ListAutoPaging(ctx context.Context, query ObservationRfobservationHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[RfobservationdetailsFull] {
