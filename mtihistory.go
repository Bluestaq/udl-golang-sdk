...
// the [NewMtiHistoryService] method instead.
type MtiHistoryService struct {
	Options []option.RequestOption
}

// NewMtiHistoryService generates a new service that applies the given options to
// each request. These options are applied after the parent client's options (if
// there is one), and before any request-specific options.
func NewMtiHistoryService(opts ...option.RequestOption) (r MtiHistoryService) {
	r = MtiHistoryService{}
	r.Options = opts
	return
}
...
func (r *MtiHistoryService) List(ctx context.Context, query MtiHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[MtiFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *MtiHistoryService) ListAutoPaging(ctx context.Context, query MtiHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[MtiFull] {
...
func (r *MtiHistoryService) Count(ctx context.Context, query MtiHistoryCountParams, opts ...option.RequestOption) (res *string, err error) {
	opts = slices.Concat(r.Options, opts)
...
type MtiFull struct {
	...
	DataMode MtiFullDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type MtiHistoryListParams struct {
...
type MtiHistoryAodrParams struct {
	// Time the row was created in the database. (YYYY-MM-DDTHH:MM:SS.sssZ)
	CreatedAt time.Time `query:"createdAt" api:"required" format:"date" json:"-"`
	// optional, fields for retrieval. When omitted, ALL fields are assumed. See the
	// queryhelp operation (/udl/&lt;datatype&gt;/queryhelp) for more details on valid
...
type MtiHistoryCountParams struct {
	// Time the row was created in the database. (YYYY-MM-DDTHH:MM:SS.sssZ)
	CreatedAt   time.Time        `query:"createdAt" api:"required" format:"date" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
