...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *AnalyticImageryService) History(ctx context.Context, query AnalyticImageryHistoryParams, opts ...option.RequestOption) (res *[]AnalyticImageryAbridged, err error) {
	opts = append(r.Options[:], opts...)
...
type AnalyticImageryQueryhelpResponse struct {
	AodrSupported         bool                                        `json:"aodrSupported"`
	ClassificationMarking string                                      `json:"classificationMarking"`
	Description           string                                      `json:"description"`
	HistorySupported      bool                                        `json:"historySupported"`
	Name                  string                                      `json:"name"`
	Parameters            []AnalyticImageryQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r AnalyticImageryQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *AnalyticImageryQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AnalyticImageryQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AnalyticImageryQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AnalyticImageryQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
