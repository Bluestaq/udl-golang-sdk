...
type LaseremitterListResponse struct {
	...
	DataMode LaseremitterListResponseDataMode `json:"dataMode" api:"required"`
	// The name of this laser within the laser system or facility.
	LaserName string `json:"laserName" api:"required"`
	// The type of laser (e.g. CONTINUOUS WAVE, PULSED, etc.).
	LaserType string `json:"laserType" api:"required"`
	// Source of the data.
...
type LaseremitterGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaseremitterGetResponseDataMode `json:"dataMode" api:"required"`
	// The name of this laser within the laser system or facility.
	LaserName string `json:"laserName" api:"required"`
	// The type of laser (e.g. CONTINUOUS WAVE, PULSED, etc.).
	LaserType string `json:"laserType" api:"required"`
...
type LaseremitterTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaseremitterTupleResponseDataMode `json:"dataMode" api:"required"`
	// The name of this laser within the laser system or facility.
	LaserName string `json:"laserName" api:"required"`
	// The type of laser (e.g. CONTINUOUS WAVE, PULSED, etc.).
	LaserType string `json:"laserType" api:"required"`
...
type LaseremitterNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaseremitterNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The name of this laser within the laser system or facility.
	LaserName string `json:"laserName" api:"required"`
	// The type of laser (e.g. CONTINUOUS WAVE, PULSED, etc.).
	LaserType string `json:"laserType" api:"required"`
...
type LaseremitterUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaseremitterUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The name of this laser within the laser system or facility.
	LaserName string `json:"laserName" api:"required"`
	// The type of laser (e.g. CONTINUOUS WAVE, PULSED, etc.).
	LaserType string `json:"laserType" api:"required"`
