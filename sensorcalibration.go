...
type SensorCalibrationQueryHelpResponse struct {
	...
	Parameters            []SensorCalibrationQueryHelpResponseParameter `json:"parameters"`
...
type SensorCalibrationQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SensorCalibrationQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SensorCalibrationQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
