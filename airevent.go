...
type AirEventListResponse struct {
	...
	DataMode AirEventListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type AirEventGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirEventGetResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Type of air event (e.g. FUEL TRANSFER, AIR DROP, etc).
	Type string `json:"type" api:"required"`
...
type AirEventTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirEventTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Type of air event (e.g. FUEL TRANSFER, AIR DROP, etc).
	Type string `json:"type" api:"required"`
...
type AirEventNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirEventNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Type of air event (e.g. FUEL TRANSFER, AIR DROP, etc).
	Type string `json:"type" api:"required"`
...
type AirEventUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirEventUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Type of air event (e.g. FUEL TRANSFER, AIR DROP, etc).
	Type string `json:"type" api:"required"`
