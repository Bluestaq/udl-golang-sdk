...
type AirEventQueryhelpResponse struct {
	...
	Parameters            []AirEventQueryhelpResponseParameter `json:"parameters"`
...
type AirEventQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AirEventQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AirEventQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
