...
type AirloadplanAbridged struct {
	...
	DataMode AirloadplanAbridgedDataMode `json:"dataMode" api:"required"`
	// The current estimated time that the aircraft is planned to depart, in ISO 8601
	// UTC format with millisecond precision.
	EstDepTime time.Time `json:"estDepTime" api:"required" format:"date-time"`
	// Source of the data.
...
type AirloadPlanNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirloadPlanNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The current estimated time that the aircraft is planned to depart, in ISO 8601
	// UTC format with millisecond precision.
	EstDepTime time.Time `json:"estDepTime" api:"required" format:"date-time"`
	// Source of the data.
...
type AirloadPlanUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirloadPlanUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The current estimated time that the aircraft is planned to depart, in ISO 8601
	// UTC format with millisecond precision.
	EstDepTime time.Time `json:"estDepTime" api:"required" format:"date-time"`
	// Source of the data.
...
type AirloadPlanListParams struct {
	...
	EstDepTime  time.Time        `query:"estDepTime" api:"required" format:"date-time" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
