...
type NavigationalObstructionListResponse struct {
	...
	JSON struct {
		...
		DataMode              resp.Field
		ObstacleID            resp.Field
		ObstacleType          resp.Field
		Source                resp.Field
		ID                    resp.Field
		ActDelCode            resp.Field
		AiracCycle            resp.Field
		BaseAiracCycle        resp.Field
		BaselineCutoffDate    resp.Field
		BoundNeLat            resp.Field
		BoundNeLon            resp.Field
		BoundSwLat            resp.Field
		BoundSwLon            resp.Field
		CountryCode           resp.Field
		CreatedAt             resp.Field
		CreatedBy             resp.Field
		CutoffDate            resp.Field
		DataSetRemarks        resp.Field
		DeletingOrg           resp.Field
		DerivingOrg           resp.Field
		DirectivityCode       resp.Field
		Elevation             resp.Field
		ElevationAcc          resp.Field
		ExternalID            resp.Field
		Facc                  resp.Field
		FeatureCode           resp.Field
		FeatureDescription    resp.Field
		FeatureName           resp.Field
		FeatureType           resp.Field
		HeightAgl             resp.Field
		HeightAglAcc          resp.Field
		HeightMsl             resp.Field
		HeightMslAcc          resp.Field
		HorizAcc              resp.Field
		HorizDatumCode        resp.Field
		InitRecordDate        resp.Field
		Keys                  resp.Field
		LightingCode          resp.Field
		LineNeLat             resp.Field
		LineNeLon             resp.Field
		LinesFilename         resp.Field
		LineSwLat             resp.Field
		LineSwLon             resp.Field
		MinHeightAgl          resp.Field
		MultObs               resp.Field
		NextCycleDate         resp.Field
		NumLines              resp.Field
		NumObs                resp.Field
		NumPoints             resp.Field
		ObstacleRemarks       resp.Field
		OrigID                resp.Field
		Origin                resp.Field
		OrigNetwork           resp.Field
		OwnerCountryCode      resp.Field
		PointLat              resp.Field
		PointLon              resp.Field
		PointsFilename        resp.Field
		ProcessCode           resp.Field
		Producer              resp.Field
		ProvinceCode          resp.Field
		Quality               resp.Field
		RawFileUri            resp.Field
		RevDate               resp.Field
		SegEndPoint           resp.Field
		SegNum                resp.Field
		SegStartPoint         resp.Field
		SourceDate            resp.Field
		SourceDl              resp.Field
		SurfaceMatCode        resp.Field
		TransactionCode       resp.Field
		ValidationCode        resp.Field
		Values                resp.Field
		VectorsFilename       resp.Field
		Wac                   resp.Field
		WacInnr               resp.Field
