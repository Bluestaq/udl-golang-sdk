...
type NavigationalObstructionQueryhelpResponse struct {
	...
	Parameters            []NavigationalObstructionQueryhelpResponseParameter `json:"parameters"`
...
type NavigationalObstructionQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r NavigationalObstructionQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *NavigationalObstructionQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
