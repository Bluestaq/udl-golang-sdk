...
type OrganizationdetailListResponse struct {
	...
	DataMode OrganizationdetailListResponseDataMode `json:"dataMode" api:"required"`
	// Unique identifier of the parent organization.
	IDOrganization string `json:"idOrganization" api:"required"`
...
type OrganizationdetailFindBySourceResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrganizationdetailFindBySourceResponseDataMode `json:"dataMode" api:"required"`
	// Unique identifier of the parent organization.
	IDOrganization string `json:"idOrganization" api:"required"`
	// Organization details name.
	Name string `json:"name" api:"required"`
...
type OrganizationdetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrganizationdetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent organization.
	IDOrganization string `json:"idOrganization" api:"required"`
	// Organization details name.
	Name string `json:"name" api:"required"`
...
type OrganizationdetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrganizationdetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent organization.
	IDOrganization string `json:"idOrganization" api:"required"`
	// Organization details name.
	Name string `json:"name" api:"required"`
