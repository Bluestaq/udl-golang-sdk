...
type AntennaDetailsAbridged struct {
	...
	DataMode AntennaDetailsAbridgedDataMode `json:"dataMode" api:"required"`
...
type OnorbitAntennaDetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitAntennaDetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent Antenna.
	IDAntenna string `json:"idAntenna" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
func (r *OnorbitAntennaDetailNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type OnorbitAntennaDetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitAntennaDetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent Antenna.
	IDAntenna string `json:"idAntenna" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
func (r *OnorbitAntennaDetailUpdateParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
