...
type ManifoldelsetQueryhelpResponse struct {
	...
	Parameters            []ManifoldelsetQueryhelpResponseParameter `json:"parameters"`
...
type ManifoldelsetQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ManifoldelsetQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ManifoldelsetQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
