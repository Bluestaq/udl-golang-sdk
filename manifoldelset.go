...
type ManifoldelsetListResponse struct {
	...
	DataMode ManifoldelsetListResponseDataMode `json:"dataMode" api:"required"`
	...
	IDManifold string `json:"idManifold" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// A placeholder satellite number and not a true NORAD catalog number.
	TmpSatNo int64 `json:"tmpSatNo" api:"required"`
...
type ManifoldelsetGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ManifoldelsetGetResponseDataMode `json:"dataMode" api:"required"`
	// Elset epoch time in ISO 8601 UTC format, with microsecond precision.
	Epoch time.Time `json:"epoch" api:"required" format:"date-time"`
	// Identifier of the parent Manifold record.
	IDManifold string `json:"idManifold" api:"required"`
...
type ManifoldelsetTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ManifoldelsetTupleResponseDataMode `json:"dataMode" api:"required"`
	// Elset epoch time in ISO 8601 UTC format, with microsecond precision.
	Epoch time.Time `json:"epoch" api:"required" format:"date-time"`
	// Identifier of the parent Manifold record.
	IDManifold string `json:"idManifold" api:"required"`
...
type ManifoldelsetNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ManifoldelsetNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Elset epoch time in ISO 8601 UTC format, with microsecond precision.
	Epoch time.Time `json:"epoch" api:"required" format:"date-time"`
	// Identifier of the parent Manifold record.
	IDManifold string `json:"idManifold" api:"required"`
...
type ManifoldelsetUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ManifoldelsetUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Elset epoch time in ISO 8601 UTC format, with microsecond precision.
	Epoch time.Time `json:"epoch" api:"required" format:"date-time"`
	// Identifier of the parent Manifold record.
	IDManifold string `json:"idManifold" api:"required"`
