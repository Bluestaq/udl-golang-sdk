...
type DeconflictsetListResponse struct {
	...
	DataMode DeconflictsetListResponseDataMode `json:"dataMode" api:"required"`
	// The start time of the event associated with the set of DeconflictWindow records,
	// in ISO 8601 UTC format with millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The number of windows provided by this DeconflictSet record.
	NumWindows int64 `json:"numWindows" api:"required"`
	// Source of the data.
...
type DeconflictsetGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DeconflictsetGetResponseDataMode `json:"dataMode" api:"required"`
	// The start time of the event associated with the set of DeconflictWindow records,
	// in ISO 8601 UTC format with millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The number of windows provided by this DeconflictSet record.
...
type DeconflictsetGetResponseDeconflictWindow struct {
	...
	StopTime time.Time `json:"stopTime" api:"required" format:"date-time"`
	// Unique identifier of the record, auto-generated by the system if not provided on
	// create operations.
	ID string `json:"id"`
...
type DeconflictsetTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DeconflictsetTupleResponseDataMode `json:"dataMode" api:"required"`
	// The start time of the event associated with the set of DeconflictWindow records,
	// in ISO 8601 UTC format with millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The number of windows provided by this DeconflictSet record.
...
type DeconflictsetNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DeconflictsetNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The start time of the event associated with the set of DeconflictWindow records,
	// in ISO 8601 UTC format with millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The number of windows provided by this DeconflictSet record.
...
type DeconflictsetListParams struct {
	...
	EventStartTime time.Time        `query:"eventStartTime" api:"required" format:"date-time" json:"-"`
...
type DeconflictsetUnvalidatedPublishParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DeconflictsetUnvalidatedPublishParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The start time of the event associated with the set of DeconflictWindow records,
	// in ISO 8601 UTC format with millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The number of windows provided by this DeconflictSet record.
