...
type OnorbitsolararrayListResponse struct {
	...
	DataMode OnorbitsolararrayListResponseDataMode `json:"dataMode" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// ID of the SolarArray.
	IDSolarArray string `json:"idSolarArray" api:"required"`
	// Source of the data.
...
type OnorbitsolararrayNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitsolararrayNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// ID of the SolarArray.
	IDSolarArray string `json:"idSolarArray" api:"required"`
	...
	// spacecraft may have multiple solar arrays and each solar array can have multiple
	// 'details' records compiled by different sources.
	SolarArray shared.SolarArrayIngestParam `json:"solarArray,omitzero"`
	paramObj
}
...
type OnorbitsolararrayUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitsolararrayUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// ID of the SolarArray.
	IDSolarArray string `json:"idSolarArray" api:"required"`
