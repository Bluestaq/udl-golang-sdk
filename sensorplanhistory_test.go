...
func TestSensorPlanHistoryListWithOptionalParams(t *testing.T) {
	...
	_, err := client.SensorPlan.History.List(context.TODO(), unifieddatalibrary.SensorPlanHistoryListParams{
		StartTime:   time.Now(),
