...
type TaiUtcQueryhelpResponse struct {
	...
	Parameters            []TaiUtcQueryhelpResponseParameter `json:"parameters"`
...
type TaiUtcQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r TaiUtcQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *TaiUtcQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
