...
type OperatingunitremarkListResponse struct {
	...
	DataMode OperatingunitremarkListResponseDataMode `json:"dataMode" api:"required"`
	// The ID of the operating unit to which this remark applies.
	IDOperatingUnit string `json:"idOperatingUnit" api:"required"`
	// Source of the data.
...
type OperatingunitremarkNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OperatingunitremarkNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The ID of the operating unit to which this remark applies.
	IDOperatingUnit string `json:"idOperatingUnit" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
