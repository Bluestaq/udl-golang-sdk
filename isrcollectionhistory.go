...
func (r *IsrCollectionHistoryService) List(ctx context.Context, query IsrCollectionHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[IsrCollectionFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *IsrCollectionHistoryService) ListAutoPaging(ctx context.Context, query IsrCollectionHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[IsrCollectionFull] {
