...
type IsrCollectionHistoryListResponse struct {
	...
	CollectionRequirements []IsrCollectionHistoryListResponseCollectionRequirement `json:"collectionRequirements"`
...
type IsrCollectionHistoryListResponseCollectionRequirement struct {
	...
	CriticalTimes IsrCollectionHistoryListResponseCollectionRequirementCriticalTimes `json:"criticalTimes"`
	// Is this collection requirement an emphasized/critical requirement.
	Emphasized              bool                                                                         `json:"emphasized"`
	ExploitationRequirement IsrCollectionHistoryListResponseCollectionRequirementExploitationRequirement `json:"exploitationRequirement"`
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseCollectionRequirement) RawJSON() string { return r.JSON.raw }
func (r *IsrCollectionHistoryListResponseCollectionRequirement) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type IsrCollectionHistoryListResponseCollectionRequirementCriticalTimes struct {
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseCollectionRequirementCriticalTimes) RawJSON() string {
	return r.JSON.raw
}
func (r *IsrCollectionHistoryListResponseCollectionRequirementCriticalTimes) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type IsrCollectionHistoryListResponseCollectionRequirementExploitationRequirement struct {
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseCollectionRequirementExploitationRequirement) RawJSON() string {
	return r.JSON.raw
}
func (r *IsrCollectionHistoryListResponseCollectionRequirementExploitationRequirement) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type IsrCollectionHistoryListResponseCollectionRequirementExploitationRequirementPoc struct {
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseCollectionRequirementExploitationRequirementPoc) RawJSON() string {
	return r.JSON.raw
}
func (r *IsrCollectionHistoryListResponseCollectionRequirementExploitationRequirementPoc) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type IsrCollectionHistoryListResponseTasking struct {
	...
	TaskingCollectionRequirements []IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirement `json:"taskingCollectionRequirements"`
...
type IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirement struct {
	// Collection Requirement Unique Identifier.
	ID string `json:"id"`
	// Country code of the collection requirement. A Country may represent countries,
	// multi-national consortiums, and international organizations.
	...
	// Collection Requirement Unique Identifier.
	CridNumbers   string                                                                           `json:"cridNumbers"`
	CriticalTimes IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementCriticalTimes `json:"criticalTimes"`
	// Is this collection requirement an emphasized/critical requirement.
	Emphasized              bool                                                                                       `json:"emphasized"`
	ExploitationRequirement IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementExploitationRequirement `json:"exploitationRequirement"`
	// Encryption hashing algorithm.
	Hash string `json:"hash"`
	// Primary type of intelligence to be collected for this requirement.
	IntelDiscipline string `json:"intelDiscipline"`
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirement) RawJSON() string {
	return r.JSON.raw
}
func (r *IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirement) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementCriticalTimes struct {
	// Critical start time to collect an image for this requirement.
	EarliestImagingTime time.Time `json:"earliestImagingTime,required" format:"date-time"`
	// Critical stop time to collect an image for this requirement.
	LatestImagingTime time.Time `json:"latestImagingTime,required" format:"date-time"`
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementCriticalTimes) RawJSON() string {
	return r.JSON.raw
}
func (r *IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementCriticalTimes) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementExploitationRequirement struct {
	// Exploitation requirement id.
	ID string `json:"id"`
	// Amplifying data for the exploitation requirement.
	Amplification string `json:"amplification"`
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementExploitationRequirement) RawJSON() string {
	return r.JSON.raw
}
func (r *IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementExploitationRequirement) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementExploitationRequirementPoc struct {
	// Unique identifier of the collection requirement POC.
	ID string `json:"id"`
	// Callsign of the POC.
	Callsign string `json:"callsign"`
...
// Returns the unmodified JSON received from the API
func (r IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementExploitationRequirementPoc) RawJSON() string {
	return r.JSON.raw
}
func (r *IsrCollectionHistoryListResponseTaskingTaskingCollectionRequirementExploitationRequirementPoc) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
