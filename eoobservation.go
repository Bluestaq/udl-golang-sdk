...
type EoObservationService struct {
	...
	History EoObservationHistoryService
}
...
func NewEoObservationService(opts ...option.RequestOption) (r EoObservationService) {
	...
	r.Options = opts
	r.History = NewEoObservationHistoryService(opts...)
	return
}
...
// mechanism.
func (r *EoObservationService) New(ctx context.Context, body EoObservationNewParams, opts ...option.RequestOption) (err error) {
...
func (r *EoObservationService) List(ctx context.Context, query EoObservationListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[EoObservationAbridged], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *EoObservationService) ListAutoPaging(ctx context.Context, query EoObservationListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[EoObservationAbridged] {
...
func (r *EoObservationService) Count(ctx context.Context, query EoObservationCountParams, opts ...option.RequestOption) (res *string, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *EoObservationService) NewBulk(ctx context.Context, params EoObservationNewBulkParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
func (r *EoObservationService) UnvalidatedPublish(ctx context.Context, body EoObservationUnvalidatedPublishParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
type EoObservationAbridged struct {
	...
	JSON struct {
		...
		BgIntensity           resp.Field
		CollectMethod         resp.Field
		CorrQuality           resp.Field
		CreatedAt             resp.Field
		CreatedBy             resp.Field
		Declination           resp.Field
		DeclinationBias       resp.Field
		DeclinationMeasured   resp.Field
		DeclinationRate       resp.Field
		DeclinationUnc        resp.Field
		...
		ExpDuration           resp.Field
		FovCount              resp.Field
		FovCountUct           resp.Field
		Geoalt                resp.Field
		Geolat                resp.Field
		Geolon                resp.Field
		Georange              resp.Field
		...
		IDSensor              resp.Field
		IDSkyImagery          resp.Field
		Intensity             resp.Field
		LosUnc                resp.Field
		Losx                  resp.Field
		Losxvel               resp.Field
		Losy                  resp.Field
		...
		Loszvel               resp.Field
		Mag                   resp.Field
		MagNormRange          resp.Field
		MagUnc                resp.Field
		NetObjSig             resp.Field
		NetObjSigUnc          resp.Field
		...
		Penumbra              resp.Field
		PrimaryExtinction     resp.Field
		PrimaryExtinctionUnc  resp.Field
		Ra                    resp.Field
		RaBias                resp.Field
		...
		Seny                  resp.Field
		Senz                  resp.Field
		ShutterDelay          resp.Field
		SkyBkgrnd             resp.Field
		SolarDecAngle         resp.Field
		SolarEqPhaseAngle     resp.Field
...
type EoObservationNewParams struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EoObservationNewParamsDataMode `json:"dataMode,omitzero,required"`
	// Ob detection time in ISO 8601 UTC, up to microsecond precision. Consumers should
	// contact the provider for details on their obTime specifications.
	ObTime time.Time `json:"obTime,required" format:"date-time"`
	// Source of the data.
	...
	EoobservationDetails EoObservationNewParamsEoobservationDetails `json:"eoobservationDetails,omitzero"`
	// The reference frame of the EOObservation measurements. If the referenceFrame is
	// null it is assumed to be J2000.
	//
	// Any of "J2000", "GCRF", "ITRF", "TEME".
	ReferenceFrame EoObservationNewParamsReferenceFrame `json:"referenceFrame,omitzero"`
	// The quaternion describing the rotation of the sensor in relation to the
	// body-fixed frame used for this system into the local geodetic frame, at
	// observation time (obTime). The array element order convention is scalar
	// component first, followed by the three vector components (qc, q1, q2, q3).
	...
	//
	// Any of "J2000", "EFG/TDR", "ECR/ECEF", "TEME", "ITRF", "GCRF".
	SenReferenceFrame EoObservationNewParamsSenReferenceFrame `json:"senReferenceFrame,omitzero"`
...
func (f EoObservationNewParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

func (r EoObservationNewParams) MarshalJSON() (data []byte, err error) {
	type shadow EoObservationNewParams
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type EoObservationNewParamsDataMode string

const (
	EoObservationNewParamsDataModeReal      EoObservationNewParamsDataMode = "REAL"
	EoObservationNewParamsDataModeTest      EoObservationNewParamsDataMode = "TEST"
	EoObservationNewParamsDataModeSimulated EoObservationNewParamsDataMode = "SIMULATED"
	EoObservationNewParamsDataModeExercise  EoObservationNewParamsDataMode = "EXERCISE"
)

// Model representation of additional detailed observation data for electro-optical
// based sensor phenomenologies.
type EoObservationNewParamsEoobservationDetails struct {
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationNewParamsEoobservationDetails) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
func (r EoObservationNewParamsEoobservationDetails) MarshalJSON() (data []byte, err error) {
	type shadow EoObservationNewParamsEoobservationDetails
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[EoObservationNewParamsEoobservationDetails](
...
// The reference frame of the EOObservation measurements. If the referenceFrame is
// null it is assumed to be J2000.
type EoObservationNewParamsReferenceFrame string

const (
	EoObservationNewParamsReferenceFrameJ2000 EoObservationNewParamsReferenceFrame = "J2000"
	EoObservationNewParamsReferenceFrameGcrf  EoObservationNewParamsReferenceFrame = "GCRF"
	EoObservationNewParamsReferenceFrameItrf  EoObservationNewParamsReferenceFrame = "ITRF"
	EoObservationNewParamsReferenceFrameTeme  EoObservationNewParamsReferenceFrame = "TEME"
)

// The reference frame of the observing sensor state. If the senReferenceFrame is
// null it is assumed to be J2000.
type EoObservationNewParamsSenReferenceFrame string

const (
	EoObservationNewParamsSenReferenceFrameJ2000   EoObservationNewParamsSenReferenceFrame = "J2000"
	EoObservationNewParamsSenReferenceFrameEfgTdr  EoObservationNewParamsSenReferenceFrame = "EFG/TDR"
	EoObservationNewParamsSenReferenceFrameEcrEcef EoObservationNewParamsSenReferenceFrame = "ECR/ECEF"
	EoObservationNewParamsSenReferenceFrameTeme    EoObservationNewParamsSenReferenceFrame = "TEME"
	EoObservationNewParamsSenReferenceFrameItrf    EoObservationNewParamsSenReferenceFrame = "ITRF"
	EoObservationNewParamsSenReferenceFrameGcrf    EoObservationNewParamsSenReferenceFrame = "GCRF"
)

type EoObservationListParams struct {
	// Ob detection time in ISO 8601 UTC, up to microsecond precision. Consumers should
	// contact the provider for details on their obTime specifications.
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationListParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [EoObservationListParams]'s query parameters as
// `url.Values`.
func (r EoObservationListParams) URLQuery() (v url.Values, err error) {
...
type EoObservationCountParams struct {
	// Ob detection time in ISO 8601 UTC, up to microsecond precision. Consumers should
	// contact the provider for details on their obTime specifications.
	// (YYYY-MM-DDTHH:MM:SS.ssssssZ)
	ObTime      time.Time        `query:"obTime,required" format:"date-time" json:"-"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationCountParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [EoObservationCountParams]'s query parameters as
// `url.Values`.
func (r EoObservationCountParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type EoObservationNewBulkParams struct {
	Body []EoObservationNewBulkParamsBody
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationNewBulkParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

func (r EoObservationNewBulkParams) MarshalJSON() (data []byte, err error) {
	return json.Marshal(r.Body)
}

// URLQuery serializes [EoObservationNewBulkParams]'s query parameters as
// `url.Values`.
func (r EoObservationNewBulkParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type EoObservationNewBulkParamsBody struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	// Model representation of additional detailed observation data for electro-optical
	// based sensor phenomenologies.
	EoobservationDetails EoObservationNewBulkParamsBodyEoobservationDetails `json:"eoobservationDetails,omitzero"`
	// The reference frame of the EOObservation measurements. If the referenceFrame is
	// null it is assumed to be J2000.
	//
	// Any of "J2000", "GCRF", "ITRF", "TEME".
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationNewBulkParamsBody) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }
func (r EoObservationNewBulkParamsBody) MarshalJSON() (data []byte, err error) {
	type shadow EoObservationNewBulkParamsBody
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[EoObservationNewBulkParamsBody](
		"DataMode", false, "REAL", "TEST", "SIMULATED", "EXERCISE",
	)
	apijson.RegisterFieldValidator[EoObservationNewBulkParamsBody](
...
// Model representation of additional detailed observation data for electro-optical
// based sensor phenomenologies.
type EoObservationNewBulkParamsBodyEoobservationDetails struct {
	// World Coordinate System (WCS) X pixel origin in astrometric fit.
	AcalCrPixX param.Opt[float64] `json:"acalCrPixX,omitzero"`
	// World Coordinate System (WCS) Y pixel origin in astrometric fit.
	AcalCrPixY param.Opt[float64] `json:"acalCrPixY,omitzero"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationNewBulkParamsBodyEoobservationDetails) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
func (r EoObservationNewBulkParamsBodyEoobservationDetails) MarshalJSON() (data []byte, err error) {
	type shadow EoObservationNewBulkParamsBodyEoobservationDetails
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[EoObservationNewBulkParamsBodyEoobservationDetails](
		"DataMode", false, "REAL", "TEST", "SIMULATED", "EXERCISE",
	)
}

type EoObservationUnvalidatedPublishParams struct {
	Body []EoObservationUnvalidatedPublishParamsBody
	paramObj
}

// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationUnvalidatedPublishParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

func (r EoObservationUnvalidatedPublishParams) MarshalJSON() (data []byte, err error) {
	return json.Marshal(r.Body)
}
...
//
// The properties ClassificationMarking, DataMode, ObTime, Source are required.
type EoObservationUnvalidatedPublishParamsBody struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	// Model representation of additional detailed observation data for electro-optical
	// based sensor phenomenologies.
	EoobservationDetails EoObservationUnvalidatedPublishParamsBodyEoobservationDetails `json:"eoobservationDetails,omitzero"`
	// The reference frame of the EOObservation measurements. If the referenceFrame is
	// null it is assumed to be J2000.
	//
	// Any of "J2000", "GCRF", "ITRF", "TEME".
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationUnvalidatedPublishParamsBody) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
func (r EoObservationUnvalidatedPublishParamsBody) MarshalJSON() (data []byte, err error) {
	type shadow EoObservationUnvalidatedPublishParamsBody
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[EoObservationUnvalidatedPublishParamsBody](
		"DataMode", false, "REAL", "TEST", "SIMULATED", "EXERCISE",
	)
	apijson.RegisterFieldValidator[EoObservationUnvalidatedPublishParamsBody](
		"ReferenceFrame", false, "J2000", "GCRF", "ITRF", "TEME",
...
// Model representation of additional detailed observation data for electro-optical
// based sensor phenomenologies.
type EoObservationUnvalidatedPublishParamsBodyEoobservationDetails struct {
	// World Coordinate System (WCS) X pixel origin in astrometric fit.
	AcalCrPixX param.Opt[float64] `json:"acalCrPixX,omitzero"`
	// World Coordinate System (WCS) Y pixel origin in astrometric fit.
	AcalCrPixY param.Opt[float64] `json:"acalCrPixY,omitzero"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f EoObservationUnvalidatedPublishParamsBodyEoobservationDetails) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
func (r EoObservationUnvalidatedPublishParamsBodyEoobservationDetails) MarshalJSON() (data []byte, err error) {
	type shadow EoObservationUnvalidatedPublishParamsBodyEoobservationDetails
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[EoObservationUnvalidatedPublishParamsBodyEoobservationDetails](
		"DataMode", false, "REAL", "TEST", "SIMULATED", "EXERCISE",
	)
}
