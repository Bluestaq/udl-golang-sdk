...
func TestSensorCalibrationNewWithOptionalParams(t *testing.T) {
	...
	err := client.Sensor.Calibration.New(context.TODO(), unifieddatalibrary.SensorCalibrationNewParams{
		...
		AzRaBiasRate:          unifieddatalibrary.Float(0.123),
		AzRaMean:              unifieddatalibrary.Float(0.083222),
		AzRaRms:               unifieddatalibrary.Float(0.605333),
		AzRaSigmaRate:         unifieddatalibrary.Float(0.123),
		...
		ElDecBiasRate:         unifieddatalibrary.Float(0.123),
		ElDecMean:             unifieddatalibrary.Float(0.004025),
		ElDecRms:              unifieddatalibrary.Float(0.080505),
		ElDecSigmaRate:        unifieddatalibrary.Float(0.123),
...
func TestSensorCalibrationQueryHelp(t *testing.T) {
	...
	err := client.Sensor.Calibration.QueryHelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
