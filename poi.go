...
type PoiListResponse struct {
	...
	DataMode PoiListResponseDataMode `json:"dataMode" api:"required"`
	...
	Poiid string `json:"poiid" api:"required"`
	// Source of the data.
...
type PoiGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode PoiGetResponseDataMode `json:"dataMode" api:"required"`
	// Name of the POI target object.
	Name string `json:"name" api:"required"`
	// Identifier of the actual Point of Interest or target object, which should remain
	// the same on subsequent POI records of the same Point of Interest.
...
type PoiQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r PoiQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *PoiQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type PoiTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode PoiTupleResponseDataMode `json:"dataMode" api:"required"`
	// Name of the POI target object.
	Name string `json:"name" api:"required"`
	// Identifier of the actual Point of Interest or target object, which should remain
	// the same on subsequent POI records of the same Point of Interest.
...
type PoiNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode PoiNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Name of the POI target object.
	Name string `json:"name" api:"required"`
	// Identifier of the actual Point of Interest or target object, which should remain
	// the same on subsequent POI records of the same Point of Interest.
