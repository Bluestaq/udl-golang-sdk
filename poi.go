...
type PoiQueryhelpResponse struct {
	...
	Parameters            []PoiQueryhelpResponseParameter `json:"parameters"`
...
type PoiQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r PoiQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *PoiQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
