...
func TestRfobservationNewWithOptionalParams(t *testing.T) {
	...
	err := client.Rfobservation.New(context.TODO(), unifieddatalibrary.RfobservationNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.RfobservationNewParamsDataModeTest,
		ObTime:                time.Now(),
		Source:                "Bluestaq",
		Type:                  "RF",
		...
		PolarityType:          unifieddatalibrary.RfobservationNewParamsPolarityTypeH,
...
func TestRfobservationListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Rfobservation.List(context.TODO(), unifieddatalibrary.RfobservationListParams{
		ObTime:      time.Now(),
...
func TestRfobservationCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Rfobservation.Count(context.TODO(), unifieddatalibrary.RfobservationCountParams{
		ObTime:      time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestRfobservationNewBulk(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Rfobservation.NewBulk(context.TODO(), unifieddatalibrary.RfobservationNewBulkParams{
		Body: []unifieddatalibrary.RfobservationNewBulkParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			ObTime:                time.Now(),
			Source:                "Bluestaq",
...
func TestRfobservationGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Rfobservation.Get(
		context.TODO(),
		"id",
		unifieddatalibrary.RfobservationGetParams{
			FirstResult: unifieddatalibrary.Int(0),
			MaxResults:  unifieddatalibrary.Int(0),
		},
	)
...
func TestRfobservationQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Rfobservation.Queryhelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestRfobservationTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Rfobservation.Tuple(context.TODO(), unifieddatalibrary.RfobservationTupleParams{
		Columns:     "columns",
		ObTime:      time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
...
func TestRfobservationUnvalidatedPublish(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Rfobservation.UnvalidatedPublish(context.TODO(), unifieddatalibrary.RfobservationUnvalidatedPublishParams{
		Body: []unifieddatalibrary.RfobservationUnvalidatedPublishParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			ObTime:                time.Now(),
			Source:                "Bluestaq",
