...
type EoObservationAbridged struct {
	...
	DataMode EoObservationAbridgedDataMode `json:"dataMode" api:"required"`
...
type ObservationEoObservationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationEoObservationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Ob detection time in ISO 8601 UTC, up to microsecond precision. Consumers should
	// contact the provider for details on their obTime specifications.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
...
type ObservationEoObservationNewParamsEoobservationDetails struct {
	...
	ImageFovHeight param.Opt[float64] `json:"imageFOVHeight,omitzero"`
	// Width of the image field of view, in degrees.
	ImageFovWidth param.Opt[float64] `json:"imageFOVWidth,omitzero"`
	...
	// should be assumed.
	ImageBoreRaDec []float64 `json:"imageBoreRaDec,omitzero"`
	...
	ImageBoreVector []float64 `json:"imageBoreVector,omitzero"`
	...
	// DEC] ].
	ImageCorners [][]float64 `json:"imageCorners,omitzero"`
	...
	ImageHorizVector []float64 `json:"imageHorizVector,omitzero"`
	// Unit vector of the vertical (y) axis of the image plane, in the specified
	// referenceFrame. If referenceFrame is null then J2K should be assumed.
	ImageVertVector []float64 `json:"imageVertVector,omitzero"`
