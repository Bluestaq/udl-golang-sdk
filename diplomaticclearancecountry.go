...
type DiplomaticClearanceCountryGetResponse struct {
	...
	DataMode DiplomaticClearanceCountryGetResponseDataMode `json:"dataMode" api:"required"`
	// Last time this country's diplomatic clearance profile information was updated,
	// in ISO 8601 UTC format with millisecond precision.
	LastChangedDate time.Time `json:"lastChangedDate" api:"required" format:"date-time"`
	// Source of the data.
...
type DiplomaticClearanceCountryListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DiplomaticClearanceCountryListResponseDataMode `json:"dataMode" api:"required"`
	// Last time this country's diplomatic clearance profile information was updated,
	// in ISO 8601 UTC format with millisecond precision.
	LastChangedDate time.Time `json:"lastChangedDate" api:"required" format:"date-time"`
	// Source of the data.
...
type DiplomaticClearanceCountryTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DiplomaticClearanceCountryTupleResponseDataMode `json:"dataMode" api:"required"`
	// Last time this country's diplomatic clearance profile information was updated,
	// in ISO 8601 UTC format with millisecond precision.
	LastChangedDate time.Time `json:"lastChangedDate" api:"required" format:"date-time"`
	// Source of the data.
...
type DiplomaticClearanceCountryNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DiplomaticClearanceCountryNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Last time this country's diplomatic clearance profile information was updated,
	// in ISO 8601 UTC format with millisecond precision.
	LastChangedDate time.Time `json:"lastChangedDate" api:"required" format:"date-time"`
	// Source of the data.
...
type DiplomaticClearanceCountryUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DiplomaticClearanceCountryUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Last time this country's diplomatic clearance profile information was updated,
	// in ISO 8601 UTC format with millisecond precision.
	LastChangedDate time.Time `json:"lastChangedDate" api:"required" format:"date-time"`
	// Source of the data.
