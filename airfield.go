...
type AirfieldAbridged struct {
	...
	DataMode AirfieldAbridgedDataMode `json:"dataMode" api:"required"`
...
type AirfieldNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The name of the airfield.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AirfieldUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The name of the airfield.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
