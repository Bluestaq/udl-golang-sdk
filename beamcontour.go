...
// parameter.
func (r *BeamContourService) Get(ctx context.Context, id string, query BeamContourGetParams, opts ...option.RequestOption) (res *BeamcontourFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
// hours ago.
func (r *BeamContourService) Tuple(ctx context.Context, query BeamContourTupleParams, opts ...option.RequestOption) (res *[]BeamcontourFull, err error) {
	opts = append(r.Options[:], opts...)
...
type BeamContourQueryHelpResponse struct {
	...
	Parameters            []BeamContourQueryHelpResponseParameter `json:"parameters"`
...
type BeamContourQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r BeamContourQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *BeamContourQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
