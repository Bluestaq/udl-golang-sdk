...
type BeamcontourAbridged struct {
	...
	DataMode BeamcontourAbridgedDataMode `json:"dataMode" api:"required"`
	// ID of the beam.
	IDBeam string `json:"idBeam" api:"required"`
	// Source of the data.
	...
	Type BeamcontourAbridgedType `json:"type" api:"required"`
...
type BeamContourNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BeamContourNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the beam.
	IDBeam string `json:"idBeam" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	...
	//
	// Any of "BORESIGHT", "CONTOUR", "SVC AREA".
	Type BeamContourNewParamsType `json:"type,omitzero" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
...
type BeamContourUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BeamContourUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the beam.
	IDBeam string `json:"idBeam" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	...
	//
	// Any of "BORESIGHT", "CONTOUR", "SVC AREA".
	Type BeamContourUpdateParamsType `json:"type,omitzero" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID param.Opt[string] `json:"id,omitzero"`
	// The index number of this contour. The value is required if type = CONTOUR.
	ContourIdx param.Opt[int64] `json:"contourIdx,omitzero"`
...
type BeamContourListParams struct {
	// ID of the beam.
	IDBeam      string           `query:"idBeam" api:"required" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
