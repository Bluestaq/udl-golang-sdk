...
func (r *BeamContourService) QueryHelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
type BeamcontourAbridged struct {
	...
	JSON struct {
		...
		Type                  resp.Field
		ID                    resp.Field
		ContourIdx            resp.Field
		CreatedAt             resp.Field
		CreatedBy             resp.Field
		Gain                  resp.Field
		GeographyJson         resp.Field
		GeographyNdims        resp.Field
		GeographySrid         resp.Field
		GeographyText         resp.Field
		GeographyType         resp.Field
		Origin                resp.Field
