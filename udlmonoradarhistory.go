...
// UdlMonoradarHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlMonoradarHistoryService] method instead.
type UdlMonoradarHistoryService struct {
	Options []option.RequestOption
}

// NewUdlMonoradarHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlMonoradarHistoryService(opts ...option.RequestOption) (r UdlMonoradarHistoryService) {
	r = UdlMonoradarHistoryService{}
	r.Options = opts
	return
}
...
type MonoRadarFull struct {
	...
	DataMode MonoRadarFullDataMode `json:"dataMode,required"`
...
func (r MonoRadarFull) RawJSON() string { return r.JSON.raw }
func (r *MonoRadarFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type MonoRadarFullDataMode string

const (
	MonoRadarFullDataModeReal      MonoRadarFullDataMode = "REAL"
	MonoRadarFullDataModeTest      MonoRadarFullDataMode = "TEST"
	MonoRadarFullDataModeSimulated MonoRadarFullDataMode = "SIMULATED"
	MonoRadarFullDataModeExercise  MonoRadarFullDataMode = "EXERCISE"
)
