...
type OnorbitassessmentListResponse struct {
	...
	AssmtTime time.Time `json:"assmtTime" api:"required" format:"date-time"`
	...
	DataMode OnorbitassessmentListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type OnorbitassessmentGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitassessmentGetResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type OnorbitassessmentTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitassessmentTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type OnorbitassessmentNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitassessmentNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
...
type OnorbitassessmentListParams struct {
	...
	AssmtTime   time.Time        `query:"assmtTime" api:"required" format:"date-time" json:"-"`
