...
func TestEphemerisListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Ephemeris.List(context.TODO(), unifieddatalibrary.EphemerisListParams{
		EsID:        "esId",
...
func TestEphemerisCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ephemeris.Count(context.TODO(), unifieddatalibrary.EphemerisCountParams{
		EsID:        "esId",
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestEphemerisFileUploadWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Ephemeris.FileUpload(context.TODO(), unifieddatalibrary.EphemerisFileUploadParams{
		Category:        "category",
		Classification:  "classification",
		DataMode:        unifieddatalibrary.EphemerisFileUploadParamsDataModeReal,
		EphemFormatType: unifieddatalibrary.EphemerisFileUploadParamsEphemFormatTypeModItc,
		HasMnvr:         true,
		SatNo:           0,
		Source:          "source",
		Type:            "type",
...
func TestEphemerisQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ephemeris.Queryhelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestEphemerisTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Ephemeris.Tuple(context.TODO(), unifieddatalibrary.EphemerisTupleParams{
		Columns:     "columns",
		EsID:        "esId",
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
...
func TestEphemerisUnvalidatedPublishWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Ephemeris.UnvalidatedPublish(context.TODO(), unifieddatalibrary.EphemerisUnvalidatedPublishParams{
		Category:              "ANALYST",
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.EphemerisUnvalidatedPublishParamsDataModeTest,
		NumPoints:             1,
		...
		CovReferenceFrame:     unifieddatalibrary.EphemerisUnvalidatedPublishParamsCovReferenceFrameJ2000,
		...
		EphemerisList: []unifieddatalibrary.EphemerisUnvalidatedPublishParamsEphemerisList{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			Source:                "Bluestaq",
			Ts:                    time.Now(),
		...
		ReferenceFrame:      unifieddatalibrary.EphemerisUnvalidatedPublishParamsReferenceFrameJ2000,
