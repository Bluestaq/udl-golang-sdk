...
type TransponderListResponse struct {
	...
	DataMode TransponderListResponseDataMode `json:"dataMode" api:"required"`
	// ID of the parent Comm object for this transponder.
	IDComm string `json:"idComm" api:"required"`
	// Source of the data.
...
type TransponderGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode TransponderGetResponseDataMode `json:"dataMode" api:"required"`
	// ID of the parent Comm object for this transponder.
	IDComm string `json:"idComm" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	...
	Channels []shared.ChannelFull `json:"channels"`
	// Time the row was created in the database, auto-populated by the system.
	CreatedAt time.Time `json:"createdAt" format:"date-time"`
	// Application user who created the row in the database, auto-populated by the
	// system.
...
type TransponderTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode TransponderTupleResponseDataMode `json:"dataMode" api:"required"`
	// ID of the parent Comm object for this transponder.
	IDComm string `json:"idComm" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type TransponderNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode TransponderNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the parent Comm object for this transponder.
	IDComm string `json:"idComm" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type TransponderUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode TransponderUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the parent Comm object for this transponder.
	IDComm string `json:"idComm" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
