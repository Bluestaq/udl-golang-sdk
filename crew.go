...
type CrewAbridged struct {
	...
	DataMode CrewAbridgedDataMode `json:"dataMode" api:"required"`
	...
	OrigCrewID string `json:"origCrewId" api:"required"`
	// Source of the data.
...
type CrewNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CrewNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the formed crew provided by the originating source.
	// Provided for systems that require tracking of an internal system generated ID.
	OrigCrewID string `json:"origCrewId" api:"required"`
	// Source of the data.
...
type CrewUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CrewUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the formed crew provided by the originating source.
	// Provided for systems that require tracking of an internal system generated ID.
	OrigCrewID string `json:"origCrewId" api:"required"`
	// Source of the data.
