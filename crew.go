...
// parameter.
func (r *CrewService) Get(ctx context.Context, id string, query CrewGetParams, opts ...option.RequestOption) (res *CrewFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
func (r *CrewService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// hours ago.
func (r *CrewService) Tuple(ctx context.Context, query CrewTupleParams, opts ...option.RequestOption) (res *[]CrewFull, err error) {
	opts = append(r.Options[:], opts...)
	path := "udl/crew/tuple"
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, query, &res, opts...)
	return
...
type CrewAbridged struct {
	...
	JSON struct {
		...
		DataMode              resp.Field
		OrigCrewID            resp.Field
		Source                resp.Field
		ID                    resp.Field
		AdjReturnTime         resp.Field
		AdjReturnTimeApprover resp.Field
		AircraftMds           resp.Field
		AlertedTime           resp.Field
		AlertType             resp.Field
		ArmsCrewUnit          resp.Field
		AssignedQualCode      resp.Field
		CommanderID           resp.Field
		CommanderLast4Ssn     resp.Field
		CommanderName         resp.Field
		CreatedAt             resp.Field
		CreatedBy             resp.Field
		CrewHome              resp.Field
		CrewMembers           resp.Field
		CrewName              resp.Field
		CrewRms               resp.Field
		CrewRole              resp.Field
		CrewSource            resp.Field
		CrewSquadron          resp.Field
		CrewType              resp.Field
		CrewUnit              resp.Field
		CrewWing              resp.Field
		CurrentIcao           resp.Field
		FdpEligType           resp.Field
		FdpType               resp.Field
		FemaleEnlistedQty     resp.Field
		FemaleOfficerQty      resp.Field
		FltAuthNum            resp.Field
		IDSiteCurrent         resp.Field
		IDSortie              resp.Field
		InitStartTime         resp.Field
		LastAlertTime         resp.Field
		LegalAlertTime        resp.Field
		LegalBravoTime        resp.Field
		LinkedTask            resp.Field
		MaleEnlistedQty       resp.Field
		MaleOfficerQty        resp.Field
		MissionAlias          resp.Field
		MissionID             resp.Field
		Origin                resp.Field
		OrigNetwork           resp.Field
		PersonnelType         resp.Field
		PickupTime            resp.Field
		PostRestApplied       resp.Field
		PostRestEnd           resp.Field
		PostRestOffset        resp.Field
		PreRestApplied        resp.Field
		PreRestStart          resp.Field
		ReqQualCode           resp.Field
		ReturnTime            resp.Field
		SourceDl              resp.Field
		Stage1Qual            resp.Field
		Stage2Qual            resp.Field
		Stage3Qual            resp.Field
		StageName             resp.Field
		StageTime             resp.Field
		Status                resp.Field
		TransportReq          resp.Field
		TripKit               resp.Field
...
type CrewAbridgedCrewMember struct {
	...
	JSON struct {
		...
		Branch                      resp.Field
		Civilian                    resp.Field
		Commander                   resp.Field
		CrewPosition                resp.Field
		DodID                       resp.Field
		DutyPosition                resp.Field
		DutyStatus                  resp.Field
		Emailed                     resp.Field
		ExtraTime                   resp.Field
		FirstName                   resp.Field
		FltCurrencyExp              resp.Field
		FltCurrencyExpID            resp.Field
		FltRecDate                  resp.Field
		FltRecDue                   resp.Field
		FlySquadron                 resp.Field
		Funded                      resp.Field
		Gender                      resp.Field
		GndCurrencyExp              resp.Field
		GndCurrencyExpID            resp.Field
		Grounded                    resp.Field
		GuestStart                  resp.Field
		GuestStop                   resp.Field
		Last4Ssn                    resp.Field
		LastFltDate                 resp.Field
		LastName                    resp.Field
		LoanedTo                    resp.Field
		Lodging                     resp.Field
		MemberActualAlertTime       resp.Field
		MemberAdjReturnTime         resp.Field
		MemberAdjReturnTimeApprover resp.Field
		MemberID                    resp.Field
		MemberInitStartTime         resp.Field
		MemberLastAlertTime         resp.Field
		MemberLegalAlertTime        resp.Field
		MemberPickupTime            resp.Field
		MemberPostRestOffset        resp.Field
		MemberPostRestTime          resp.Field
		MemberPreRestTime           resp.Field
		MemberRemarks               resp.Field
		MemberReturnTime            resp.Field
		MemberSchedAlertTime        resp.Field
		MemberSource                resp.Field
		MemberStageName             resp.Field
		MemberTransportReq          resp.Field
		MemberType                  resp.Field
		MiddleInitial               resp.Field
		Notified                    resp.Field
		PhoneNumber                 resp.Field
		PhysAvCode                  resp.Field
		PhysAvStatus                resp.Field
		PhysDue                     resp.Field
		Rank                        resp.Field
		RemarkCode                  resp.Field
		RmsMds                      resp.Field
		ShowTime                    resp.Field
		Squadron                    resp.Field
		TrainingDate                resp.Field
		Username                    resp.Field
		Wing                        resp.Field
		ExtraFields                 map[string]resp.Field
		raw                         string
