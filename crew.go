...
type CrewQueryhelpResponse struct {
	...
	Parameters            []CrewQueryhelpResponseParameter `json:"parameters"`
...
type CrewQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r CrewQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *CrewQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
