...
func TestObservationPassiveRadarObservationNewWithOptionalParams(t *testing.T) {
	...
	err := client.Observations.PassiveRadarObservation.New(context.TODO(), unifieddatalibrary.ObservationPassiveRadarObservationNewParams{
		...
		SenReferenceFrame:     unifieddatalibrary.ObservationPassiveRadarObservationNewParamsSenReferenceFrameJ2000,
		Senx:                  unifieddatalibrary.Float(-4527.793),
		Seny:                  unifieddatalibrary.Float(3793.586),
		Senz:                  unifieddatalibrary.Float(3553.495),
...
func TestObservationPassiveRadarObservationQueryhelp(t *testing.T) {
	...
	_, err := client.Observations.PassiveRadarObservation.Queryhelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
