...
func TestSensorNewWithOptionalParams(t *testing.T) {
	...
	err := client.Sensor.New(context.TODO(), unifieddatalibrary.SensorNewParams{
		...
		Sensorcharacteristics: []unifieddatalibrary.SensorNewParamsSensorcharacteristic{{
			...
			AcceptableSatIDFormats:          []string{"5-DIGIT", "ALPHA-5"},
			...
			AzimuthRate:                     unifieddatalibrary.Float(10.23),
			...
			DataFormats:                     []string{"AA007", "EOSSA"},
			...
			ElevationRateGeolm:              unifieddatalibrary.Float(10.23),
			...
			MagnitudeLimit:                  unifieddatalibrary.Float(20.23),
			MaxDataTransmissionRate:         unifieddatalibrary.Float(10.23),
			MaxDeviationAngle:               unifieddatalibrary.Float(20.23),
			MaxIntegrationTime:              unifieddatalibrary.Float(1.1),
			MaxNumTracks:                    unifieddatalibrary.Int(6),
			MaxObservableRange:              unifieddatalibrary.Float(20.23),
			MaxRangeLimit:                   unifieddatalibrary.Float(20.23),
			...
			MinSignalNoiseRatio:             unifieddatalibrary.Float(20.23),
			MinWavelength:                   unifieddatalibrary.Float(1.23),
			NegativeRangeRateLimit:          unifieddatalibrary.Float(20.23),
			...
			NumSearchPatterns:               unifieddatalibrary.Int(2),
			NumWaveforms:                    unifieddatalibrary.Int(2),
			ObsPerTrack:                     unifieddatalibrary.Int(100),
			ObsSpacing:                      unifieddatalibrary.Float(1.1),
			...
			PositiveRangeRateLimit:          unifieddatalibrary.Float(20.23),
			...
			RadioFrequency:                  unifieddatalibrary.Float(20000.1),
			...
			SearchPatternPoints:             []float64{0, 40.1, 60.1},
			SettleTime:                      unifieddatalibrary.Float(4.4),
			...
			TaskingChannels:                 []string{"AD-HOC", "DAILY", "CTL"},
			...
			TrackAngle:                      unifieddatalibrary.Float(1.23),
			...
			TransmitPower:                   unifieddatalibrary.Float(20.23),
