...
type SeraDataEarlyWarningQueryhelpResponse struct {
	...
	Name                  string                                           `json:"name"`
	Parameters            []SeraDataEarlyWarningQueryhelpResponseParameter `json:"parameters"`
...
type SeraDataEarlyWarningQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SeraDataEarlyWarningQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SeraDataEarlyWarningQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
