...
type OnorbitbatteryListResponse struct {
	...
	DataMode OnorbitbatteryListResponseDataMode `json:"dataMode" api:"required"`
	// ID of the battery.
	IDBattery string `json:"idBattery" api:"required"`
...
type OnorbitbatteryNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitbatteryNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the battery.
	IDBattery string `json:"idBattery" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
...
type OnorbitbatteryUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitbatteryUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the battery.
	IDBattery string `json:"idBattery" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
