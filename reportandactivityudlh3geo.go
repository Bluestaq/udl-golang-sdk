...
type ReportAndActivityUdlH3geoUnvalidatedPublishParams struct {
	...
	Cells []ReportAndActivityUdlH3geoUnvalidatedPublishParamsCell `json:"cells,omitzero" api:"required"`
	...
	DataMode ReportAndActivityUdlH3geoUnvalidatedPublishParamsDataMode `json:"dataMode,omitzero" api:"required"`
