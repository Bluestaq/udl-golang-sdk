...
type ChannelAbridged struct {
	...
	DataMode ChannelAbridgedDataMode `json:"dataMode" api:"required"`
	// ID of the parent transponder object for this Channel.
	IDTransponder string `json:"idTransponder" api:"required"`
	// Channel name.
...
type ChannelQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r ChannelQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *ChannelQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type ChannelNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ChannelNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the parent transponder object for this Channel.
	IDTransponder string `json:"idTransponder" api:"required"`
	// Channel name.
	Name string `json:"name" api:"required"`
...
type ChannelUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ChannelUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the parent transponder object for this Channel.
	IDTransponder string `json:"idTransponder" api:"required"`
	// Channel name.
	Name string `json:"name" api:"required"`
