...
type ChannelQueryhelpResponse struct {
	...
	Parameters            []ChannelQueryhelpResponseParameter `json:"parameters"`
...
type ChannelQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ChannelQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ChannelQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
