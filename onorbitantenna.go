...
type OnorbitantennaListResponse struct {
	...
	DataMode OnorbitantennaListResponseDataMode `json:"dataMode" api:"required"`
	// ID of the antenna.
	IDAntenna string `json:"idAntenna" api:"required"`
...
type OnorbitantennaNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitantennaNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the antenna.
	IDAntenna string `json:"idAntenna" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	...
	// antennas. A spacecraft may have multiple antennas and each antenna can have
	// multiple 'details' records compiled by different sources.
	Antenna shared.AntennaIngestParam `json:"antenna,omitzero"`
	paramObj
}
...
func (r *OnorbitantennaNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type OnorbitantennaUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitantennaUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// ID of the antenna.
	IDAntenna string `json:"idAntenna" api:"required"`
	// ID of the on-orbit object.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
...
func (r *OnorbitantennaUpdateParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
