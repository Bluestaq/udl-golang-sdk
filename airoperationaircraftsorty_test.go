...
func TestAirOperationAircraftSortyHistoryAodrWithOptionalParams(t *testing.T) {
	...
	err := client.AirOperations.AircraftSorties.HistoryAodr(context.TODO(), unifieddatalibrary.AirOperationAircraftSortyHistoryAodrParams{
		PlannedDepTime:  time.Now(),
...
func TestAirOperationAircraftSortyHistoryCountWithOptionalParams(t *testing.T) {
	...
	_, err := client.AirOperations.AircraftSorties.HistoryCount(context.TODO(), unifieddatalibrary.AirOperationAircraftSortyHistoryCountParams{
		PlannedDepTime: time.Now(),
		FirstResult:    unifieddatalibrary.Int(0),
		MaxResults:     unifieddatalibrary.Int(0),
	})
...
func TestAirOperationAircraftSortyHistoryQueryWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AirOperations.AircraftSorties.HistoryQuery(context.TODO(), unifieddatalibrary.AirOperationAircraftSortyHistoryQueryParams{
		PlannedDepTime: time.Now(),
		Columns:        unifieddatalibrary.String("columns"),
		FirstResult:    unifieddatalibrary.Int(0),
		MaxResults:     unifieddatalibrary.Int(0),
