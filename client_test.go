...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Elsets.Current.List(context.Background(), unifieddatalibrary.ElsetCurrentListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Elsets.Current.List(cancelCtx, unifieddatalibrary.ElsetCurrentListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Elsets.Current.List(deadlineCtx, unifieddatalibrary.ElsetCurrentListParams{})
		if err == nil {
