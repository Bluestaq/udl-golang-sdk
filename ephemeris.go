...
type EphemerisQueryhelpResponse struct {
	...
	Parameters            []EphemerisQueryhelpResponseParameter `json:"parameters"`
...
type EphemerisQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r EphemerisQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *EphemerisQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
