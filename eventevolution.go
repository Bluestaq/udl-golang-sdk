...
type EventEvolutionQueryhelpResponse struct {
	...
	Parameters            []EventEvolutionQueryhelpResponseParameter `json:"parameters"`
...
type EventEvolutionQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r EventEvolutionQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *EventEvolutionQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
