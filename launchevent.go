...
func (r *LaunchEventService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *LaunchEventQueryhelpResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type LaunchEventListResponse struct {
	...
	DataMode LaunchEventListResponseDataMode `json:"dataMode" api:"required"`
	// Timestamp of the originating message in ISO8601 UTC format.
	MsgCreateDate time.Time `json:"msgCreateDate" api:"required" format:"date-time"`
	// Source of the data.
...
type LaunchEventGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchEventGetResponseDataMode `json:"dataMode" api:"required"`
	// Timestamp of the originating message in ISO8601 UTC format.
	MsgCreateDate time.Time `json:"msgCreateDate" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchEventQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r LaunchEventQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *LaunchEventQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type LaunchEventTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchEventTupleResponseDataMode `json:"dataMode" api:"required"`
	// Timestamp of the originating message in ISO8601 UTC format.
	MsgCreateDate time.Time `json:"msgCreateDate" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchEventNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchEventNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Timestamp of the originating message in ISO8601 UTC format.
	MsgCreateDate time.Time `json:"msgCreateDate" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchEventListParams struct {
	...
	MsgCreateDate time.Time        `query:"msgCreateDate" api:"required" format:"date-time" json:"-"`
