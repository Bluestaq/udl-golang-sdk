...
type LaunchEventQueryhelpResponse struct {
	...
	Parameters            []LaunchEventQueryhelpResponseParameter `json:"parameters"`
...
type LaunchEventQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r LaunchEventQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *LaunchEventQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
