...
func (r *MissionassignmentService) Get(ctx context.Context, id string, query MissionassignmentGetParams, opts ...option.RequestOption) (res *MissionAssignmentFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
		err = errors.New("missing required id parameter")
		return
...
// hours ago.
func (r *MissionassignmentService) Tuple(ctx context.Context, query MissionassignmentTupleParams, opts ...option.RequestOption) (res *[]MissionAssignmentFull, err error) {
	opts = append(r.Options[:], opts...)
