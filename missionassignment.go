...
type MissionAssignmentListResponse struct {
	...
	DataMode MissionAssignmentListResponseDataMode `json:"dataMode" api:"required"`
	// The mission assignment discrete value.
	Mad string `json:"mad" api:"required"`
	// Source of the data.
...
type MissionAssignmentGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode MissionAssignmentGetResponseDataMode `json:"dataMode" api:"required"`
	// The mission assignment discrete value.
	Mad string `json:"mad" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type MissionAssignmentQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r MissionAssignmentQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *MissionAssignmentQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type MissionAssignmentTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode MissionAssignmentTupleResponseDataMode `json:"dataMode" api:"required"`
	// The mission assignment discrete value.
	Mad string `json:"mad" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type MissionAssignmentNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode MissionAssignmentNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The mission assignment discrete value.
	Mad string `json:"mad" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type MissionAssignmentUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode MissionAssignmentUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The mission assignment discrete value.
	Mad string `json:"mad" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
