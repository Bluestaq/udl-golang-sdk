...
type MissionAssignmentQueryhelpResponse struct {
	...
	Parameters            []MissionAssignmentQueryhelpResponseParameter `json:"parameters"`
...
type MissionAssignmentQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r MissionAssignmentQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *MissionAssignmentQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
