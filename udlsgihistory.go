...
// UdlSgiHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlSgiHistoryService] method instead.
type UdlSgiHistoryService struct {
	Options []option.RequestOption
}

// NewUdlSgiHistoryService generates a new service that applies the given options
// to each request. These options are applied after the parent client's options (if
// there is one), and before any request-specific options.
func NewUdlSgiHistoryService(opts ...option.RequestOption) (r UdlSgiHistoryService) {
	r = UdlSgiHistoryService{}
	r.Options = opts
	return
}
...
type SgiFull struct {
	...
	DataMode SgiFullDataMode `json:"dataMode,required"`
	...
	//
	// Any of "O", "P", "R", "Y", "Z".
	Precedence SgiFullPrecedence `json:"precedence"`
...
func (r SgiFull) RawJSON() string { return r.JSON.raw }
func (r *SgiFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type SgiFullDataMode string

const (
	SgiFullDataModeReal      SgiFullDataMode = "REAL"
	SgiFullDataModeTest      SgiFullDataMode = "TEST"
	SgiFullDataModeSimulated SgiFullDataMode = "SIMULATED"
	SgiFullDataModeExercise  SgiFullDataMode = "EXERCISE"
)

// The precedence of data in this record (O = Immediate, P = Priority, R = Routine,
// Y = Emergency, Z = Flash).
type SgiFullPrecedence string

const (
	SgiFullPrecedenceO SgiFullPrecedence = "O"
	SgiFullPrecedenceP SgiFullPrecedence = "P"
	SgiFullPrecedenceR SgiFullPrecedence = "R"
	SgiFullPrecedenceY SgiFullPrecedence = "Y"
	SgiFullPrecedenceZ SgiFullPrecedence = "Z"
)

// State indicating Issued (I), Nowcast (N), or Predicted (P) values for this
// record.
type SgiFullState string

const (
	SgiFullStateI SgiFullState = "I"
	SgiFullStateN SgiFullState = "N"
	SgiFullStateP SgiFullState = "P"
)
