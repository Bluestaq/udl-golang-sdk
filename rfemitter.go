...
type RfEmitterListResponse struct {
	...
	DataMode RfEmitterListResponseDataMode `json:"dataMode" api:"required"`
...
type RfEmitterGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfEmitterGetResponseDataMode `json:"dataMode" api:"required"`
	// Unique name of this RF Emitter.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type RfEmitterGetResponseRfEmitterDetail struct {
	...
	IDRfEmitter string `json:"idRFEmitter" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type RfEmitterGetResponseRfEmitterDetailAntennaTransmitChannel struct {
	...
	Power float64 `json:"power" api:"required"`
...
type RfEmitterTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfEmitterTupleResponseDataMode `json:"dataMode" api:"required"`
	// Unique name of this RF Emitter.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type RfEmitterNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfEmitterNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique name of this RF Emitter.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type RfEmitterUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfEmitterUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique name of this RF Emitter.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
