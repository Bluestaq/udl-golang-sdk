...
func (r *SigactHistoryService) List(ctx context.Context, query SigactHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[SigactFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *SigactHistoryService) ListAutoPaging(ctx context.Context, query SigactHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[SigactFull] {
