...
func TestSigactListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Sigact.List(context.TODO(), unifieddatalibrary.SigactListParams{
		ReportDate:  time.Now(),
...
func TestSigactCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Sigact.Count(context.TODO(), unifieddatalibrary.SigactCountParams{
		ReportDate:  time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestSigactNewBulk(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Sigact.NewBulk(context.TODO(), unifieddatalibrary.SigactNewBulkParams{
		Body: []unifieddatalibrary.SigactNewBulkParamsBody{{
			...
			RelatedDocs: []unifieddatalibrary.SigactNewBulkParamsBodyRelatedDoc{{
				DataSourceRefs: []unifieddatalibrary.SigactNewBulkParamsBodyRelatedDocDataSourceRef{{
...
func TestSigactQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestSigactTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Sigact.Tuple(context.TODO(), unifieddatalibrary.SigactTupleParams{
		Columns:     "columns",
		ReportDate:  time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
...
func TestSigactUploadZip(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Sigact.UploadZip(context.TODO(), unifieddatalibrary.SigactUploadZipParams{
