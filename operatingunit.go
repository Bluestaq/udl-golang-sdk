...
type OperatingunitQueryhelpResponse struct {
	AodrSupported         bool                                      `json:"aodrSupported"`
	ClassificationMarking string                                    `json:"classificationMarking"`
	Description           string                                    `json:"description"`
	HistorySupported      bool                                      `json:"historySupported"`
	Name                  string                                    `json:"name"`
	Parameters            []OperatingunitQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r OperatingunitQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *OperatingunitQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type OperatingunitQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r OperatingunitQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *OperatingunitQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
