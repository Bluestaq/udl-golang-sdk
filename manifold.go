...
type ManifoldQueryhelpResponse struct {
	...
	Parameters            []ManifoldQueryhelpResponseParameter `json:"parameters"`
...
type ManifoldQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ManifoldQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ManifoldQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
