...
type SarObservationQueryhelpResponse struct {
	...
	Parameters            []SarObservationQueryhelpResponseParameter `json:"parameters"`
...
type SarObservationQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SarObservationQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SarObservationQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
