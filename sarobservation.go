...
type SarObservationListResponse struct {
	...
	CollectionEnd time.Time `json:"collectionEnd" api:"required" format:"date-time"`
	// Collection start time in ISO 8601 UTC format with microsecond precision.
	CollectionStart time.Time `json:"collectionStart" api:"required" format:"date-time"`
	...
	DataMode SarObservationListResponseDataMode `json:"dataMode" api:"required"`
	// Collection mode setting for this collection (e.g. AREA, SPOTLIGHT, STRIP, etc.).
	SarMode string `json:"sarMode" api:"required"`
	// Source of the data.
	...
	JSON struct {
		...
		CollectionEnd              respjson.Field
		CollectionStart            respjson.Field
		DataMode                   respjson.Field
		SarMode                    respjson.Field
		...
		AzimuthAngle               respjson.Field
		CenterTime                 respjson.Field
		CollectionID               respjson.Field
		ContinuousSpotAngle        respjson.Field
		CoordSys                   respjson.Field
		CreatedAt                  respjson.Field
		CreatedBy                  respjson.Field
		DetectionEnd               respjson.Field
		DetectionID                respjson.Field
		DetectionStart             respjson.Field
		DwellTime                  respjson.Field
		ExternalID                 respjson.Field
		FarRange                   respjson.Field
		GrazeAngle                 respjson.Field
		GroundResolutionProjection respjson.Field
		IDOnOrbit                  respjson.Field
		IDSensor                   respjson.Field
		IncidenceAngle             respjson.Field
		LooksAzimuth               respjson.Field
		LooksRange                 respjson.Field
		MultilookNumber            respjson.Field
		NearRange                  respjson.Field
		ObDirection                respjson.Field
		OperatingBand              respjson.Field
		OperatingFreq              respjson.Field
		OrbitState                 respjson.Field
		Origin                     respjson.Field
		OrigNetwork                respjson.Field
		OrigObjectID               respjson.Field
		OrigSensorID               respjson.Field
		PulseBandwidth             respjson.Field
		PulseDuration              respjson.Field
		ResolutionAzimuth          respjson.Field
		ResolutionRange            respjson.Field
		RxPolarization             respjson.Field
		SatNo                      respjson.Field
		Senalt                     respjson.Field
		SenlatEnd                  respjson.Field
		SenlatStart                respjson.Field
		SenlonEnd                  respjson.Field
		SenlonStart                respjson.Field
		Senvelx                    respjson.Field
		Senvely                    respjson.Field
		Senvelz                    respjson.Field
		SlantRange                 respjson.Field
		Snr                        respjson.Field
		SourceDl                   respjson.Field
		SpacingAzimuth             respjson.Field
		SpacingRange               respjson.Field
		SquintAngle                respjson.Field
		SrcIDs                     respjson.Field
		SrcTyps                    respjson.Field
		SwathLength                respjson.Field
		Targetposx                 respjson.Field
		Targetposy                 respjson.Field
		Targetposz                 respjson.Field
		TransactionID              respjson.Field
		TxPolarization             respjson.Field
...
type SarObservationGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SarObservationGetResponseDataMode `json:"dataMode" api:"required"`
	// Collection mode setting for this collection (e.g. AREA, SPOTLIGHT, STRIP, etc.).
	SarMode string `json:"sarMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SarObservationQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r SarObservationQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *SarObservationQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type SarObservationTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SarObservationTupleResponseDataMode `json:"dataMode" api:"required"`
	// Collection mode setting for this collection (e.g. AREA, SPOTLIGHT, STRIP, etc.).
	SarMode string `json:"sarMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SarObservationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SarObservationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Collection mode setting for this collection (e.g. AREA, SPOTLIGHT, STRIP, etc.).
	SarMode string `json:"sarMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SarObservationListParams struct {
	...
	CollectionStart time.Time        `query:"collectionStart" api:"required" format:"date-time" json:"-"`
