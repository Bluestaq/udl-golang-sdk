...
// path parameter.
func (r *SarobservationService) Get(ctx context.Context, id string, query SarobservationGetParams, opts ...option.RequestOption) (res *SarobservationFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
// hours ago.
func (r *SarobservationService) Tuple(ctx context.Context, query SarobservationTupleParams, opts ...option.RequestOption) (res *[]SarobservationFull, err error) {
	opts = append(r.Options[:], opts...)
