...
type ObservationPassiveRadarObservationHistoryListResponse struct {
	...
	DataMode ObservationPassiveRadarObservationHistoryListResponseDataMode `json:"dataMode" api:"required"`
	...
	SenReferenceFrame ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame `json:"senReferenceFrame"`
...
// The reference frame of the observing sensor state. If the senReferenceFrame is
// null, it is assumed to be J2000.
type ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame string

const (
	ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrameJ2000   ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame = "J2000"
	ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrameEfgTdr  ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame = "EFG/TDR"
	ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrameEcrEcef ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame = "ECR/ECEF"
	ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrameTeme    ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame = "TEME"
	ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrameItrf    ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame = "ITRF"
	ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrameGcrf    ObservationPassiveRadarObservationHistoryListResponseSenReferenceFrame = "GCRF"
)
