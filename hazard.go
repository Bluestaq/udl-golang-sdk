...
// parameter.
func (r *HazardService) Get(ctx context.Context, id string, query HazardGetParams, opts ...option.RequestOption) (res *HazardFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
// hours ago.
func (r *HazardService) Tuple(ctx context.Context, query HazardTupleParams, opts ...option.RequestOption) (res *[]HazardFull, err error) {
	opts = append(r.Options[:], opts...)
