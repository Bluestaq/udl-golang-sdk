...
type HazardListResponse struct {
	...
	DataMode HazardListResponseDataMode `json:"dataMode" api:"required"`
...
type HazardGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode HazardGetResponseDataMode `json:"dataMode" api:"required"`
	// The detect time, in ISO 8601 UTC format, with millisecond precision.
	DetectTime time.Time `json:"detectTime" api:"required" format:"date-time"`
	// The type of hazard (Chemical, Biological, Radiological, Nuclear) detect
	// associated with this record.
...
type HazardQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r HazardQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *HazardQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type HazardTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode HazardTupleResponseDataMode `json:"dataMode" api:"required"`
	// The detect time, in ISO 8601 UTC format, with millisecond precision.
	DetectTime time.Time `json:"detectTime" api:"required" format:"date-time"`
	// The type of hazard (Chemical, Biological, Radiological, Nuclear) detect
	// associated with this record.
...
type HazardNewParams struct {
	// Array of the specific alarms associated with this detection. The alarms and
	// alarmValues arrays must contain the same number of elements.
	Alarms []string `json:"alarms,omitzero" api:"required"`
	// Array of the values that correspond to each of the alarms contained in alarms.
	// The alarms and alarmValues arrays must contain the same number of elements.
	AlarmValues []float64 `json:"alarmValues,omitzero" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode HazardNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The detect time, in ISO 8601 UTC format, with millisecond precision.
	DetectTime time.Time `json:"detectTime" api:"required" format:"date-time"`
	// The type of hazard (Chemical, Biological, Radiological, Nuclear) detect
	// associated with this record.
