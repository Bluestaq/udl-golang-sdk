...
type StarCatalogListResponse struct {
	...
	AstrometryOrigin StarCatalogListResponseAstrometryOrigin `json:"astrometryOrigin" api:"required"`
	...
	JSON struct {
		...
		AllWisew1Mag          respjson.Field
		AllWisew1MagUnc       respjson.Field
		AllWisew2Mag          respjson.Field
		AllWisew2MagUnc       respjson.Field
		AllWisew3Mag          respjson.Field
		AllWisew3MagUnc       respjson.Field
		AllWisew4Mag          respjson.Field
		AllWisew4MagUnc       respjson.Field
...
type StarCatalogGetResponse struct {
	...
	//
	// Any of "GAIADR3", "HIPPARCOS", "USNOBSC".
	AstrometryOrigin StarCatalogGetResponseAstrometryOrigin `json:"astrometryOrigin" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// The ID of this object in the specific catalog associated with this record.
	CsID int64 `json:"csId" api:"required"`
...
type StarCatalogTupleResponse struct {
	...
	//
	// Any of "GAIADR3", "HIPPARCOS", "USNOBSC".
	AstrometryOrigin StarCatalogTupleResponseAstrometryOrigin `json:"astrometryOrigin" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// The ID of this object in the specific catalog associated with this record.
	CsID int64 `json:"csId" api:"required"`
...
type StarCatalogNewParams struct {
	...
	//
	// Any of "GAIADR3", "HIPPARCOS", "USNOBSC".
	AstrometryOrigin StarCatalogNewParamsAstrometryOrigin `json:"astrometryOrigin,omitzero" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// The ID of this object in the specific catalog associated with this record.
	CsID int64 `json:"csId" api:"required"`
	...
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W1-band (3.4 microns) magnitude in the Vega system.
	AllWisew1Mag param.Opt[float64] `json:"allWISEW1Mag,omitzero"`
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W1-band (3.4 microns) magnitude uncertainty in the Vega system.
	AllWisew1MagUnc param.Opt[float64] `json:"allWISEW1MagUnc,omitzero"`
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W2-band (4.6 microns) magnitude in the Vega system.
	AllWisew2Mag param.Opt[float64] `json:"allWISEW2Mag,omitzero"`
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W2-band (4.6 microns) magnitude uncertainty in the Vega system.
	AllWisew2MagUnc param.Opt[float64] `json:"allWISEW2MagUnc,omitzero"`
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W3-band (12 microns) magnitude in the Vega system.
	AllWisew3Mag param.Opt[float64] `json:"allWISEW3Mag,omitzero"`
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W3-band (12 microns) magnitude uncertainty in the Vega system.
	AllWisew3MagUnc param.Opt[float64] `json:"allWISEW3MagUnc,omitzero"`
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W4-band (22 microns) magnitude in the Vega system.
	AllWisew4Mag param.Opt[float64] `json:"allWISEW4Mag,omitzero"`
	// The All Wide-field Infrared Survey Explorer (AllWISE) mid-infrared photometric
	// W4-band (22 microns) magnitude uncertainty in the Vega system.
	AllWisew4MagUnc param.Opt[float64] `json:"allWISEW4MagUnc,omitzero"`
	// Gaia DR3 optical photometric Bp-band magnitude in the Vega scale.
...
type StarCatalogUpdateParams struct {
	...
	//
	// Any of "GAIADR3", "HIPPARCOS", "USNOBSC".
	AstrometryOrigin StarCatalogUpdateParamsAstrometryOrigin `json:"astrometryOrigin,omitzero" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// The ID of this object in the specific catalog associated with this record.
	CsID int64 `json:"csId" api:"required"`
...
type StarCatalogNewBulkParamsBody struct {
	...
	//
	// Any of "GAIADR3", "HIPPARCOS", "USNOBSC".
	AstrometryOrigin string `json:"astrometryOrigin,omitzero" api:"required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// The ID of this object in the specific catalog associated with this record.
	CsID int64 `json:"csId" api:"required"`
