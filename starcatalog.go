...
type StarCatalogQueryhelpResponse struct {
	...
	Parameters            []StarCatalogQueryhelpResponseParameter `json:"parameters"`
...
type StarCatalogQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r StarCatalogQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *StarCatalogQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
