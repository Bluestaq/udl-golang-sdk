...
type SeradataRadarPayloadQueryhelpResponse struct {
	...
	Name                  string                                           `json:"name"`
	Parameters            []SeradataRadarPayloadQueryhelpResponseParameter `json:"parameters"`
...
type SeradataRadarPayloadQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SeradataRadarPayloadQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SeradataRadarPayloadQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
