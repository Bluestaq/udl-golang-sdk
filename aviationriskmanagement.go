...
type AviationRiskManagementGetResponse struct {
	...
	DataMode AviationRiskManagementGetResponseDataMode `json:"dataMode" api:"required"`
...
type AviationRiskManagementGetResponseAviationRiskManagementWorksheetRecord struct {
	...
	MissionDate time.Time `json:"missionDate" api:"required" format:"date"`
...
type AviationRiskManagementListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AviationRiskManagementListResponseDataMode `json:"dataMode" api:"required"`
	// The unique identifier of the mission to which this risk management record is
	// assigned.
	IDMission string `json:"idMission" api:"required"`
	// Source of the data.
...
type AviationRiskManagementTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AviationRiskManagementTupleResponseDataMode `json:"dataMode" api:"required"`
	// The unique identifier of the mission to which this risk management record is
	// assigned.
	IDMission string `json:"idMission" api:"required"`
	// Source of the data.
...
type AviationRiskManagementNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AviationRiskManagementNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The unique identifier of the mission to which this risk management record is
	// assigned.
	IDMission string `json:"idMission" api:"required"`
	// Source of the data.
...
type AviationRiskManagementUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AviationRiskManagementUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The unique identifier of the mission to which this risk management record is
	// assigned.
	IDMission string `json:"idMission" api:"required"`
	// Source of the data.
...
type AviationRiskManagementListParams struct {
	// The unique identifier of the mission to which this risk management record is
	// assigned.
	IDMission   string           `query:"idMission" api:"required" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
