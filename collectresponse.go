...
type CollectResponseAbridged struct {
	...
	DataMode CollectResponseAbridgedDataMode `json:"dataMode" api:"required"`
	// Unique identifier of the request associated with this response.
	IDRequest string `json:"idRequest" api:"required"`
	// Source of the data.
...
type CollectResponseNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CollectResponseNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the request associated with this response.
	IDRequest string `json:"idRequest" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
