...
type PortQueryhelpResponse struct {
	...
	Parameters            []PortQueryhelpResponseParameter `json:"parameters"`
...
type PortQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r PortQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *PortQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
