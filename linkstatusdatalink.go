...
type LinkStatusDatalinkQueryhelpResponse struct {
	...
	Name                  string                                         `json:"name"`
	Parameters            []LinkStatusDatalinkQueryhelpResponseParameter `json:"parameters"`
...
type LinkStatusDatalinkQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r LinkStatusDatalinkQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *LinkStatusDatalinkQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
