...
type BusQueryHelpResponse struct {
	...
	Parameters            []BusQueryHelpResponseParameter `json:"parameters"`
...
type BusQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r BusQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *BusQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
