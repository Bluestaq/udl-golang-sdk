...
// parameter.
func (r *BusService) Get(ctx context.Context, id string, query BusGetParams, opts ...option.RequestOption) (res *BusFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
func (r *BusService) QueryHelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// hours ago.
func (r *BusService) Tuple(ctx context.Context, query BusTupleParams, opts ...option.RequestOption) (res *[]BusFull, err error) {
	opts = append(r.Options[:], opts...)
	path := "udl/bus/tuple"
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, query, &res, opts...)
	return
...
type BusAbridged struct {
	...
	JSON struct {
		...
		Source                             resp.Field
		ID                                 resp.Field
		AocsNotes                          resp.Field
		AvgDryMass                         resp.Field
		AvgPayloadMass                     resp.Field
		AvgPayloadPower                    resp.Field
		AvgSpacecraftPower                 resp.Field
		AvgWetMass                         resp.Field
		BodyDimensionX                     resp.Field
		BodyDimensionY                     resp.Field
		BodyDimensionZ                     resp.Field
		BusKitDesignerOrgID                resp.Field
		...
		Generic                            resp.Field
		IDEntity                           resp.Field
		LaunchEnvelopeDimensionX           resp.Field
		LaunchEnvelopeDimensionY           resp.Field
		LaunchEnvelopeDimensionZ           resp.Field
		MainComputerManufacturerOrgID      resp.Field
		ManufacturerOrgID                  resp.Field
		MassCategory                       resp.Field
		MaxBolPowerLower                   resp.Field
		MaxBolPowerUpper                   resp.Field
		MaxBolStationMass                  resp.Field
		MaxDryMass                         resp.Field
		MaxEolPowerLower                   resp.Field
		MaxEolPowerUpper                   resp.Field
		MaxLaunchMassLower                 resp.Field
		MaxLaunchMassUpper                 resp.Field
		MaxPayloadMass                     resp.Field
		MaxPayloadPower                    resp.Field
		MaxSpacecraftPower                 resp.Field
		MaxWetMass                         resp.Field
		MedianDryMass                      resp.Field
		MedianWetMass                      resp.Field
		MinDryMass                         resp.Field
		MinWetMass                         resp.Field
		NumOrbitType                       resp.Field
		OapPayloadPower                    resp.Field
		OapSpacecraftPower                 resp.Field
		Origin                             resp.Field
		OrigNetwork                        resp.Field
		PayloadDimensionX                  resp.Field
		PayloadDimensionY                  resp.Field
		PayloadDimensionZ                  resp.Field
		PayloadVolume                      resp.Field
		PowerCategory                      resp.Field
		TelemetryTrackingManufacturerOrgID resp.Field
		Type                               resp.Field
