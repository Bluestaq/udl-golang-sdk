...
type WeatherDataQueryhelpResponse struct {
	...
	Parameters            []WeatherDataQueryhelpResponseParameter `json:"parameters"`
...
type WeatherDataQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r WeatherDataQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *WeatherDataQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
