...
func (r *OrbitdeterminationHistoryService) List(ctx context.Context, query OrbitdeterminationHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[OrbitdeterminationHistoryListResponse], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *OrbitdeterminationHistoryService) ListAutoPaging(ctx context.Context, query OrbitdeterminationHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[OrbitdeterminationHistoryListResponse] {
...
type OrbitdeterminationHistoryListResponse struct {
	...
	DataMode OrbitdeterminationHistoryListResponseDataMode `json:"dataMode,required"`
	...
	AprioriElset OrbitdeterminationHistoryListResponseAprioriElset `json:"aprioriElset"`
	...
	// provider.
	AprioriStateVector OrbitdeterminationHistoryListResponseAprioriStateVector `json:"aprioriStateVector"`
	...
	JSON struct {
		...
		DataMode               resp.Field
		EndTime                resp.Field
		InitialOd              resp.Field
		Method                 resp.Field
		Source                 resp.Field
		StartTime              resp.Field
		ID                     resp.Field
		AcceptedObIDs          resp.Field
		AcceptedObTyps         resp.Field
		AgomEst                resp.Field
		AgomModel              resp.Field
		AprioriElset           resp.Field
		AprioriIDElset         resp.Field
		AprioriIDStateVector   resp.Field
		AprioriStateVector     resp.Field
		BallisticCoeffEst      resp.Field
		BallisticCoeffModel    resp.Field
		BestPassWrms           resp.Field
		CreatedAt              resp.Field
		CreatedBy              resp.Field
		Edr                    resp.Field
		EffectiveFrom          resp.Field
		EffectiveUntil         resp.Field
		ErrorGrowthRate        resp.Field
		FirstPassWrms          resp.Field
		FitSpan                resp.Field
		IDOnOrbit              resp.Field
		LastObEnd              resp.Field
		LastObStart            resp.Field
		MethodSource           resp.Field
		NumIterations          resp.Field
		OnOrbit                resp.Field
		Origin                 resp.Field
		OrigNetwork            resp.Field
		OrigObjectID           resp.Field
		PreviousWrms           resp.Field
		RejectedObIDs          resp.Field
		RejectedObTyps         resp.Field
		RmsConvergenceCriteria resp.Field
		SatNo                  resp.Field
		SensorIDs              resp.Field
		SourceDl               resp.Field
		TimeSpan               resp.Field
		Wrms                   resp.Field
...
func (r OrbitdeterminationHistoryListResponse) RawJSON() string { return r.JSON.raw }
func (r *OrbitdeterminationHistoryListResponse) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type OrbitdeterminationHistoryListResponseDataMode string

const (
	OrbitdeterminationHistoryListResponseDataModeReal      OrbitdeterminationHistoryListResponseDataMode = "REAL"
	OrbitdeterminationHistoryListResponseDataModeTest      OrbitdeterminationHistoryListResponseDataMode = "TEST"
	OrbitdeterminationHistoryListResponseDataModeSimulated OrbitdeterminationHistoryListResponseDataMode = "SIMULATED"
	OrbitdeterminationHistoryListResponseDataModeExercise  OrbitdeterminationHistoryListResponseDataMode = "EXERCISE"
)
...
// order to predict the motion of a satellite. The element set, or elset for short,
// consists of identification data, the classical elements and drag parameters.
type OrbitdeterminationHistoryListResponseAprioriElset struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r OrbitdeterminationHistoryListResponseAprioriElset) RawJSON() string { return r.JSON.raw }
func (r *OrbitdeterminationHistoryListResponseAprioriElset) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// the 'Discover' tab in the storefront to confirm coordinate frames by data
// provider.
type OrbitdeterminationHistoryListResponseAprioriStateVector struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r OrbitdeterminationHistoryListResponseAprioriStateVector) RawJSON() string { return r.JSON.raw }
func (r *OrbitdeterminationHistoryListResponseAprioriStateVector) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
