...
func (r *SiteOperationService) QueryHelp(ctx context.Context, opts ...option.RequestOption) (res *SiteOperationQueryHelpResponse, err error) {
	opts = slices.Concat(r.Options, opts)
...
type SiteOperationGetResponse struct {
	...
	DataMode SiteOperationGetResponseDataMode `json:"dataMode" api:"required"`
	// The ID of the parent site.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
...
type SiteOperationListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SiteOperationListResponseDataMode `json:"dataMode" api:"required"`
	// The ID of the parent site.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SiteOperationQueryHelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r SiteOperationQueryHelpResponse) RawJSON() string { return r.JSON.raw }
func (r *SiteOperationQueryHelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type SiteOperationTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SiteOperationTupleResponseDataMode `json:"dataMode" api:"required"`
	// The ID of the parent site.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SiteOperationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SiteOperationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The ID of the parent site.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SiteOperationUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SiteOperationUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The ID of the parent site.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SiteOperationListParams struct {
	// The ID of the parent site.
	IDSite      string           `query:"idSite" api:"required" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
