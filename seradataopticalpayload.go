...
type SeradataOpticalPayloadQueryhelpResponse struct {
	...
	Name                  string                                             `json:"name"`
	Parameters            []SeradataOpticalPayloadQueryhelpResponseParameter `json:"parameters"`
...
type SeradataOpticalPayloadQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SeradataOpticalPayloadQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SeradataOpticalPayloadQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
