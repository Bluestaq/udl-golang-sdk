...
type SeradataOpticalPayloadListResponse struct {
	...
	DataMode SeradataOpticalPayloadListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type SeradataOpticalPayloadGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataOpticalPayloadGetResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeradataOpticalPayloadTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataOpticalPayloadTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeradataOpticalPayloadNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataOpticalPayloadNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeradataOpticalPayloadUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataOpticalPayloadUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
