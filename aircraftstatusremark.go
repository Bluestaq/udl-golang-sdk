...
func (r *AircraftStatusRemarkService) Get(ctx context.Context, id string, query AircraftStatusRemarkGetParams, opts ...option.RequestOption) (res *shared.AircraftstatusremarkFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
func (r *AircraftStatusRemarkService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *AircraftStatusRemarkQueryhelpResponse, err error) {
	opts = append(r.Options[:], opts...)
...
// hours ago.
func (r *AircraftStatusRemarkService) Tuple(ctx context.Context, query AircraftStatusRemarkTupleParams, opts ...option.RequestOption) (res *[]shared.AircraftstatusremarkFull, err error) {
	opts = append(r.Options[:], opts...)
...
type AircraftStatusRemarkQueryhelpResponse struct {
	AodrSupported         bool                                             `json:"aodrSupported"`
	ClassificationMarking string                                           `json:"classificationMarking"`
	Description           string                                           `json:"description"`
	HistorySupported      bool                                             `json:"historySupported"`
	Name                  string                                           `json:"name"`
	Parameters            []AircraftStatusRemarkQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r AircraftStatusRemarkQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *AircraftStatusRemarkQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AircraftStatusRemarkQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AircraftStatusRemarkQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AircraftStatusRemarkQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
