...
type EquipmentAbridged struct {
	...
	DataMode EquipmentAbridgedDataMode `json:"dataMode" api:"required"`
...
type EquipmentFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EquipmentFullDataMode `json:"dataMode" api:"required"`
	// WGS84 latitude of the location, in degrees. -90 to 90 degrees (negative values
	// south of equator).
	Lat float64 `json:"lat" api:"required"`
	// WGS84 longitude of the location, in degrees. -180 to 180 degrees (negative
...
type EquipmentQueryHelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r EquipmentQueryHelpResponse) RawJSON() string { return r.JSON.raw }
func (r *EquipmentQueryHelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type EquipmentNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EquipmentNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// WGS84 latitude of the location, in degrees. -90 to 90 degrees (negative values
	// south of equator).
	Lat float64 `json:"lat" api:"required"`
	// WGS84 longitude of the location, in degrees. -180 to 180 degrees (negative
...
type EquipmentUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EquipmentUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// WGS84 latitude of the location, in degrees. -90 to 90 degrees (negative values
	// south of equator).
	Lat float64 `json:"lat" api:"required"`
	// WGS84 longitude of the location, in degrees. -180 to 180 degrees (negative
