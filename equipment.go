...
type EquipmentQueryHelpResponse struct {
	...
	Parameters            []EquipmentQueryHelpResponseParameter `json:"parameters"`
...
type EquipmentQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r EquipmentQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *EquipmentQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
