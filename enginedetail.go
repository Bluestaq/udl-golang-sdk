...
type EngineDetailsAbridged struct {
	...
	DataMode EngineDetailsAbridgedDataMode `json:"dataMode" api:"required"`
...
type EngineDetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EngineDetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent engine record.
	IDEngine string `json:"idEngine" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EngineDetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EngineDetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent engine record.
	IDEngine string `json:"idEngine" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
