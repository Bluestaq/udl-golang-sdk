...
func (r *SitestatusHistoryService) List(ctx context.Context, query SitestatusHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[SitestatusFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *SitestatusHistoryService) ListAutoPaging(ctx context.Context, query SitestatusHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[SitestatusFull] {
