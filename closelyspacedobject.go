...
type CloselyspacedobjectsAbridged struct {
	...
	// SEPARATED, UPDATED.
	CsoState string `json:"csoState" api:"required"`
	...
	DataMode CloselyspacedobjectsAbridgedDataMode `json:"dataMode" api:"required"`
...
type CloselyspacedobjectsAbridgedCsoDetail struct {
	...
	ObjectEvent string `json:"objectEvent" api:"required"`
...
type CloselyspacedobjectGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CloselyspacedobjectGetResponseDataMode `json:"dataMode" api:"required"`
	// Timestamp representing the events start time in ISO 8601 UTC format with
	// millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The type of event associated with this record. Values include: DOCK, UNDOCK,
...
type CloselyspacedobjectTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CloselyspacedobjectTupleResponseDataMode `json:"dataMode" api:"required"`
	// Timestamp representing the events start time in ISO 8601 UTC format with
	// millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The type of event associated with this record. Values include: DOCK, UNDOCK,
...
type CloselyspacedobjectNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CloselyspacedobjectNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Timestamp representing the events start time in ISO 8601 UTC format with
	// millisecond precision.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
	// The type of event associated with this record. Values include: DOCK, UNDOCK,
