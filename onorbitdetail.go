...
type OnorbitdetailListResponse struct {
	...
	DataMode OnorbitdetailListResponseDataMode `json:"dataMode" api:"required"`
...
type OnorbitdetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitdetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type OnorbitdetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitdetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
