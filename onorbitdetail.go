...
func (r *OnorbitdetailService) Get(ctx context.Context, id string, query OnorbitdetailGetParams, opts ...option.RequestOption) (res *OnorbitdetailGetResponse, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
		err = errors.New("missing required id parameter")
		return
...
// Contains details of the OnOrbit object.
type OnorbitdetailGetResponse struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitdetailGetResponseDataMode `json:"dataMode,required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit,required"`
	// Source of the data.
	Source string `json:"source,required"`
...
// Returns the unmodified JSON received from the API
func (r OnorbitdetailGetResponse) RawJSON() string { return r.JSON.raw }
func (r *OnorbitdetailGetResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type OnorbitdetailGetResponseDataMode string

const (
	OnorbitdetailGetResponseDataModeReal      OnorbitdetailGetResponseDataMode = "REAL"
	OnorbitdetailGetResponseDataModeTest      OnorbitdetailGetResponseDataMode = "TEST"
	OnorbitdetailGetResponseDataModeSimulated OnorbitdetailGetResponseDataMode = "SIMULATED"
	OnorbitdetailGetResponseDataModeExercise  OnorbitdetailGetResponseDataMode = "EXERCISE"
)
