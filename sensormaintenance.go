...
type SensorMaintenanceQueryhelpResponse struct {
	...
	Parameters            []SensorMaintenanceQueryhelpResponseParameter `json:"parameters"`
...
type SensorMaintenanceQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SensorMaintenanceQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SensorMaintenanceQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
