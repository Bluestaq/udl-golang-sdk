...
// Service operation to get current Sensor Maintenance records using any number of
// additional parameters.
func (r *SensorMaintenanceService) ListCurrentAutoPaging(ctx context.Context, query SensorMaintenanceListCurrentParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[SensorMaintenanceListCurrentResponse] {
	return pagination.NewOffsetPageAutoPager(r.ListCurrent(ctx, query, opts...))
}
...
type SensorMaintenanceListResponse struct {
	...
	DataMode SensorMaintenanceListResponseDataMode `json:"dataMode" api:"required"`
	...
	SiteCode string `json:"siteCode" api:"required"`
	// Source of the data.
...
type SensorMaintenanceGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SensorMaintenanceGetResponseDataMode `json:"dataMode" api:"required"`
	// The planned outage end time in ISO8601 UTC format.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// The site to which this item applies. NOTE - this site code is COLT specific and
	// may not identically correspond to other UDL site IDs.
...
// Maintenance schedule and operational status of Sensor.
type SensorMaintenanceListCurrentResponse struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SensorMaintenanceListCurrentResponseDataMode `json:"dataMode" api:"required"`
	// The planned outage end time in ISO8601 UTC format.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// The site to which this item applies. NOTE - this site code is COLT specific and
	// may not identically correspond to other UDL site IDs.
...
// Returns the unmodified JSON received from the API
func (r SensorMaintenanceListCurrentResponse) RawJSON() string { return r.JSON.raw }
func (r *SensorMaintenanceListCurrentResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// SIMULATED:&nbsp;Synthetic data generated by a model to mimic real-world
// datasets.
type SensorMaintenanceListCurrentResponseDataMode string

const (
	SensorMaintenanceListCurrentResponseDataModeReal      SensorMaintenanceListCurrentResponseDataMode = "REAL"
	SensorMaintenanceListCurrentResponseDataModeTest      SensorMaintenanceListCurrentResponseDataMode = "TEST"
	SensorMaintenanceListCurrentResponseDataModeSimulated SensorMaintenanceListCurrentResponseDataMode = "SIMULATED"
...
type SensorMaintenanceTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SensorMaintenanceTupleResponseDataMode `json:"dataMode" api:"required"`
	// The planned outage end time in ISO8601 UTC format.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// The site to which this item applies. NOTE - this site code is COLT specific and
	// may not identically correspond to other UDL site IDs.
...
type SensorMaintenanceNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SensorMaintenanceNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The planned outage end time in ISO8601 UTC format.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// The site to which this item applies. NOTE - this site code is COLT specific and
	// may not identically correspond to other UDL site IDs.
...
type SensorMaintenanceUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SensorMaintenanceUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The planned outage end time in ISO8601 UTC format.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// The site to which this item applies. NOTE - this site code is COLT specific and
	// may not identically correspond to other UDL site IDs.
...
type SensorMaintenanceListCurrentParams struct {
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}

// URLQuery serializes [SensorMaintenanceListCurrentParams]'s query parameters as
// `url.Values`.
func (r SensorMaintenanceListCurrentParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
