...
type LaunchVehicleListResponse struct {
	...
	DataMode LaunchVehicleListResponseDataMode `json:"dataMode" api:"required"`
	// Launch vehicle name.
...
type LaunchVehicleGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchVehicleGetResponseDataMode `json:"dataMode" api:"required"`
	// Launch vehicle name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchVehicleGetResponseLaunchVehicleDetail struct {
	...
	IDLaunchVehicle string `json:"idLaunchVehicle" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type LaunchVehicleGetResponseStage struct {
	...
	IDEngine string `json:"idEngine" api:"required"`
...
type LaunchVehicleTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchVehicleTupleResponseDataMode `json:"dataMode" api:"required"`
	// Launch vehicle name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchVehicleNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchVehicleNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Launch vehicle name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchVehicleUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchVehicleUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Launch vehicle name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
