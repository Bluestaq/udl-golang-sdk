...
type ObservationRfObservationGetResponse struct {
	...
	JSON struct {
		...
		Bandwidth             resp.Field
		BaudRate              resp.Field
		BaudRates             resp.Field
		BitErrorRate          resp.Field
		CarrierStandard       resp.Field
		Channel               resp.Field
		ChipRates             resp.Field
		CodeFills             resp.Field
		CodeLengths           resp.Field
		CodeTaps              resp.Field
		CollectionMode        resp.Field
		Confidence            resp.Field
		Confidences           resp.Field
		ConstellationXPoints  resp.Field
		ConstellationYPoints  resp.Field
		CreatedAt             resp.Field
		CreatedBy             resp.Field
		Descriptor            resp.Field
		DetectionStatus       resp.Field
		DetectionStatuses     resp.Field
		Eirp                  resp.Field
		Elevation             resp.Field
		ElevationMeasured     resp.Field
		ElevationRate         resp.Field
...
func (f ObservationRfObservationNewParams) IsPresent() bool {
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationListParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationCountParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationNewBulkParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationNewBulkParamsBody) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationGetParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationTupleParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationUnvalidatedPublishParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f ObservationRfObservationUnvalidatedPublishParamsBody) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
