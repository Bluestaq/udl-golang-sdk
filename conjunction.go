...
type ConjunctionAbridged struct {
	...
	Tca time.Time `json:"tca" api:"required" format:"date-time"`
...
type ConjunctionUploadConjunctionDataMessageParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ConjunctionUploadConjunctionDataMessageParamsDataMode `query:"dataMode,omitzero" api:"required" json:"-"`
