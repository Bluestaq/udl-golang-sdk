...
// parameter.
func (r *ConjunctionService) Get(ctx context.Context, id string, query ConjunctionGetParams, opts ...option.RequestOption) (res *ConjunctionFull, err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *ConjunctionService) GetHistory(ctx context.Context, query ConjunctionGetHistoryParams, opts ...option.RequestOption) (res *[]ConjunctionFull, err error) {
	opts = append(r.Options[:], opts...)
...
// hours ago.
func (r *ConjunctionService) Tuple(ctx context.Context, query ConjunctionTupleParams, opts ...option.RequestOption) (res *[]ConjunctionFull, err error) {
	opts = append(r.Options[:], opts...)
...
type ConjunctionAbridged struct {
	...
	JSON struct {
		...
		CdAoM1                resp.Field
		CdAoM2                resp.Field
		CollisionProb         resp.Field
		CollisionProbMethod   resp.Field
		Comments              resp.Field
		ConcernNotes          resp.Field
		CrAoM1                resp.Field
		CrAoM2                resp.Field
		CreatedAt             resp.Field
		CreatedBy             resp.Field
		Descriptor            resp.Field
		EphemName1            resp.Field
		EphemName2            resp.Field
		EsId1                 resp.Field
		EsId2                 resp.Field
		EventID               resp.Field
		IDOnOrbit1            resp.Field
		IDOnOrbit2            resp.Field
		IDStateVector1        resp.Field
		IDStateVector2        resp.Field
		LargeCovWarning       resp.Field
		LargeRelPosWarning    resp.Field
		LastObTime1           resp.Field
		LastObTime2           resp.Field
		MessageFor            resp.Field
		MessageID             resp.Field
		MissDistance          resp.Field
		OrigIDOnOrbit1        resp.Field
		OrigIDOnOrbit2        resp.Field
		Origin                resp.Field
		Originator            resp.Field
		OrigNetwork           resp.Field
		OwnerContacted        resp.Field
		PenetrationLevelSigma resp.Field
		RawFileUri            resp.Field
		RelPosN               resp.Field
		RelPosR               resp.Field
		RelPosT               resp.Field
		RelVelMag             resp.Field
		RelVelN               resp.Field
		RelVelR               resp.Field
		RelVelT               resp.Field
		SatNo1                resp.Field
		SatNo2                resp.Field
		ScreenEntryTime       resp.Field
		ScreenExitTime        resp.Field
		ScreenVolumeX         resp.Field
		ScreenVolumeY         resp.Field
		ScreenVolumeZ         resp.Field
		SmallCovWarning       resp.Field
		SmallRelVelWarning    resp.Field
		StateDeptNotified     resp.Field
		StateVector1          resp.Field
		StateVector2          resp.Field
		ThrustAccel1          resp.Field
		ThrustAccel2          resp.Field
		TransactionID         resp.Field
		Type                  resp.Field
		UvwWarn               resp.Field
		VolEntryTime          resp.Field
		VolExitTime           resp.Field
		VolShape              resp.Field
...
type ConjunctionFull struct {
	...
	OnOrbit1 shared.OnorbitFull `json:"onOrbit1"`
	// Model object representing on-orbit objects or satellites in the system.
	OnOrbit2 shared.OnorbitFull `json:"onOrbit2"`
	// Optional place holder for an OnOrbit ID that does not exist in UDL.
	OrigIDOnOrbit1 string `json:"origIdOnOrbit1"`
	// Optional place holder for an OnOrbit ID that does not exist in UDL.
	OrigIDOnOrbit2 string `json:"origIdOnOrbit2"`
