...
type SeradataSpacecraftDetailListResponse struct {
	...
	DataMode SeradataSpacecraftDetailListResponseDataMode `json:"dataMode" api:"required"`
	// Spacecraft name.
...
type SeradataSpacecraftDetailGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSpacecraftDetailGetResponseDataMode `json:"dataMode" api:"required"`
	// Spacecraft name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SeradataSpacecraftDetailTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSpacecraftDetailTupleResponseDataMode `json:"dataMode" api:"required"`
	// Spacecraft name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SeradataSpacecraftDetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSpacecraftDetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Spacecraft name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SeradataSpacecraftDetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeradataSpacecraftDetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Spacecraft name.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
