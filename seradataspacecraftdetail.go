...
type SeradataSpacecraftDetailQueryhelpResponse struct {
	...
	Name                  string                                               `json:"name"`
	Parameters            []SeradataSpacecraftDetailQueryhelpResponseParameter `json:"parameters"`
...
type SeradataSpacecraftDetailQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SeradataSpacecraftDetailQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SeradataSpacecraftDetailQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
