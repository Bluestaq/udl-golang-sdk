...
type OnorbitQueryhelpResponse struct {
	...
	Parameters            []OnorbitQueryhelpResponseParameter `json:"parameters"`
...
type OnorbitQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r OnorbitQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *OnorbitQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
