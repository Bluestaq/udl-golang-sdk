...
type OnorbitIngestParam struct {
	...
	DataMode OnorbitIngestDataMode `json:"dataMode,omitzero" api:"required"`
...
type OnorbitListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitListResponseDataMode `json:"dataMode" api:"required"`
	// Satellite/Catalog number of the target on-orbit object.
	SatNo int64 `json:"satNo" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type OnorbitGetSignatureParams struct {
	...
	IDOnOrbit   string           `query:"idOnOrbit" api:"required" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
