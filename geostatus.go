...
type GeoStatusQueryhelpResponse struct {
	...
	Parameters            []GeoStatusQueryhelpResponseParameter `json:"parameters"`
...
type GeoStatusQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r GeoStatusQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *GeoStatusQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
