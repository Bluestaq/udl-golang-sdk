...
type SensorPlanHistoryListResponse struct {
	...
	DataMode SensorPlanHistoryListResponseDataMode `json:"dataMode" api:"required"`
	// The type of records that comprise this parent set (COLLECT, CONTACT).
	RecType string `json:"recType" api:"required"`
	// Source of the data.
	...
	JSON struct {
		...
		RecType               respjson.Field
		Source                respjson.Field
		StartTime             respjson.Field
		Type                  respjson.Field
		ID                    respjson.Field
		CollectRequests       respjson.Field
		...
		ReqTotal              respjson.Field
		SenNetwork            respjson.Field
