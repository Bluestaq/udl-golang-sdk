...
// UdlGeostatusHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlGeostatusHistoryService] method instead.
type UdlGeostatusHistoryService struct {
	Options []option.RequestOption
}

// NewUdlGeostatusHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlGeostatusHistoryService(opts ...option.RequestOption) (r UdlGeostatusHistoryService) {
	r = UdlGeostatusHistoryService{}
	r.Options = opts
	return
}
...
func (r *UdlGeostatusHistoryService) List(ctx context.Context, query UdlGeostatusHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[GeoStatusFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *UdlGeostatusHistoryService) ListAutoPaging(ctx context.Context, query UdlGeostatusHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[GeoStatusFull] {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *UdlGeostatusHistoryService) Aodr(ctx context.Context, query UdlGeostatusHistoryAodrParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
...
func (r *UdlGeostatusHistoryService) Count(ctx context.Context, query UdlGeostatusHistoryCountParams, opts ...option.RequestOption) (res *string, err error) {
	opts = append(r.Options[:], opts...)
...
type UdlGeostatusHistoryListParams struct {
	// Time the row was created in the database, auto-populated by the system.
...
func (f UdlGeostatusHistoryListParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [UdlGeostatusHistoryListParams]'s query parameters as
// `url.Values`.
func (r UdlGeostatusHistoryListParams) URLQuery() (v url.Values, err error) {
...
type UdlGeostatusHistoryAodrParams struct {
	// Time the row was created in the database, auto-populated by the system.
	// (YYYY-MM-DDTHH:MM:SS.sssZ)
	CreatedAt time.Time `query:"createdAt,required" format:"date" json:"-"`
	// optional, fields for retrieval. When omitted, ALL fields are assumed. See the
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f UdlGeostatusHistoryAodrParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [UdlGeostatusHistoryAodrParams]'s query parameters as
// `url.Values`.
func (r UdlGeostatusHistoryAodrParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type UdlGeostatusHistoryCountParams struct {
	// Time the row was created in the database, auto-populated by the system.
	// (YYYY-MM-DDTHH:MM:SS.sssZ)
	CreatedAt   time.Time        `query:"createdAt,required" format:"date" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f UdlGeostatusHistoryCountParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [UdlGeostatusHistoryCountParams]'s query parameters as
// `url.Values`.
func (r UdlGeostatusHistoryCountParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
