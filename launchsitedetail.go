...
type LaunchSiteDetailListResponse struct {
	...
	DataMode LaunchSiteDetailListResponseDataMode `json:"dataMode" api:"required"`
	// Identifier of the parent launch site record.
	IDLaunchSite string `json:"idLaunchSite" api:"required"`
	// Source of the data.
...
type LaunchSiteDetailFindBySourceResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchSiteDetailFindBySourceResponseDataMode `json:"dataMode" api:"required"`
	// Identifier of the parent launch site record.
	IDLaunchSite string `json:"idLaunchSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchSiteDetailGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchSiteDetailGetResponseDataMode `json:"dataMode" api:"required"`
	// Identifier of the parent launch site record.
	IDLaunchSite string `json:"idLaunchSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchSiteDetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchSiteDetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent launch site record.
	IDLaunchSite string `json:"idLaunchSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchSiteDetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchSiteDetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent launch site record.
	IDLaunchSite string `json:"idLaunchSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
