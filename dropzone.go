...
type DropzoneGetResponse struct {
	...
	DataMode DropzoneGetResponseDataMode `json:"dataMode" api:"required"`
...
type DropzoneListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DropzoneListResponseDataMode `json:"dataMode" api:"required"`
	// WGS84 latitude of the drop zone, in degrees. -90 to 90 degrees (negative values
	// south of equator).
	Lat float64 `json:"lat" api:"required"`
	// WGS84 longitude of the drop zone, in degrees. -180 to 180 degrees (negative
...
type DropzoneTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DropzoneTupleResponseDataMode `json:"dataMode" api:"required"`
	// WGS84 latitude of the drop zone, in degrees. -90 to 90 degrees (negative values
	// south of equator).
	Lat float64 `json:"lat" api:"required"`
	// WGS84 longitude of the drop zone, in degrees. -180 to 180 degrees (negative
...
type DropzoneNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DropzoneNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// WGS84 latitude of the drop zone, in degrees. -90 to 90 degrees (negative values
	// south of equator).
	Lat float64 `json:"lat" api:"required"`
	// WGS84 longitude of the drop zone, in degrees. -180 to 180 degrees (negative
...
type DropzoneUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode DropzoneUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// WGS84 latitude of the drop zone, in degrees. -90 to 90 degrees (negative values
	// south of equator).
	Lat float64 `json:"lat" api:"required"`
	// WGS84 longitude of the drop zone, in degrees. -180 to 180 degrees (negative
