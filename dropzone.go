...
type DropzoneQueryHelpResponse struct {
	...
	Parameters            []DropzoneQueryHelpResponseParameter `json:"parameters"`
...
type DropzoneQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r DropzoneQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *DropzoneQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
