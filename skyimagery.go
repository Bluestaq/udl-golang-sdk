...
type SkyImageryListResponse struct {
	...
	DataMode SkyImageryListResponseDataMode `json:"dataMode" api:"required"`
	// Start time of the exposure, in ISO 8601 UTC format with microsecond precision.
	ExpStartTime time.Time `json:"expStartTime" api:"required" format:"date-time"`
...
type SkyImageryGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SkyImageryGetResponseDataMode `json:"dataMode" api:"required"`
	// Start time of the exposure, in ISO 8601 UTC format with microsecond precision.
	ExpStartTime time.Time `json:"expStartTime" api:"required" format:"date-time"`
	// The type of image associated with this record (e.g. FITS, EOSSA, EOCHIP, MP4).
	ImageType string `json:"imageType" api:"required"`
...
type SkyImageryTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SkyImageryTupleResponseDataMode `json:"dataMode" api:"required"`
	// Start time of the exposure, in ISO 8601 UTC format with microsecond precision.
	ExpStartTime time.Time `json:"expStartTime" api:"required" format:"date-time"`
	// The type of image associated with this record (e.g. FITS, EOSSA, EOCHIP, MP4).
	ImageType string `json:"imageType" api:"required"`
...
type SkyImageryListParams struct {
	...
	ExpStartTime time.Time        `query:"expStartTime" api:"required" format:"date-time" json:"-"`
