...
// UdlSensorplanHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlSensorplanHistoryService] method instead.
type UdlSensorplanHistoryService struct {
	Options []option.RequestOption
}

// NewUdlSensorplanHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlSensorplanHistoryService(opts ...option.RequestOption) (r UdlSensorplanHistoryService) {
	r = UdlSensorplanHistoryService{}
	r.Options = opts
	return
}
...
type SensorplanFull struct {
	...
	DataMode SensorplanFullDataMode `json:"dataMode,required"`
	...
	CollectRequests []SensorplanFullCollectRequest `json:"collectRequests"`
...
func (r SensorplanFull) RawJSON() string { return r.JSON.raw }
func (r *SensorplanFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type SensorplanFullDataMode string

const (
	SensorplanFullDataModeReal      SensorplanFullDataMode = "REAL"
	SensorplanFullDataModeTest      SensorplanFullDataMode = "TEST"
	SensorplanFullDataModeSimulated SensorplanFullDataMode = "SIMULATED"
	SensorplanFullDataModeExercise  SensorplanFullDataMode = "EXERCISE"
)
...
// if desired.
type SensorplanFullCollectRequest struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	Elset SensorplanFullCollectRequestElset `json:"elset"`
	...
	// provider.
	StateVector SensorplanFullCollectRequestStateVector `json:"stateVector"`
...
// Returns the unmodified JSON received from the API
func (r SensorplanFullCollectRequest) RawJSON() string { return r.JSON.raw }
func (r *SensorplanFullCollectRequest) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// order to predict the motion of a satellite. The element set, or elset for short,
// consists of identification data, the classical elements and drag parameters.
type SensorplanFullCollectRequestElset struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r SensorplanFullCollectRequestElset) RawJSON() string { return r.JSON.raw }
func (r *SensorplanFullCollectRequestElset) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// the 'Discover' tab in the storefront to confirm coordinate frames by data
// provider.
type SensorplanFullCollectRequestStateVector struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r SensorplanFullCollectRequestStateVector) RawJSON() string { return r.JSON.raw }
func (r *SensorplanFullCollectRequestStateVector) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
