...
// path parameter.
func (r *AircraftService) Get(ctx context.Context, id string, query AircraftGetParams, opts ...option.RequestOption) (res *shared.AircraftFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
func (r *AircraftService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *AircraftQueryhelpResponse, err error) {
	opts = append(r.Options[:], opts...)
...
type AircraftQueryhelpResponse struct {
	AodrSupported         bool                                 `json:"aodrSupported"`
	ClassificationMarking string                               `json:"classificationMarking"`
	Description           string                               `json:"description"`
	HistorySupported      bool                                 `json:"historySupported"`
	Name                  string                               `json:"name"`
	Parameters            []AircraftQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r AircraftQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *AircraftQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AircraftQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AircraftQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AircraftQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (r *AircraftNewParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
func (r *AircraftUpdateParams) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
