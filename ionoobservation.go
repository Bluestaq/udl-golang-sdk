...
type IonOobservationQueryhelpResponse struct {
	...
	Name                  string                                      `json:"name"`
	Parameters            []IonOobservationQueryhelpResponseParameter `json:"parameters"`
...
type IonOobservationQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r IonOobservationQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *IonOobservationQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
