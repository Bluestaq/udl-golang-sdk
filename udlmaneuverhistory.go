...
// UdlManeuverHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlManeuverHistoryService] method instead.
type UdlManeuverHistoryService struct {
	Options []option.RequestOption
}

// NewUdlManeuverHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlManeuverHistoryService(opts ...option.RequestOption) (r UdlManeuverHistoryService) {
	r = UdlManeuverHistoryService{}
	r.Options = opts
	return
}
...
type ManeuverFull struct {
	...
	DataMode ManeuverFullDataMode `json:"dataMode,required"`
	...
	PostEventElset ManeuverFullPostEventElset `json:"postEventElset"`
	...
	// provider.
	PostEventStateVector ManeuverFullPostEventStateVector `json:"postEventStateVector"`
	...
	// order to predict the motion of a satellite. The element set, or elset for short,
	// consists of identification data, the classical elements and drag parameters.
	PreEventElset ManeuverFullPreEventElset `json:"preEventElset"`
	...
	// the 'Discover' tab in the storefront to confirm coordinate frames by data
	// provider.
	PreEventStateVector ManeuverFullPreEventStateVector `json:"preEventStateVector"`
...
func (r ManeuverFull) RawJSON() string { return r.JSON.raw }
func (r *ManeuverFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type ManeuverFullDataMode string

const (
	ManeuverFullDataModeReal      ManeuverFullDataMode = "REAL"
	ManeuverFullDataModeTest      ManeuverFullDataMode = "TEST"
	ManeuverFullDataModeSimulated ManeuverFullDataMode = "SIMULATED"
	ManeuverFullDataModeExercise  ManeuverFullDataMode = "EXERCISE"
)
...
// order to predict the motion of a satellite. The element set, or elset for short,
// consists of identification data, the classical elements and drag parameters.
type ManeuverFullPostEventElset struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r ManeuverFullPostEventElset) RawJSON() string { return r.JSON.raw }
func (r *ManeuverFullPostEventElset) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// the 'Discover' tab in the storefront to confirm coordinate frames by data
// provider.
type ManeuverFullPostEventStateVector struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r ManeuverFullPostEventStateVector) RawJSON() string { return r.JSON.raw }
func (r *ManeuverFullPostEventStateVector) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// order to predict the motion of a satellite. The element set, or elset for short,
// consists of identification data, the classical elements and drag parameters.
type ManeuverFullPreEventElset struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r ManeuverFullPreEventElset) RawJSON() string { return r.JSON.raw }
func (r *ManeuverFullPreEventElset) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// the 'Discover' tab in the storefront to confirm coordinate frames by data
// provider.
type ManeuverFullPreEventStateVector struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r ManeuverFullPreEventStateVector) RawJSON() string { return r.JSON.raw }
func (r *ManeuverFullPreEventStateVector) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
