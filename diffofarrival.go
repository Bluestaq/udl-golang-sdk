...
type DiffOfArrivalQueryhelpResponse struct {
	...
	Parameters            []DiffOfArrivalQueryhelpResponseParameter `json:"parameters"`
...
func (r DiffOfArrivalQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *DiffOfArrivalQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type DiffOfArrivalQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r DiffOfArrivalQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *DiffOfArrivalQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
