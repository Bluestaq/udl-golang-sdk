...
type EquipmentRemarkAbridged struct {
	...
	DataMode EquipmentRemarkAbridgedDataMode `json:"dataMode" api:"required"`
	// The ID of the Equipment to which this remark applies.
	IDEquipment string `json:"idEquipment" api:"required"`
	// Source of the data.
...
type EquipmentRemarkFull struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EquipmentRemarkFullDataMode `json:"dataMode" api:"required"`
	// The ID of the Equipment to which this remark applies.
	IDEquipment string `json:"idEquipment" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EquipmentRemarkNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EquipmentRemarkNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The ID of the Equipment to which this remark applies.
	IDEquipment string `json:"idEquipment" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
