...
// the [NewNotificationHistoryService] method instead.
type NotificationHistoryService struct {
	Options []option.RequestOption
}

// NewNotificationHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewNotificationHistoryService(opts ...option.RequestOption) (r NotificationHistoryService) {
	r = NotificationHistoryService{}
	r.Options = opts
	return
}
...
func (r *NotificationHistoryService) List(ctx context.Context, query NotificationHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[NotificationFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *NotificationHistoryService) ListAutoPaging(ctx context.Context, query NotificationHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[NotificationFull] {
...
// `url.Values`.
func (r NotificationHistoryCountParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
