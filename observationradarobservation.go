...
type ObservationRadarobservationQueryhelpResponse struct {
	...
	Parameters            []ObservationRadarobservationQueryhelpResponseParameter `json:"parameters"`
...
type ObservationRadarobservationQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ObservationRadarobservationQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ObservationRadarobservationQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
