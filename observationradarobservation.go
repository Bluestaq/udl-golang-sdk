...
type ObservationRadarobservationListResponse struct {
	...
	DataMode ObservationRadarobservationListResponseDataMode `json:"dataMode" api:"required"`
...
type ObservationRadarobservationGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationRadarobservationGetResponseDataMode `json:"dataMode" api:"required"`
	// Ob detection time in ISO 8601 UTC with microsecond precision.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type ObservationRadarobservationTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationRadarobservationTupleResponseDataMode `json:"dataMode" api:"required"`
	// Ob detection time in ISO 8601 UTC with microsecond precision.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type ObservationRadarobservationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationRadarobservationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Ob detection time in ISO 8601 UTC with microsecond precision.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
