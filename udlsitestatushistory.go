...
// UdlSitestatusHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlSitestatusHistoryService] method instead.
type UdlSitestatusHistoryService struct {
	Options []option.RequestOption
}

// NewUdlSitestatusHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlSitestatusHistoryService(opts ...option.RequestOption) (r UdlSitestatusHistoryService) {
	r = UdlSitestatusHistoryService{}
	r.Options = opts
	return
}
...
type SitestatusFull struct {
	...
	DataMode SitestatusFullDataMode `json:"dataMode,required"`
	...
	Cat SitestatusFullCat `json:"cat"`
	...
	//
	// Any of "1", "2", "3", "4", "5".
	Cpcon SitestatusFullCpcon `json:"cpcon"`
	...
	//
	// Any of "COLD", "WARM", "HOT".
	Eoc SitestatusFullEoc `json:"eoc"`
	...
	Fpcon SitestatusFullFpcon `json:"fpcon"`
	...
	Hpcon SitestatusFullHpcon `json:"hpcon"`
	...
	InstStatus SitestatusFullInstStatus `json:"instStatus"`
...
func (r SitestatusFull) RawJSON() string { return r.JSON.raw }
func (r *SitestatusFull) UnmarshalJSON(data []byte) error {
...
//
// HOT - Fully active.
type SitestatusFullCat string

const (
	SitestatusFullCatCold SitestatusFullCat = "COLD"
	SitestatusFullCatWarm SitestatusFullCat = "WARM"
	SitestatusFullCatHot  SitestatusFullCat = "HOT"
)
...
//
// 5 - VERY LOW - All functions.
type SitestatusFullCpcon string

const (
	SitestatusFullCpcon1 SitestatusFullCpcon = "1"
	SitestatusFullCpcon2 SitestatusFullCpcon = "2"
	SitestatusFullCpcon3 SitestatusFullCpcon = "3"
	SitestatusFullCpcon4 SitestatusFullCpcon = "4"
	SitestatusFullCpcon5 SitestatusFullCpcon = "5"
)
...
//
// HOT - Fully active.
type SitestatusFullEoc string

const (
	SitestatusFullEocCold SitestatusFullEoc = "COLD"
	SitestatusFullEocWarm SitestatusFullEoc = "WARM"
	SitestatusFullEocHot  SitestatusFullEoc = "HOT"
)
...
// intelligence is received indicating terrorist action against a location is
// imminent.
type SitestatusFullFpcon string

const (
	SitestatusFullFpconNormal  SitestatusFullFpcon = "NORMAL"
	SitestatusFullFpconAlpha   SitestatusFullFpcon = "ALPHA"
	SitestatusFullFpconBravo   SitestatusFullFpcon = "BRAVO"
	SitestatusFullFpconCharlie SitestatusFullFpcon = "CHARLIE"
	SitestatusFullFpconDelta   SitestatusFullFpcon = "DELTA"
)
...
//
// DELTA - Severe, widespread community transmission.
type SitestatusFullHpcon string

const (
	SitestatusFullHpcon0       SitestatusFullHpcon = "0"
	SitestatusFullHpconAlpha   SitestatusFullHpcon = "ALPHA"
	SitestatusFullHpconBravo   SitestatusFullHpcon = "BRAVO"
	SitestatusFullHpconCharlie SitestatusFullHpcon = "CHARLIE"
	SitestatusFullHpconDelta   SitestatusFullHpcon = "DELTA"
)
...
//
// UNK - Unknown.
type SitestatusFullInstStatus string

const (
	SitestatusFullInstStatusFmc SitestatusFullInstStatus = "FMC"
	SitestatusFullInstStatusPmc SitestatusFullInstStatus = "PMC"
	SitestatusFullInstStatusNmc SitestatusFullInstStatus = "NMC"
	SitestatusFullInstStatusUnk SitestatusFullInstStatus = "UNK"
)
