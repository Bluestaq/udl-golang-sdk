...
func TestEoObservationNewWithOptionalParams(t *testing.T) {
	...
	err := client.EoObservations.New(context.TODO(), unifieddatalibrary.EoObservationNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.EoObservationNewParamsDataModeTest,
		ObTime:                time.Now(),
		Source:                "Bluestaq",
		...
		EoobservationDetails: unifieddatalibrary.EoObservationNewParamsEoobservationDetails{
		...
		ReferenceFrame:       unifieddatalibrary.EoObservationNewParamsReferenceFrameJ2000,
		...
		SenReferenceFrame:    unifieddatalibrary.EoObservationNewParamsSenReferenceFrameJ2000,
...
func TestEoObservationListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.EoObservations.List(context.TODO(), unifieddatalibrary.EoObservationListParams{
		ObTime:      time.Now(),
...
func TestEoObservationCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.EoObservations.Count(context.TODO(), unifieddatalibrary.EoObservationCountParams{
		ObTime:      time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestEoObservationNewBulkWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.EoObservations.NewBulk(context.TODO(), unifieddatalibrary.EoObservationNewBulkParams{
		Body: []unifieddatalibrary.EoObservationNewBulkParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			ObTime:                time.Now(),
			Source:                "Bluestaq",
			...
			ElevationRate:         unifieddatalibrary.Float(1.1),
			ElevationUnc:          unifieddatalibrary.Float(1.1),
			EoobservationDetails: unifieddatalibrary.EoObservationNewBulkParamsBodyEoobservationDetails{
				AcalCrPixX:                           unifieddatalibrary.Float(123.2),
				AcalCrPixY:                           unifieddatalibrary.Float(123.2),
				AcalCrValX:                           unifieddatalibrary.Float(123.2),
				AcalCrValY:                           unifieddatalibrary.Float(123.2),
...
func TestEoObservationUnvalidatedPublish(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.EoObservations.UnvalidatedPublish(context.TODO(), unifieddatalibrary.EoObservationUnvalidatedPublishParams{
		Body: []unifieddatalibrary.EoObservationUnvalidatedPublishParamsBody{{
			ClassificationMarking: "U",
			DataMode:              "TEST",
			ObTime:                time.Now(),
			Source:                "Bluestaq",
			...
			ElevationRate:         unifieddatalibrary.Float(1.1),
			ElevationUnc:          unifieddatalibrary.Float(1.1),
			EoobservationDetails: unifieddatalibrary.EoObservationUnvalidatedPublishParamsBodyEoobservationDetails{
				AcalCrPixX:                           unifieddatalibrary.Float(123.2),
				AcalCrPixY:                           unifieddatalibrary.Float(123.2),
				AcalCrValX:                           unifieddatalibrary.Float(123.2),
				AcalCrValY:                           unifieddatalibrary.Float(123.2),
