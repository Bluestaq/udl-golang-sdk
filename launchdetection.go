...
type LaunchDetectionListResponse struct {
	...
	DataMode LaunchDetectionListResponseDataMode `json:"dataMode" api:"required"`
	...
	ObservationLatitude float64 `json:"observationLatitude" api:"required"`
	// Longitude of launch vehicle at observation time (in Degrees).
	ObservationLongitude float64 `json:"observationLongitude" api:"required"`
	// Time of observation.
	ObservationTime time.Time `json:"observationTime" api:"required" format:"date-time"`
	// Integer indicating how messages should be sequenced for a specific event.
	SequenceNumber int64 `json:"sequenceNumber" api:"required"`
	// Source of the data.
...
type LaunchDetectionGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchDetectionGetResponseDataMode `json:"dataMode" api:"required"`
	// Type of message for the data.
	MessageType string `json:"messageType" api:"required"`
	// Latitude of launch vehicle at observation time (in Degrees). -90 to 90 degrees
	// (negative values south of equator).
...
type LaunchDetectionTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchDetectionTupleResponseDataMode `json:"dataMode" api:"required"`
	// Type of message for the data.
	MessageType string `json:"messageType" api:"required"`
	// Latitude of launch vehicle at observation time (in Degrees). -90 to 90 degrees
	// (negative values south of equator).
...
type LaunchDetectionNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchDetectionNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Type of message for the data.
	MessageType string `json:"messageType" api:"required"`
	// Latitude of launch vehicle at observation time (in Degrees). -90 to 90 degrees
	// (negative values south of equator).
...
type LaunchDetectionUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchDetectionUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Type of message for the data.
	MessageType string `json:"messageType" api:"required"`
	// Latitude of launch vehicle at observation time (in Degrees). -90 to 90 degrees
	// (negative values south of equator).
