...
type AircraftsortieAbridged struct {
	...
	JSON struct {
		...
		ActualBlockInTime     resp.Field
		ActualBlockOutTime    resp.Field
		ActualDepTime         resp.Field
		AircraftAdsb          resp.Field
		AircraftAltID         resp.Field
		AircraftEvent         resp.Field
		AircraftMds           resp.Field
		AircraftRemarks       resp.Field
		AlertStatus           resp.Field
		AlertStatusCode       resp.Field
		AmcMsnNum             resp.Field
		AmcMsnType            resp.Field
		ArrFaa                resp.Field
		ArrIata               resp.Field
		ArrIcao               resp.Field
		ArrItinerary          resp.Field
		ArrPurposeCode        resp.Field
		CallSign              resp.Field
		...
		DelayCode             resp.Field
		DepFaa                resp.Field
		DepIata               resp.Field
		DepIcao               resp.Field
		DepItinerary          resp.Field
		DepPurposeCode        resp.Field
		Dhd                   resp.Field
		DhdReason             resp.Field
		EstArrTime            resp.Field
		EstBlockInTime        resp.Field
		EstBlockOutTime       resp.Field
		EstDepTime            resp.Field
		Filename              resp.Field
		Filesize              resp.Field
		FlightTime            resp.Field
		FmDeskNum             resp.Field
		FmName                resp.Field
		FuelReq               resp.Field
		GndTime               resp.Field
		...
		MissionUpdate         resp.Field
		ObjectiveRemarks      resp.Field
		Origin                resp.Field
		OrigNetwork           resp.Field
		OrigSortieID          resp.Field
		OxyOnCrew             resp.Field
		OxyOnPax              resp.Field
		OxyReqCrew            resp.Field
		OxyReqPax             resp.Field
		PaperStatus           resp.Field
		PapersVersion         resp.Field
		ParkingLoc            resp.Field
		Passengers            resp.Field
		PlannedArrTime        resp.Field
		PprStatus             resp.Field
		PrimaryScl            resp.Field
		RawFileUri            resp.Field
		ReqConfig             resp.Field
		ResultRemarks         resp.Field
		RvnReq                resp.Field
		ScheduleRemarks       resp.Field
		SecondaryScl          resp.Field
		Soe                   resp.Field
		SortieDate            resp.Field
		SourceDl              resp.Field
