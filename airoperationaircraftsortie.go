...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *AirOperationAircraftSortieService) HistoryQuery(ctx context.Context, query AirOperationAircraftSortieHistoryQueryParams, opts ...option.RequestOption) (res *[]shared.AircraftsortieFull, err error) {
	opts = append(r.Options[:], opts...)
