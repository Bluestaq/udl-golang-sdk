...
type NotificationListResponse struct {
	...
	DataMode NotificationListResponseDataMode `json:"dataMode" api:"required"`
	...
	MsgBody string `json:"msgBody" api:"required"`
	// Source provided message type.
	MsgType string `json:"msgType" api:"required"`
	// Source of the data.
...
type NotificationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode NotificationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The message body content as a text string, XML, JSON, etc. If JSON is used for
	// the msgBody, it should be 'inline' with the notification message JSON (without
	// quotation marks or escape characters). Size of the msg body cannot be over 1MB.
	MsgBody string `json:"msgBody" api:"required"`
...
type NotificationNewRawParams struct {
	...
	// Source provided message type.
	MsgType string `query:"msgType" api:"required" json:"-"`
	// Origin of the data.
	Origin string `query:"origin" api:"required" json:"-"`
	// Source of the data.
