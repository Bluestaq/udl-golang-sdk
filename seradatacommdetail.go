...
type SeraDataCommDetailQueryhelpResponse struct {
	...
	Parameters            []SeraDataCommDetailQueryhelpResponseParameter `json:"parameters"`
...
type SeraDataCommDetailQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SeraDataCommDetailQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SeraDataCommDetailQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
