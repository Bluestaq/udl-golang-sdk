...
type SoiObservationSetQueryhelpResponse struct {
	...
	Parameters            []SoiObservationSetQueryhelpResponseParameter `json:"parameters"`
...
type SoiObservationSetQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SoiObservationSetQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SoiObservationSetQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
