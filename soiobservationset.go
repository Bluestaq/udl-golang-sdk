...
type SoiObservationSetListResponse struct {
	...
	DataMode SoiObservationSetListResponseDataMode `json:"dataMode" api:"required"`
	// The number of observation records in the set.
	NumObs int64 `json:"numObs" api:"required"`
	// Source of the data.
	...
	Type SoiObservationSetListResponseType `json:"type" api:"required"`
...
type SoiObservationSetNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SoiObservationSetNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The number of observation records in the set.
	NumObs int64 `json:"numObs" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	...
	//
	// Any of "OPTICAL", "RADAR".
	Type SoiObservationSetNewParamsType `json:"type,omitzero" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
...
type SoiObservationSetNewParamsOpticalSoiObservationList struct {
	...
	ObStartTime time.Time `json:"obStartTime" api:"required" format:"date-time"`
