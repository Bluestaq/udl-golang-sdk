...
type ObservationEcpsdrQueryHelpResponse struct {
	...
	Parameters            []ObservationEcpsdrQueryHelpResponseParameter `json:"parameters"`
...
type ObservationEcpsdrQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ObservationEcpsdrQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ObservationEcpsdrQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
