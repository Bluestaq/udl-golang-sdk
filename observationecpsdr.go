...
type Ecpsdr struct {
	...
	DataMode EcpsdrDataMode `json:"dataMode" api:"required"`
...
type EcpsdrAbridged struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EcpsdrAbridgedDataMode `json:"dataMode" api:"required"`
	// Time stamp of time packet receipt on ground, in ISO 8601 UTC format with
	// millisecond precision.
	MsgTime time.Time `json:"msgTime" api:"required" format:"date-time"`
	// Source of the data.
...
type ObservationEcpsdrNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationEcpsdrNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Time stamp of time packet receipt on ground, in ISO 8601 UTC format with
	// millisecond precision.
	MsgTime time.Time `json:"msgTime" api:"required" format:"date-time"`
	// Source of the data.
