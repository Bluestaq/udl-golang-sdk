...
type GnssRawifQueryhelpResponse struct {
	...
	Parameters            []GnssRawifQueryhelpResponseParameter `json:"parameters"`
...
type GnssRawifQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r GnssRawifQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *GnssRawifQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
