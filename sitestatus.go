...
type SiteStatusQueryhelpResponse struct {
	...
	Parameters            []SiteStatusQueryhelpResponseParameter `json:"parameters"`
...
type SiteStatusQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SiteStatusQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SiteStatusQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
