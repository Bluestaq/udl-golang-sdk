...
type ObservationObscorrelationGetResponse struct {
	...
	CorrType ObservationObscorrelationGetResponseCorrType `json:"corrType" api:"required"`
	...
	DataMode ObservationObscorrelationGetResponseDataMode `json:"dataMode" api:"required"`
	// Correlation message generation time, in ISO 8601 UTC format with millisecond
	// precision.
	MsgTs time.Time `json:"msgTs" api:"required" format:"date-time"`
	...
	// trackId.
	ObID string `json:"obId" api:"required"`
	...
	ObType ObservationObscorrelationGetResponseObType `json:"obType" api:"required"`
	// Identifier of the orbit state used for correlation.
	ReferenceOrbitID string `json:"referenceOrbitId" api:"required"`
	...
	ReferenceOrbitType ObservationObscorrelationGetResponseReferenceOrbitType `json:"referenceOrbitType" api:"required"`
	// Source of the data.
...
type ObservationObscorrelationListResponse struct {
	...
	//
	// Any of "OBSERVATION", "TRACK".
	CorrType ObservationObscorrelationListResponseCorrType `json:"corrType" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	// REAL:&nbsp;Data collected or produced that pertains to real-world objects,
	// events, and analysis.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationObscorrelationListResponseDataMode `json:"dataMode" api:"required"`
	// Correlation message generation time, in ISO 8601 UTC format with millisecond
	// precision.
	MsgTs time.Time `json:"msgTs" api:"required" format:"date-time"`
	// Identifier of the Observation associated with this Correlation. If
	...
	//
	// Any of "DOA", "EO", "PASSIVE_RADAR", "RADAR", "RF", "SAR", "SOISET".
	ObType ObservationObscorrelationListResponseObType `json:"obType" api:"required"`
	// Identifier of the orbit state used for correlation.
	ReferenceOrbitID string `json:"referenceOrbitId" api:"required"`
	// Indicator of whether the reference orbit type used for correlation is an ELSET,
	// ESID, or SV: ELSET: The reference orbit type is an Element Set. ESID: The
	...
	//
	// Any of "ELSET", "ESID", "SV".
	ReferenceOrbitType ObservationObscorrelationListResponseReferenceOrbitType `json:"referenceOrbitType" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type ObservationObscorrelationTupleResponse struct {
	...
	//
	// Any of "OBSERVATION", "TRACK".
	CorrType ObservationObscorrelationTupleResponseCorrType `json:"corrType" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	// REAL:&nbsp;Data collected or produced that pertains to real-world objects,
	// events, and analysis.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationObscorrelationTupleResponseDataMode `json:"dataMode" api:"required"`
	// Correlation message generation time, in ISO 8601 UTC format with millisecond
	// precision.
	MsgTs time.Time `json:"msgTs" api:"required" format:"date-time"`
	// Identifier of the Observation associated with this Correlation. If
	...
	//
	// Any of "DOA", "EO", "PASSIVE_RADAR", "RADAR", "RF", "SAR", "SOISET".
	ObType ObservationObscorrelationTupleResponseObType `json:"obType" api:"required"`
	// Identifier of the orbit state used for correlation.
	ReferenceOrbitID string `json:"referenceOrbitId" api:"required"`
	// Indicator of whether the reference orbit type used for correlation is an ELSET,
	// ESID, or SV: ELSET: The reference orbit type is an Element Set. ESID: The
	...
	//
	// Any of "ELSET", "ESID", "SV".
	ReferenceOrbitType ObservationObscorrelationTupleResponseReferenceOrbitType `json:"referenceOrbitType" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type ObservationObscorrelationNewParams struct {
	...
	//
	// Any of "OBSERVATION", "TRACK".
	CorrType ObservationObscorrelationNewParamsCorrType `json:"corrType,omitzero" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	// REAL:&nbsp;Data collected or produced that pertains to real-world objects,
	// events, and analysis.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObservationObscorrelationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Correlation message generation time, in ISO 8601 UTC format with millisecond
	// precision.
	MsgTs time.Time `json:"msgTs" api:"required" format:"date-time"`
	// Identifier of the Observation associated with this Correlation. If
	...
	//
	// Any of "DOA", "EO", "PASSIVE_RADAR", "RADAR", "RF", "SAR", "SOISET".
	ObType ObservationObscorrelationNewParamsObType `json:"obType,omitzero" api:"required"`
	// Identifier of the orbit state used for correlation.
	ReferenceOrbitID string `json:"referenceOrbitId" api:"required"`
	// Indicator of whether the reference orbit type used for correlation is an ELSET,
	// ESID, or SV: ELSET: The reference orbit type is an Element Set. ESID: The
	...
	//
	// Any of "ELSET", "ESID", "SV".
	ReferenceOrbitType ObservationObscorrelationNewParamsReferenceOrbitType `json:"referenceOrbitType,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
...
type ObservationObscorrelationListParams struct {
	...
	MsgTs       time.Time        `query:"msgTs" api:"required" format:"date-time" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
...
type ObservationObscorrelationNewBulkParamsBody struct {
	...
	//
	// Any of "OBSERVATION", "TRACK".
	CorrType string `json:"corrType,omitzero" api:"required"`
	// Indicator of whether the data is REAL, TEST, EXERCISE, or SIMULATED data:
	//
	// REAL:&nbsp;Data collected or produced that pertains to real-world objects,
	// events, and analysis.
	...
	//
	// Any of "DOA", "EO", "PASSIVE_RADAR", "RADAR", "RF", "SAR", "SOISET".
	ObType string `json:"obType,omitzero" api:"required"`
	// Identifier of the orbit state used for correlation.
	ReferenceOrbitID string `json:"referenceOrbitId" api:"required"`
	// Indicator of whether the reference orbit type used for correlation is an ELSET,
	// ESID, or SV: ELSET: The reference orbit type is an Element Set. ESID: The
	...
	//
	// Any of "ELSET", "ESID", "SV".
	ReferenceOrbitType string `json:"referenceOrbitType,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID param.Opt[string] `json:"id,omitzero"`
