...
func (r *ReportAndActivityPoiHistoryService) List(ctx context.Context, query ReportAndActivityPoiHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[PoiFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *ReportAndActivityPoiHistoryService) ListAutoPaging(ctx context.Context, query ReportAndActivityPoiHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[PoiFull] {
