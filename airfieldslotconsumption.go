...
type AirfieldslotconsumptionAbridged struct {
	...
	DataMode AirfieldslotconsumptionAbridgedDataMode `json:"dataMode" api:"required"`
	// Unique identifier of the airfield slot for which this slot consumption record is
	// referencing.
	IDAirfieldSlot string `json:"idAirfieldSlot" api:"required"`
	// Number of aircraft using this slot for this time.
	NumAircraft int64 `json:"numAircraft" api:"required"`
	// Source of the data.
...
type AirfieldSlotConsumptionNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldSlotConsumptionNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the airfield slot for which this slot consumption record is
	// referencing.
	IDAirfieldSlot string `json:"idAirfieldSlot" api:"required"`
	// Number of aircraft using this slot for this time.
...
type AirfieldSlotConsumptionUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldSlotConsumptionUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the airfield slot for which this slot consumption record is
	// referencing.
	IDAirfieldSlot string `json:"idAirfieldSlot" api:"required"`
	// Number of aircraft using this slot for this time.
