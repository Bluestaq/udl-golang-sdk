...
type SolarArrayDetailListResponse struct {
	...
	DataMode SolarArrayDetailListResponseDataMode `json:"dataMode" api:"required"`
...
type SolarArrayDetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SolarArrayDetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent SolarArray.
	IDSolarArray string `json:"idSolarArray" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SolarArrayDetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SolarArrayDetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent SolarArray.
	IDSolarArray string `json:"idSolarArray" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
