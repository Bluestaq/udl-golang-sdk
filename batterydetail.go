...
type BatterydetailsAbridged struct {
	...
	DataMode BatterydetailsAbridgedDataMode `json:"dataMode" api:"required"`
...
type BatterydetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatterydetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent battery type record.
	IDBattery string `json:"idBattery" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type BatterydetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatterydetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent battery type record.
	IDBattery string `json:"idBattery" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
