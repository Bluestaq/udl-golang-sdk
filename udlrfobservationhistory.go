...
// UdlRfobservationHistoryService contains methods and other services that help
// with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlRfobservationHistoryService] method instead.
type UdlRfobservationHistoryService struct {
	Options []option.RequestOption
}

// NewUdlRfobservationHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlRfobservationHistoryService(opts ...option.RequestOption) (r UdlRfobservationHistoryService) {
	r = UdlRfobservationHistoryService{}
	r.Options = opts
	return
}
...
// frequencies[0]).
type RfobservationdetailsFull struct {
	...
	DataMode RfobservationdetailsFullDataMode `json:"dataMode,required"`
	...
	//
	// Any of "H", "V", "R", "L".
	PolarityType RfobservationdetailsFullPolarityType `json:"polarityType"`
...
func (r RfobservationdetailsFull) RawJSON() string { return r.JSON.raw }
func (r *RfobservationdetailsFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type RfobservationdetailsFullDataMode string

const (
	RfobservationdetailsFullDataModeReal      RfobservationdetailsFullDataMode = "REAL"
	RfobservationdetailsFullDataModeTest      RfobservationdetailsFullDataMode = "TEST"
	RfobservationdetailsFullDataModeSimulated RfobservationdetailsFullDataMode = "SIMULATED"
	RfobservationdetailsFullDataModeExercise  RfobservationdetailsFullDataMode = "EXERCISE"
)
...
// R - (Right Hand Circularly Polarized) Rotating right relative to the earth's
// surface.
type RfobservationdetailsFullPolarityType string

const (
	RfobservationdetailsFullPolarityTypeH RfobservationdetailsFullPolarityType = "H"
	RfobservationdetailsFullPolarityTypeV RfobservationdetailsFullPolarityType = "V"
	RfobservationdetailsFullPolarityTypeR RfobservationdetailsFullPolarityType = "R"
	RfobservationdetailsFullPolarityTypeL RfobservationdetailsFullPolarityType = "L"
)
