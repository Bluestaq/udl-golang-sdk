...
// UdlOrbittrackHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlOrbittrackHistoryService] method instead.
type UdlOrbittrackHistoryService struct {
	Options []option.RequestOption
}

// NewUdlOrbittrackHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlOrbittrackHistoryService(opts ...option.RequestOption) (r UdlOrbittrackHistoryService) {
	r = UdlOrbittrackHistoryService{}
	r.Options = opts
	return
}
...
type OrbittrackFull struct {
	...
	DataMode OrbittrackFullDataMode `json:"dataMode,required"`
	...
	ObjectType OrbittrackFullObjectType `json:"objectType"`
	...
	// "UNKNOWN".
	ObjIdent OrbittrackFullObjIdent `json:"objIdent"`
	...
	TrackSensors []OrbittrackFullTrackSensor `json:"trackSensors"`
...
func (r OrbittrackFull) RawJSON() string { return r.JSON.raw }
func (r *OrbittrackFull) UnmarshalJSON(data []byte) error {
...
type OrbittrackFullTrackSensor struct {
...
// Returns the unmodified JSON received from the API
func (r OrbittrackFullTrackSensor) RawJSON() string { return r.JSON.raw }
func (r *OrbittrackFullTrackSensor) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
