...
type AirfieldSlotQueryhelpResponse struct {
	...
	Parameters            []AirfieldSlotQueryhelpResponseParameter `json:"parameters"`
...
type AirfieldSlotQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r AirfieldSlotQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *AirfieldSlotQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
