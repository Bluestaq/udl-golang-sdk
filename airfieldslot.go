...
type AirfieldslotAbridged struct {
	...
	AirfieldName string `json:"airfieldName" api:"required"`
	...
	DataMode AirfieldslotAbridgedDataMode `json:"dataMode" api:"required"`
	// Name of this slot.
...
type AirfieldSlotNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldSlotNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Name of this slot.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type AirfieldSlotUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode AirfieldSlotUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Name of this slot.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
