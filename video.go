...
type VideoListResponse struct {
	...
	DataMode VideoListResponseDataMode `json:"dataMode" api:"required"`
	...
	TokenValue string `json:"tokenValue" api:"required"`
...
type VideoGetPlayerStreamingInfoResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode VideoGetPlayerStreamingInfoResponseDataMode `json:"dataMode" api:"required"`
	// Description/notes associated with the video stream.
	Description string `json:"description" api:"required"`
	// Name of the video stream.
	Name string `json:"name" api:"required"`
...
type VideoGetPublisherStreamingInfoResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode VideoGetPublisherStreamingInfoResponseDataMode `json:"dataMode" api:"required"`
	// Description/notes associated with the video stream.
	Description string `json:"description" api:"required"`
	// Name of the video stream.
	Name string `json:"name" api:"required"`
...
type VideoGetStreamFileResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode VideoGetStreamFileResponseDataMode `json:"dataMode" api:"required"`
	// Description/notes associated with the video stream.
	Description string `json:"description" api:"required"`
	// Name of the video stream.
	Name string `json:"name" api:"required"`
...
type VideoNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode VideoNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Description/notes associated with the video stream.
	Description string `json:"description" api:"required"`
	// Name of the video stream.
	Name string `json:"name" api:"required"`
...
type VideoGetPlayerStreamingInfoParams struct {
	...
	SourceName string `query:"sourceName" api:"required" json:"-"`
	// The video stream name.
	StreamName  string           `query:"streamName" api:"required" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
