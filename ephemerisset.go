...
type EphemerisSet struct {
	...
	DataMode EphemerisSetDataMode `json:"dataMode" api:"required"`
...
type EphemerisSetAbridged struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EphemerisSetAbridgedDataMode `json:"dataMode" api:"required"`
	// Number of points contained in the ephemeris.
	NumPoints int64 `json:"numPoints" api:"required"`
	// End time/last time point of the ephemeris, in ISO 8601 UTC format.
	PointEndTime time.Time `json:"pointEndTime" api:"required" format:"date-time"`
...
type EphemerisSetNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EphemerisSetNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Number of points contained in the ephemeris.
	NumPoints int64 `json:"numPoints" api:"required"`
	// End time/last time point of the ephemeris, in ISO 8601 UTC format.
	PointEndTime time.Time `json:"pointEndTime" api:"required" format:"date-time"`
