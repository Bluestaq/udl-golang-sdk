...
func TestTrackRouteNewWithOptionalParams(t *testing.T) {
	...
	err := client.TrackRoute.New(context.TODO(), unifieddatalibrary.TrackRouteNewParams{
		TrackRouteIngest: unifieddatalibrary.TrackRouteIngestParam{
			ClassificationMarking: "U",
			DataMode:              unifieddatalibrary.TrackRouteIngestDataModeTest,
			LastUpdateDate:        time.Now(),
			Source:                "Bluestaq",
			Type:                  "AIR REFUELING",
			ID:                    unifieddatalibrary.String("026dd511-8ba5-47d3-9909-836149f87686"),
			AltitudeBlocks: []unifieddatalibrary.AltitudeBlocksIngestParam{{
			...
			Poc: []unifieddatalibrary.PointOfContactIngestParam{{
			...
			RoutePoints: []unifieddatalibrary.RoutePointsIngestParam{{
...
func TestTrackRouteNewBulk(t *testing.T) {
	...
	err := client.TrackRoute.NewBulk(context.TODO(), unifieddatalibrary.TrackRouteNewBulkParams{
		Body: []unifieddatalibrary.TrackRouteIngestParam{{
			ClassificationMarking: "U",
			DataMode:              unifieddatalibrary.TrackRouteIngestDataModeTest,
			LastUpdateDate:        time.Now(),
			Source:                "Bluestaq",
