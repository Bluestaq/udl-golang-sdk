...
type LocationQueryhelpResponse struct {
	...
	Parameters            []LocationQueryhelpResponseParameter `json:"parameters"`
...
type LocationQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r LocationQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *LocationQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
