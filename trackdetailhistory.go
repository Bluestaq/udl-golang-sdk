...
type TrackDetailsFull struct {
	...
	JSON struct {
		...
		Aton                  resp.Field
		AvgSpd                resp.Field
		AzCorrArcWidth        resp.Field
		AzCorrCenterLine      resp.Field
		BeNumber              resp.Field
		Boosting              resp.Field
		...
		Elnot2                resp.Field
		EmgInd                resp.Field
		EmitterName           resp.Field
		Env                   resp.Field
		ErrAreaOrient         resp.Field
		ErrGeoAreaSwitch      resp.Field
		ErrSemiIntAxis        resp.Field
		ErrSemiMajElev        resp.Field
		Eta                   resp.Field
		Etd                   resp.Field
		EvalRating            resp.Field
		Feint                 resp.Field
		Freq                  resp.Field
		Ftn                   resp.Field
		FtnCmd                resp.Field
		FtnMsgTs              resp.Field
		Harmonics             resp.Field
		Hdng                  resp.Field
		Hq                    resp.Field
		HullNum               resp.Field
		HullProf              resp.Field
		...
		ManeuverInd           resp.Field
		MaxFreq               resp.Field
		MidbCat               resp.Field
		Mil2525Bstr           resp.Field
		Mmsi                  resp.Field
		MsgType               resp.Field
		...
		RptArchived           resp.Field
		RptChxref             resp.Field
		Rtn                   resp.Field
		RtnCmd                resp.Field
		RtnMsgTs              resp.Field
		RtnTrkState           resp.Field
		ScanRate              resp.Field
		ScanType              resp.Field
		Scn                   resp.Field
		Sconum                resp.Field
		SelfReport            resp.Field
		Sen                   resp.Field
		ShipClass             resp.Field
		ShortName             resp.Field
		SourceUid             resp.Field
		SpaceAmp              resp.Field
		SpaceAmpConf          resp.Field
		SpaceSpecType         resp.Field
		Spd                   resp.Field
		StaffCmts             resp.Field
		SternType             resp.Field
		TaskForce             resp.Field
		Tcpa                  resp.Field
		TesEventID            resp.Field
		Tol                   resp.Field
		Tpk                   resp.Field
		TrkConf               resp.Field
		TrkID                 resp.Field
		...
		TrkQual               resp.Field
		TrkScope              resp.Field
		TrnspdrID             resp.Field
		TrnspdrType           resp.Field
		VslWt                 resp.Field
		Width                 resp.Field
