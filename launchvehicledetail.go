...
type LaunchVehicleDetailListResponse struct {
	...
	DataMode LaunchVehicleDetailListResponseDataMode `json:"dataMode" api:"required"`
...
type LaunchVehicleDetailGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchVehicleDetailGetResponseDataMode `json:"dataMode" api:"required"`
	// Identifier of the parent launch vehicle record.
	IDLaunchVehicle string `json:"idLaunchVehicle" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchVehicleDetailNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchVehicleDetailNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent launch vehicle record.
	IDLaunchVehicle string `json:"idLaunchVehicle" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type LaunchVehicleDetailUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaunchVehicleDetailUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Identifier of the parent launch vehicle record.
	IDLaunchVehicle string `json:"idLaunchVehicle" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
