...
// UdlGnssobservationsetHistoryService contains methods and other services that
// help with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlGnssobservationsetHistoryService] method instead.
type UdlGnssobservationsetHistoryService struct {
	Options []option.RequestOption
}

// NewUdlGnssobservationsetHistoryService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewUdlGnssobservationsetHistoryService(opts ...option.RequestOption) (r UdlGnssobservationsetHistoryService) {
	r = UdlGnssobservationsetHistoryService{}
	r.Options = opts
	return
}
...
func (r *UdlGnssobservationsetHistoryService) List(ctx context.Context, query UdlGnssobservationsetHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[GnssObservationSetFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *UdlGnssobservationsetHistoryService) ListAutoPaging(ctx context.Context, query UdlGnssobservationsetHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[GnssObservationSetFull] {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *UdlGnssobservationsetHistoryService) Aodr(ctx context.Context, query UdlGnssobservationsetHistoryAodrParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
...
type UdlGnssobservationsetHistoryListParams struct {
	// Observation Time, in ISO8601 UTC format with microsecond precision. This
	// timestamp applies to all observations within the set.
...
func (f UdlGnssobservationsetHistoryListParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

// URLQuery serializes [UdlGnssobservationsetHistoryListParams]'s query parameters
// as `url.Values`.
func (r UdlGnssobservationsetHistoryListParams) URLQuery() (v url.Values, err error) {
...
type UdlGnssobservationsetHistoryAodrParams struct {
	// Observation Time, in ISO8601 UTC format with microsecond precision. This
	// timestamp applies to all observations within the set.
	// (YYYY-MM-DDTHH:MM:SS.ssssssZ)
	Ts time.Time `query:"ts,required" format:"date-time" json:"-"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f UdlGnssobservationsetHistoryAodrParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

// URLQuery serializes [UdlGnssobservationsetHistoryAodrParams]'s query parameters
// as `url.Values`.
func (r UdlGnssobservationsetHistoryAodrParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
