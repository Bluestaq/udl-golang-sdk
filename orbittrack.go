...
func (r *OrbittrackService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *OrbittrackQueryhelpResponse, err error) {
	opts = append(r.Options[:], opts...)
...
type OrbittrackQueryhelpResponse struct {
	AodrSupported         bool                                   `json:"aodrSupported"`
	ClassificationMarking string                                 `json:"classificationMarking"`
	Description           string                                 `json:"description"`
	HistorySupported      bool                                   `json:"historySupported"`
	Name                  string                                 `json:"name"`
	Parameters            []OrbittrackQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r OrbittrackQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *OrbittrackQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type OrbittrackQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r OrbittrackQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *OrbittrackQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
