...
type GroundImageryQueryhelpResponse struct {
	...
	Name                  string                                    `json:"name"`
	Parameters            []GroundImageryQueryhelpResponseParameter `json:"parameters"`
...
type GroundImageryQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r GroundImageryQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *GroundImageryQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
