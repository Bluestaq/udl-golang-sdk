...
// BatteryService contains methods and other services that help with interacting
// with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewBatteryService] method instead.
type BatteryService struct {
	Options []option.RequestOption
}

// NewBatteryService generates a new service that applies the given options to each
// request. These options are applied after the parent client's options (if there
// is one), and before any request-specific options.
func NewBatteryService(opts ...option.RequestOption) (r BatteryService) {
	r = BatteryService{}
	r.Options = opts
	return
}
...
// path parameter.
func (r *BatteryService) Get(ctx context.Context, id string, query BatteryGetParams, opts ...option.RequestOption) (res *BatteryFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *BatteryService) ListAutoPaging(ctx context.Context, query BatteryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[BatteryAbridged] {
...
// hours ago.
func (r *BatteryService) Tuple(ctx context.Context, query BatteryTupleParams, opts ...option.RequestOption) (res *[]BatteryFull, err error) {
	opts = append(r.Options[:], opts...)
...
type BatteryAbridged struct {
	...
	DataMode BatteryAbridgedDataMode `json:"dataMode,required"`
	// Battery name.
...
func (r BatteryAbridged) RawJSON() string { return r.JSON.raw }
func (r *BatteryAbridged) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type BatteryAbridgedDataMode string

const (
	BatteryAbridgedDataModeReal      BatteryAbridgedDataMode = "REAL"
	BatteryAbridgedDataModeTest      BatteryAbridgedDataMode = "TEST"
	BatteryAbridgedDataModeSimulated BatteryAbridgedDataMode = "SIMULATED"
	BatteryAbridgedDataModeExercise  BatteryAbridgedDataMode = "EXERCISE"
)
...
type BatteryQueryhelpResponse struct {
	AodrSupported         bool                                `json:"aodrSupported"`
	ClassificationMarking string                              `json:"classificationMarking"`
	Description           string                              `json:"description"`
	HistorySupported      bool                                `json:"historySupported"`
	Name                  string                              `json:"name"`
	Parameters            []BatteryQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r BatteryQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *BatteryQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type BatteryQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r BatteryQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *BatteryQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type BatteryNewParams struct {
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	// EXERCISE:&nbsp;Data pertaining to a government or military exercise. The data
	// may include both real and simulated data.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatteryNewParamsDataMode `json:"dataMode,omitzero,required"`
	// Battery name.
	Name string `json:"name,required"`
	// Source of the data.
	Source string `json:"source,required"`
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type BatteryNewParamsDataMode string

const (
	BatteryNewParamsDataModeReal      BatteryNewParamsDataMode = "REAL"
	BatteryNewParamsDataModeTest      BatteryNewParamsDataMode = "TEST"
	BatteryNewParamsDataModeSimulated BatteryNewParamsDataMode = "SIMULATED"
	BatteryNewParamsDataModeExercise  BatteryNewParamsDataMode = "EXERCISE"
)
...
type BatteryUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BatteryUpdateParamsDataMode `json:"dataMode,omitzero,required"`
	// Battery name.
	Name string `json:"name,required"`
	// Source of the data.
	Source string `json:"source,required"`
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type BatteryUpdateParamsDataMode string

const (
	BatteryUpdateParamsDataModeReal      BatteryUpdateParamsDataMode = "REAL"
	BatteryUpdateParamsDataModeTest      BatteryUpdateParamsDataMode = "TEST"
	BatteryUpdateParamsDataModeSimulated BatteryUpdateParamsDataMode = "SIMULATED"
	BatteryUpdateParamsDataModeExercise  BatteryUpdateParamsDataMode = "EXERCISE"
)
...
type BatteryCountParams struct {
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
...
type BatteryTupleParams struct {
