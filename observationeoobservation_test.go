...
func TestObservationEoObservationNewWithOptionalParams(t *testing.T) {
	...
	err := client.Observations.EoObservations.New(context.TODO(), unifieddatalibrary.ObservationEoObservationNewParams{
		...
		Declination:           unifieddatalibrary.Float(-17.3053),
		...
		DeclinationUnc:        unifieddatalibrary.Float(0.000015),
		...
		EoobservationDetails: unifieddatalibrary.ObservationEoObservationNewParamsEoobservationDetails{
			...
			ImageBoreRaDec:                       []float64{74.2, -0.83},
			ImageBoreVector:                      []float64{0.272, 0.962, -0.014},
			ImageCorners:                         [][]float64{{75.2, -0.186}, {73.4, -0.0114}, {75.1, -1.65}, {73.3, -1.47}},
			ImageFovHeight:                       unifieddatalibrary.Float(1.47),
			ImageFovWidth:                        unifieddatalibrary.Float(1.83),
			ImageHorizVector:                     []float64{0.958, -0.269, 0.095},
			ImageVertVector:                      []float64{0.088, -0.039, -0.995},
			...
			SolarDiskFrac:                        unifieddatalibrary.Float(0.5),
		...
		Ra:                   unifieddatalibrary.Float(23.4025),
		...
		RaUnc:                unifieddatalibrary.Float(0.000015),
		...
		Senalt:               unifieddatalibrary.Float(0.7539),
