...
type RfBandListResponse struct {
	...
	DataMode RfBandListResponseDataMode `json:"dataMode" api:"required"`
...
type RfBandNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfBandNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent Entity which uses this band.
	IDEntity string `json:"idEntity" api:"required"`
	// RF Band name.
	Name string `json:"name" api:"required"`
...
type RfBandUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfBandUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique identifier of the parent Entity which uses this band.
	IDEntity string `json:"idEntity" api:"required"`
	// RF Band name.
	Name string `json:"name" api:"required"`
