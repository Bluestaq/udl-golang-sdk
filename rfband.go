...
type RfBandQueryhelpResponse struct {
	...
	Parameters            []RfBandQueryhelpResponseParameter `json:"parameters"`
...
type RfBandQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r RfBandQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *RfBandQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
