...
type FeatureAssessmentHistoryListResponse struct {
	...
	DataMode FeatureAssessmentHistoryListResponseDataMode `json:"dataMode" api:"required"`
	// Datetime type value associated with this record, in ISO 8601 UTC format with
	// millisecond precision.
	FeatureTs time.Time `json:"featureTs" api:"required" format:"date-time"`
	...
	FeatureUoM string `json:"featureUoM" api:"required"`
	// Unique identifier of the Analytic Imagery associated with this Feature
	// Assessment record.
	IDAnalyticImagery string `json:"idAnalyticImagery" api:"required"`
	// Source of the data.
...
type FeatureAssessmentHistoryListParams struct {
	// Unique identifier of the Analytic Imagery associated with this Feature
	// Assessment record.
	IDAnalyticImagery string `query:"idAnalyticImagery" api:"required" json:"-"`
