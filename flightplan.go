...
type FlightplanQueryhelpResponse struct {
	...
	Parameters            []FlightplanQueryhelpResponseParameter `json:"parameters"`
...
type FlightplanQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r FlightplanQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *FlightplanQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
