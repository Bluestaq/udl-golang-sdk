...
type FlightPlanAbridged struct {
	...
	ArrAirfield string `json:"arrAirfield" api:"required"`
	...
	DataMode FlightPlanAbridgedDataMode `json:"dataMode" api:"required"`
	// The airfield identifier of the departure location, International Civil Aviation
	// Organization (ICAO) code preferred.
	DepAirfield string `json:"depAirfield" api:"required"`
	// The generation time of this flight plan in ISO 8601 UTC format, with millisecond
	// precision.
	GenTs time.Time `json:"genTS" api:"required" format:"date-time"`
	// Source of the data.
...
type FlightPlanAbridgedFlightPlanWaypoint struct {
	...
	WaypointName string `json:"waypointName" api:"required"`
...
type FlightplanNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode FlightplanNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The airfield identifier of the departure location, International Civil Aviation
	// Organization (ICAO) code preferred.
	DepAirfield string `json:"depAirfield" api:"required"`
	// The generation time of this flight plan in ISO 8601 UTC format, with millisecond
...
type FlightplanUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode FlightplanUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The airfield identifier of the departure location, International Civil Aviation
	// Organization (ICAO) code preferred.
	DepAirfield string `json:"depAirfield" api:"required"`
	// The generation time of this flight plan in ISO 8601 UTC format, with millisecond
