...
type SiteRemarkQueryhelpResponse struct {
	...
	Name                  string                                 `json:"name"`
	Parameters            []SiteRemarkQueryhelpResponseParameter `json:"parameters"`
...
type SiteRemarkQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SiteRemarkQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SiteRemarkQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
