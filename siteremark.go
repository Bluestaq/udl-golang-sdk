...
type SiteRemarkListResponse struct {
	...
	DataMode SiteRemarkListResponseDataMode `json:"dataMode" api:"required"`
...
type SiteRemarkGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SiteRemarkGetResponseDataMode `json:"dataMode" api:"required"`
	// The ID of the site to which this remark applies.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SiteRemarkTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SiteRemarkTupleResponseDataMode `json:"dataMode" api:"required"`
	// The ID of the site to which this remark applies.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type SiteRemarkNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SiteRemarkNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// The ID of the site to which this remark applies.
	IDSite string `json:"idSite" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
