...
type LinkStatusGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LinkStatusGetResponseDataMode `json:"dataMode" api:"required"`
	// Latitude of link endpoint-1, WGS-84 in degrees. -90 to 90 degrees (negative
	// values south of equator).
	EndPoint1Lat float64 `json:"endPoint1Lat" api:"required"`
	// Longitude of link endpoint-1, WGS-84 longitude in degrees. -180 to 180 degrees
...
type LinkStatusQueryhelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r LinkStatusQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *LinkStatusQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type LinkStatusTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LinkStatusTupleResponseDataMode `json:"dataMode" api:"required"`
	// Latitude of link endpoint-1, WGS-84 in degrees. -90 to 90 degrees (negative
	// values south of equator).
	EndPoint1Lat float64 `json:"endPoint1Lat" api:"required"`
	// Longitude of link endpoint-1, WGS-84 longitude in degrees. -180 to 180 degrees
...
type LinkStatusNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LinkStatusNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Latitude of link endpoint-1, WGS-84 in degrees. -90 to 90 degrees (negative
	// values south of equator).
	EndPoint1Lat float64 `json:"endPoint1Lat" api:"required"`
	// Longitude of link endpoint-1, WGS-84 longitude in degrees. -180 to 180 degrees
