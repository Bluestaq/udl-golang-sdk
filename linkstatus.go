...
type LinkStatusQueryhelpResponse struct {
	...
	Parameters            []LinkStatusQueryhelpResponseParameter `json:"parameters"`
...
type LinkStatusQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r LinkStatusQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *LinkStatusQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
