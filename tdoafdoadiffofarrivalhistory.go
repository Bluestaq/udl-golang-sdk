...
// the [NewTdoaFdoaDiffofarrivalHistoryService] method instead.
type TdoaFdoaDiffofarrivalHistoryService struct {
	Options []option.RequestOption
}

// NewTdoaFdoaDiffofarrivalHistoryService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewTdoaFdoaDiffofarrivalHistoryService(opts ...option.RequestOption) (r TdoaFdoaDiffofarrivalHistoryService) {
	r = TdoaFdoaDiffofarrivalHistoryService{}
	r.Options = opts
	return
}
...
func (r *TdoaFdoaDiffofarrivalHistoryService) List(ctx context.Context, query TdoaFdoaDiffofarrivalHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[DiffofarrivalFull], err error) {
	...
	path := "udl/diffofarrival/history"
...
// as `url.Values`.
func (r TdoaFdoaDiffofarrivalHistoryAodrParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
