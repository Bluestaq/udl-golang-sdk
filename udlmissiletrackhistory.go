...
// UdlMissiletrackHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlMissiletrackHistoryService] method instead.
type UdlMissiletrackHistoryService struct {
	Options []option.RequestOption
}

// NewUdlMissiletrackHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlMissiletrackHistoryService(opts ...option.RequestOption) (r UdlMissiletrackHistoryService) {
	r = UdlMissiletrackHistoryService{}
	r.Options = opts
	return
}
...
type MissileTrackFull struct {
	...
	DataMode MissileTrackFullDataMode `json:"dataMode,required"`
	// Source of the data.
	...
	Env MissileTrackFullEnv `json:"env"`
	// Three element array representing an Area of Uncertainty (AoU). The array element
	// definitions and units are type specific depending on the aouType specified in
	// this record:
	//
	...
	// "UNKNOWN".
	ObjIdent MissileTrackFullObjIdent `json:"objIdent"`
	...
	Vectors []MissileTrackFullVector `json:"vectors"`
...
func (r MissileTrackFull) RawJSON() string { return r.JSON.raw }
func (r *MissileTrackFull) UnmarshalJSON(data []byte) error {
...
type MissileTrackFullVector struct {
...
// Returns the unmodified JSON received from the API
func (r MissileTrackFullVector) RawJSON() string { return r.JSON.raw }
func (r *MissileTrackFullVector) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
