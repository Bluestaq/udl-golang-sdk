...
type GlobalAtmosphericModelQueryHelpResponse struct {
	...
	Parameters            []GlobalAtmosphericModelQueryHelpResponseParameter `json:"parameters"`
...
type GlobalAtmosphericModelQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r GlobalAtmosphericModelQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *GlobalAtmosphericModelQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
