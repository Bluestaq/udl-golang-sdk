...
type GlobalAtmosphericModelGetResponse struct {
	...
	DataMode GlobalAtmosphericModelGetResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type GlobalAtmosphericModelListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode GlobalAtmosphericModelListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Target time of the model in ISO 8601 UTC format with millisecond precision.
	Ts time.Time `json:"ts" api:"required" format:"date-time"`
...
type GlobalAtmosphericModelTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode GlobalAtmosphericModelTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Target time of the model in ISO 8601 UTC format with millisecond precision.
	Ts time.Time `json:"ts" api:"required" format:"date-time"`
...
type GlobalAtmosphericModelUnvalidatedPublishParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode GlobalAtmosphericModelUnvalidatedPublishParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Target time of the model in ISO 8601 UTC format with millisecond precision.
	Ts time.Time `json:"ts" api:"required" format:"date-time"`
