...
func (r *OrbitdeterminationService) Get(ctx context.Context, id string, query OrbitdeterminationGetParams, opts ...option.RequestOption) (res *OrbitdeterminationFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
// hours ago.
func (r *OrbitdeterminationService) Tuple(ctx context.Context, query OrbitdeterminationTupleParams, opts ...option.RequestOption) (res *[]OrbitdeterminationFull, err error) {
	opts = append(r.Options[:], opts...)
