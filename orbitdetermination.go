...
type OrbitdeterminationListResponse struct {
	...
	DataMode OrbitdeterminationListResponseDataMode `json:"dataMode" api:"required"`
...
type OrbitdeterminationGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrbitdeterminationGetResponseDataMode `json:"dataMode" api:"required"`
	// End time for OD solution in ISO 8601 UTC datetime format, with microsecond
	// precision.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// Flag indicating whether this is an initial orbit determination.
...
type OrbitdeterminationTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrbitdeterminationTupleResponseDataMode `json:"dataMode" api:"required"`
	// End time for OD solution in ISO 8601 UTC datetime format, with microsecond
	// precision.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// Flag indicating whether this is an initial orbit determination.
...
type OrbitdeterminationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OrbitdeterminationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// End time for OD solution in ISO 8601 UTC datetime format, with microsecond
	// precision.
	EndTime time.Time `json:"endTime" api:"required" format:"date-time"`
	// Flag indicating whether this is an initial orbit determination.
