...
type ObjectOfInterestListResponse struct {
	...
	DataMode ObjectOfInterestListResponseDataMode `json:"dataMode" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Sensor tasking start time for object of interest.
	SensorTaskingStartTime time.Time `json:"sensorTaskingStartTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Time of last status change of the object of interest event.
	StatusDate time.Time `json:"statusDate" api:"required" format:"date-time"`
...
type ObjectOfInterestGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObjectOfInterestGetResponseDataMode `json:"dataMode" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Sensor tasking start time for object of interest.
	SensorTaskingStartTime time.Time `json:"sensorTaskingStartTime" api:"required" format:"date-time"`
...
type ObjectOfInterestGetResponseManifold struct {
	...
	IDObjectOfInterest string `json:"idObjectOfInterest" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type ObjectOfInterestTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObjectOfInterestTupleResponseDataMode `json:"dataMode" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Sensor tasking start time for object of interest.
	SensorTaskingStartTime time.Time `json:"sensorTaskingStartTime" api:"required" format:"date-time"`
...
type ObjectOfInterestNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObjectOfInterestNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Sensor tasking start time for object of interest.
	SensorTaskingStartTime time.Time `json:"sensorTaskingStartTime" api:"required" format:"date-time"`
...
type ObjectOfInterestUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ObjectOfInterestUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// UUID of the parent Onorbit record.
	IDOnOrbit string `json:"idOnOrbit" api:"required"`
	// Sensor tasking start time for object of interest.
	SensorTaskingStartTime time.Time `json:"sensorTaskingStartTime" api:"required" format:"date-time"`
