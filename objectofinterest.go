...
type ObjectOfInterestQueryhelpResponse struct {
	...
	Name                  string                                       `json:"name"`
	Parameters            []ObjectOfInterestQueryhelpResponseParameter `json:"parameters"`
...
type ObjectOfInterestQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ObjectOfInterestQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ObjectOfInterestQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
