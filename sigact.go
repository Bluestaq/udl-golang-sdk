...
func (r *SigactService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// hours ago.
func (r *SigactService) Tuple(ctx context.Context, query SigactTupleParams, opts ...option.RequestOption) (res *[]SigactFull, err error) {
	opts = append(r.Options[:], opts...)
