...
type StatusQueryhelpResponse struct {
	...
	Parameters            []StatusQueryhelpResponseParameter `json:"parameters"`
...
type StatusQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r StatusQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *StatusQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
