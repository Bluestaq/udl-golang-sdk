...
type CountryQueryhelpResponse struct {
	...
	Name                  string                              `json:"name"`
	Parameters            []CountryQueryhelpResponseParameter `json:"parameters"`
...
type CountryQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r CountryQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *CountryQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
