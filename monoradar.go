...
// MonoradarService contains methods and other services that help with interacting
// with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewMonoradarService] method instead.
type MonoradarService struct {
	Options []option.RequestOption
}

// NewMonoradarService generates a new service that applies the given options to
// each request. These options are applied after the parent client's options (if
// there is one), and before any request-specific options.
func NewMonoradarService(opts ...option.RequestOption) (r MonoradarService) {
	r = MonoradarService{}
	r.Options = opts
	return
}
...
func (r *MonoradarService) List(ctx context.Context, query MonoradarListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[MonoradarListResponse], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *MonoradarService) ListAutoPaging(ctx context.Context, query MonoradarListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[MonoradarListResponse] {
...
func (r *MonoradarService) Count(ctx context.Context, query MonoradarCountParams, opts ...option.RequestOption) (res *string, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *MonoradarService) NewBulk(ctx context.Context, body MonoradarNewBulkParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
...
func (r *MonoradarService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// hours ago.
func (r *MonoradarService) Tuple(ctx context.Context, query MonoradarTupleParams, opts ...option.RequestOption) (res *[]MonoRadarFull, err error) {
	opts = append(r.Options[:], opts...)
...
// generate the record.
type MonoradarListResponse struct {
	...
	DataMode MonoradarListResponseDataMode `json:"dataMode,required"`
...
func (r MonoradarListResponse) RawJSON() string { return r.JSON.raw }
func (r *MonoradarListResponse) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type MonoradarListResponseDataMode string

const (
	MonoradarListResponseDataModeReal      MonoradarListResponseDataMode = "REAL"
	MonoradarListResponseDataModeTest      MonoradarListResponseDataMode = "TEST"
	MonoradarListResponseDataModeSimulated MonoradarListResponseDataMode = "SIMULATED"
	MonoradarListResponseDataModeExercise  MonoradarListResponseDataMode = "EXERCISE"
)

type MonoradarListParams struct {
	// Target detection time, in ISO 8601 UTC format with microsecond precision.
...
func (f MonoradarListParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [MonoradarListParams]'s query parameters as `url.Values`.
func (r MonoradarListParams) URLQuery() (v url.Values, err error) {
...
type MonoradarCountParams struct {
	// Target detection time, in ISO 8601 UTC format with microsecond precision.
	// (YYYY-MM-DDTHH:MM:SS.ssssssZ)
	Ts          time.Time        `query:"ts,required" format:"date-time" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f MonoradarCountParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [MonoradarCountParams]'s query parameters as `url.Values`.
func (r MonoradarCountParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type MonoradarNewBulkParams struct {
	Body []MonoradarNewBulkParamsBody
	paramObj
}

// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f MonoradarNewBulkParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

func (r MonoradarNewBulkParams) MarshalJSON() (data []byte, err error) {
...
// Ts are required.
type MonoradarNewBulkParamsBody struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f MonoradarNewBulkParamsBody) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }
func (r MonoradarNewBulkParamsBody) MarshalJSON() (data []byte, err error) {
	type shadow MonoradarNewBulkParamsBody
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[MonoradarNewBulkParamsBody](
		"DataMode", false, "REAL", "TEST", "SIMULATED", "EXERCISE",
	)
}

type MonoradarTupleParams struct {
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f MonoradarTupleParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [MonoradarTupleParams]'s query parameters as `url.Values`.
func (r MonoradarTupleParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
