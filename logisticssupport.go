...
type LogisticsDiscrepancyInfosFull struct {
...
func (r LogisticsDiscrepancyInfosFull) RawJSON() string { return r.JSON.raw }
func (r *LogisticsDiscrepancyInfosFull) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The parts associated with this support item.
type LogisticsPartsFull struct {
	...
	LogisticsStocks []LogisticsStocksFull `json:"logisticsStocks"`
...
// Returns the unmodified JSON received from the API
func (r LogisticsPartsFull) RawJSON() string { return r.JSON.raw }
func (r *LogisticsPartsFull) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Remarks associated with this LogisticsSupport record.
type LogisticsRemarksAbridged struct {
...
// Returns the unmodified JSON received from the API
func (r LogisticsRemarksAbridged) RawJSON() string { return r.JSON.raw }
func (r *LogisticsRemarksAbridged) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Remarks associated with this LogisticsSupport record.
type LogisticsSegmentsFull struct {
...
// Returns the unmodified JSON received from the API
func (r LogisticsSegmentsFull) RawJSON() string { return r.JSON.raw }
func (r *LogisticsSegmentsFull) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The specialties required to implement this support item.
type LogisticsSpecialtiesFull struct {
...
// Returns the unmodified JSON received from the API
func (r LogisticsSpecialtiesFull) RawJSON() string { return r.JSON.raw }
func (r *LogisticsSpecialtiesFull) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The supply stocks for this support item.
type LogisticsStocksFull struct {
...
// Returns the unmodified JSON received from the API
func (r LogisticsStocksFull) RawJSON() string { return r.JSON.raw }
func (r *LogisticsStocksFull) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Support items associated with this LogisticsSupport record.
type LogisticsSupportItemsFull struct {
	...
	// The parts associated with this support item.
	LogisticsParts []LogisticsPartsFull `json:"logisticsParts"`
	// Remarks associated with this support item.
	LogisticsRemarks []LogisticsRemarksFull `json:"logisticsRemarks"`
	// The specialties required to implement this support item.
	LogisticsSpecialties []LogisticsSpecialtiesFull `json:"logisticsSpecialties"`
...
// Returns the unmodified JSON received from the API
func (r LogisticsSupportItemsFull) RawJSON() string { return r.JSON.raw }
func (r *LogisticsSupportItemsFull) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// Transportation plans associated with this LogisticsSupport record, used to
// coordinate maintenance efforts.
type LogisticsTransportationPlansFull struct {
	...
	LogisticsSegments []LogisticsSegmentsFull `json:"logisticsSegments"`
...
// Returns the unmodified JSON received from the API
func (r LogisticsTransportationPlansFull) RawJSON() string { return r.JSON.raw }
func (r *LogisticsTransportationPlansFull) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type LogisticsSupportListResponse struct {
	...
	// Remarks associated with this LogisticsSupport record.
	LogisticsRemarks []LogisticsRemarksAbridged `json:"logisticsRemarks"`
	// Support items associated with this LogisticsSupport record.
...
type LogisticsSupportListResponseLogisticsTransportationPlan struct {
	...
	// Remarks associated with this transportation plan.
	LogisticsTransportationPlansRemarks []LogisticsRemarksAbridged `json:"logisticsTransportationPlansRemarks"`
	// The major command for the current unit.
	Majcom string `json:"majcom"`
	// Indicates whether there have been changes to changes to ICAOs, estArrTime, or
	// estDepTime since this Transportation Plan was last edited.
