...
type SortiePprQueryhelpResponse struct {
	...
	Parameters            []SortiePprQueryhelpResponseParameter `json:"parameters"`
...
type SortiePprQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SortiePprQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SortiePprQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
