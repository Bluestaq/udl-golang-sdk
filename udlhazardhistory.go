...
// UdlHazardHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlHazardHistoryService] method instead.
type UdlHazardHistoryService struct {
	Options []option.RequestOption
}

// NewUdlHazardHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlHazardHistoryService(opts ...option.RequestOption) (r UdlHazardHistoryService) {
	r = UdlHazardHistoryService{}
	r.Options = opts
	return
}
...
type HazardFull struct {
	...
	DataMode HazardFullDataMode `json:"dataMode,required"`
...
func (r HazardFull) RawJSON() string { return r.JSON.raw }
func (r *HazardFull) UnmarshalJSON(data []byte) error {
