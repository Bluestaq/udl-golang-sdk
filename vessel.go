...
type VesselQueryhelpResponse struct {
	...
	Parameters            []VesselQueryhelpResponseParameter `json:"parameters"`
...
type VesselQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r VesselQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *VesselQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
