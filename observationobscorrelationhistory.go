...
type ObservationObscorrelationHistoryListResponse struct {
	...
	CorrType ObservationObscorrelationHistoryListResponseCorrType `json:"corrType" api:"required"`
	...
	DataMode ObservationObscorrelationHistoryListResponseDataMode `json:"dataMode" api:"required"`
	...
	ObType ObservationObscorrelationHistoryListResponseObType `json:"obType" api:"required"`
	...
	ReferenceOrbitType ObservationObscorrelationHistoryListResponseReferenceOrbitType `json:"referenceOrbitType" api:"required"`
	// Source of the data.
