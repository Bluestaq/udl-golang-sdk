...
type EvacQueryHelpResponse struct {
	...
	Name                  string                           `json:"name"`
	Parameters            []EvacQueryHelpResponseParameter `json:"parameters"`
...
type EvacQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r EvacQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *EvacQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
