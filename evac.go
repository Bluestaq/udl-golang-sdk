...
type EvacQueryHelpResponse struct {
...
// Returns the unmodified JSON received from the API
func (r EvacQueryHelpResponse) RawJSON() string { return r.JSON.raw }
func (r *EvacQueryHelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type EvacNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EvacNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// WGS-84 latitude of the pickup location, in degrees. -90 to 90 degrees (negative
	// values south of equator).
	PickupLat float64 `json:"pickupLat" api:"required"`
	// WGS-84 longitude of the pickup location, in degrees. -180 to 180 degrees
	...
	//
	// Any of "REQUEST", "RESPONSE".
	Type EvacNewParamsType `json:"type,omitzero" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
