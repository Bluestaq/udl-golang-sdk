...
func TestAirOperationAirspaceControlOrderUnvalidatedPublish(t *testing.T) {
	...
	err := client.AirOperations.AirspaceControlOrders.UnvalidatedPublish(context.TODO(), unifieddatalibrary.AirOperationAirspaceControlOrderUnvalidatedPublishParams{
		Body: []unifieddatalibrary.AirOperationAirspaceControlOrderUnvalidatedPublishParamsBody{{
			...
			AirspaceControlMeansStatus: []unifieddatalibrary.AirOperationAirspaceControlOrderUnvalidatedPublishParamsBodyAirspaceControlMeansStatus{{
				AirspaceControlMeans: []unifieddatalibrary.AirOperationAirspaceControlOrderUnvalidatedPublishParamsBodyAirspaceControlMeansStatusAirspaceControlMean{{
					AirspaceControlPoint: []unifieddatalibrary.AirOperationAirspaceControlOrderUnvalidatedPublishParamsBodyAirspaceControlMeansStatusAirspaceControlMeanAirspaceControlPoint{{
					...
					AirspaceTimePeriod: []unifieddatalibrary.AirOperationAirspaceControlOrderUnvalidatedPublishParamsBodyAirspaceControlMeansStatusAirspaceControlMeanAirspaceTimePeriod{{
						IntDur:    []string{"65WK"},
			...
			AirspaceControlOrderReferences: []unifieddatalibrary.AirOperationAirspaceControlOrderUnvalidatedPublishParamsBodyAirspaceControlOrderReference{{
