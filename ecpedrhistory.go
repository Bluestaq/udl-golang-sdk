...
type EcpedrHistoryListResponse struct {
	...
	DataMode EcpedrHistoryListResponseDataMode `json:"dataMode" api:"required"`
	// Collection of measurements associated with this ECP EDR record.
	EcpedrMeasurements []EcpedrHistoryListResponseEcpedrMeasurement `json:"ecpedrMeasurements" api:"required"`
