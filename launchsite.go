...
type LaunchSiteQueryhelpResponse struct {
	...
	Parameters            []LaunchSiteQueryhelpResponseParameter `json:"parameters"`
...
type LaunchSiteQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r LaunchSiteQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *LaunchSiteQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
