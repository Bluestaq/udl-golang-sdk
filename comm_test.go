...
func TestCommNewWithOptionalParams(t *testing.T) {
	...
	err := client.Comm.New(context.TODO(), unifieddatalibrary.CommNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.CommNewParamsDataModeTest,
		Name:                  "DSCS II C-7-COMM Payload",
		Source:                "Bluestaq",
		ID:                    unifieddatalibrary.String("COMM-ID"),
		Description:           unifieddatalibrary.String("Description for comm A"),
...
func TestCommGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Comm.Get(
		context.TODO(),
		"id",
		unifieddatalibrary.CommGetParams{
...
func TestCommUpdateWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Comm.Update(
		context.TODO(),
		"id",
		unifieddatalibrary.CommUpdateParams{
			CommAbridged: unifieddatalibrary.CommAbridgedParam{
				ClassificationMarking: "U",
				DataMode:              unifieddatalibrary.CommAbridgedDataModeTest,
				Name:                  "DSCS II C-7-COMM Payload",
				Source:                "Bluestaq",
				ID:                    unifieddatalibrary.String("COMM-ID"),
				Description:           unifieddatalibrary.String("Description for comm A"),
...
func TestCommListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Comm.List(context.TODO(), unifieddatalibrary.CommListParams{
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
	if err != nil {
...
func TestCommDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Comm.Delete(context.TODO(), "id")
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestCommCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Comm.Count(context.TODO(), unifieddatalibrary.CommCountParams{
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
	if err != nil {
...
func TestCommQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Comm.Queryhelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestCommTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Comm.Tuple(context.TODO(), unifieddatalibrary.CommTupleParams{
		Columns:     "columns",
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
