...
type RouteStatQueryHelpResponse struct {
	...
	Parameters            []RouteStatQueryHelpResponseParameter `json:"parameters"`
...
type RouteStatQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r RouteStatQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *RouteStatQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
