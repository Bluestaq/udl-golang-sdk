...
type RouteStatGetResponse struct {
	...
	DataMode RouteStatGetResponseDataMode `json:"dataMode" api:"required"`
	// End location of the vehicle.
	LocationEnd string `json:"locationEnd" api:"required"`
	// Starting location of the vehicle.
	LocationStart string `json:"locationStart" api:"required"`
	// Source of the data.
...
type RouteStatListResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RouteStatListResponseDataMode `json:"dataMode" api:"required"`
	// End location of the vehicle.
	LocationEnd string `json:"locationEnd" api:"required"`
	// Starting location of the vehicle.
	LocationStart string `json:"locationStart" api:"required"`
...
// Returns the unmodified JSON received from the API
func (r RouteStatQueryHelpResponse) RawJSON() string { return r.JSON.raw }
func (r *RouteStatQueryHelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type RouteStatTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RouteStatTupleResponseDataMode `json:"dataMode" api:"required"`
	// End location of the vehicle.
	LocationEnd string `json:"locationEnd" api:"required"`
	// Starting location of the vehicle.
	LocationStart string `json:"locationStart" api:"required"`
...
type RouteStatNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RouteStatNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// End location of the vehicle.
	LocationEnd string `json:"locationEnd" api:"required"`
	// Starting location of the vehicle.
	LocationStart string `json:"locationStart" api:"required"`
...
type RouteStatUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RouteStatUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// End location of the vehicle.
	LocationEnd string `json:"locationEnd" api:"required"`
	// Starting location of the vehicle.
	LocationStart string `json:"locationStart" api:"required"`
