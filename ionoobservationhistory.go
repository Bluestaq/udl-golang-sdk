...
type IonoObservationHistoryListResponse struct {
	...
	DataMode IonoObservationHistoryListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Sounding Start time in ISO8601 UTC format.
	StartTimeUtc time.Time `json:"startTimeUTC" api:"required" format:"date-time"`
	// URSI code for station or stations producing the ionosonde.
	StationID string `json:"stationId" api:"required"`
	// Ionosonde hardware type or data collection type together with possible
	// additional descriptors.
	System string `json:"system" api:"required"`
	// Names of settings.
	SystemInfo string `json:"systemInfo" api:"required"`
...
type IonoObservationHistoryListParams struct {
	...
	StartTimeUtc time.Time `query:"startTimeUTC" api:"required" format:"date-time" json:"-"`
