...
func (r *IonoObservationHistoryService) List(ctx context.Context, query IonoObservationHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[IonoObservationFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *IonoObservationHistoryService) ListAutoPaging(ctx context.Context, query IonoObservationHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[IonoObservationFull] {
