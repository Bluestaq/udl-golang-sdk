...
type EcpedrListResponse struct {
	...
	DataMode EcpedrListResponseDataMode `json:"dataMode" api:"required"`
	// Collection of measurements associated with this ECP EDR record.
	EcpedrMeasurements []EcpedrListResponseEcpedrMeasurement `json:"ecpedrMeasurements" api:"required"`
...
type EcpedrListResponseEcpedrMeasurement struct {
	...
	ObType string `json:"obType" api:"required"`
	...
	ObUoM string `json:"obUoM" api:"required"`
...
type EcpedrTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EcpedrTupleResponseDataMode `json:"dataMode" api:"required"`
	// Collection of measurements associated with this ECP EDR record.
	EcpedrMeasurements []EcpedrTupleResponseEcpedrMeasurement `json:"ecpedrMeasurements" api:"required"`
	// Time of the observation, in ISO 8601 UTC format with microsecond precision.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EcpedrNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EcpedrNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Collection of measurements associated with this ECP EDR record.
	EcpedrMeasurements []EcpedrNewParamsEcpedrMeasurement `json:"ecpedrMeasurements,omitzero" api:"required"`
	// Time of the observation, in ISO 8601 UTC format with microsecond precision.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EcpedrNewBulkParamsBody struct {
	...
	// Collection of measurements associated with this ECP EDR record.
	EcpedrMeasurements []EcpedrNewBulkParamsBodyEcpedrMeasurement `json:"ecpedrMeasurements,omitzero" api:"required"`
	// Time of the observation, in ISO 8601 UTC format with microsecond precision.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type EcpedrUnvalidatedPublishParamsBody struct {
	...
	DataMode string `json:"dataMode,omitzero" api:"required"`
	// Collection of measurements associated with this ECP EDR record.
	EcpedrMeasurements []EcpedrUnvalidatedPublishParamsBodyEcpedrMeasurement `json:"ecpedrMeasurements,omitzero" api:"required"`
	// Time of the observation, in ISO 8601 UTC format with microsecond precision.
	ObTime time.Time `json:"obTime" api:"required" format:"date-time"`
	// Source of the data.
	Source string `json:"source" api:"required"`
