...
func TestAirloadPlanNewWithOptionalParams(t *testing.T) {
	...
	err := client.AirloadPlans.New(context.TODO(), unifieddatalibrary.AirloadPlanNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.AirloadPlanNewParamsDataModeTest,
		EstDepTime:            time.Now(),
		Source:                "source",
		...
		AirLoadPlanHazmatActuals: []unifieddatalibrary.AirloadPlanNewParamsAirLoadPlanHazmatActual{{
		...
		AirLoadPlanHr: []unifieddatalibrary.AirloadPlanNewParamsAirLoadPlanHr{{
		...
		AirLoadPlanPalletDetails: []unifieddatalibrary.AirloadPlanNewParamsAirLoadPlanPalletDetail{{
		...
		AirLoadPlanPaxCargo: []unifieddatalibrary.AirloadPlanNewParamsAirLoadPlanPaxCargo{{
		...
		AirLoadPlanUlnActuals: []unifieddatalibrary.AirloadPlanNewParamsAirLoadPlanUlnActual{{
...
func TestAirloadPlanGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AirloadPlans.Get(
		context.TODO(),
		"id",
		unifieddatalibrary.AirloadPlanGetParams{
...
func TestAirloadPlanListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AirloadPlans.List(context.TODO(), unifieddatalibrary.AirloadPlanListParams{
		EstDepTime:  time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestAirloadPlanCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AirloadPlans.Count(context.TODO(), unifieddatalibrary.AirloadPlanCountParams{
		EstDepTime:  time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
	})
...
func TestAirloadPlanQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AirloadPlans.Queryhelp(context.TODO())
	if err != nil {
		var apierr *unifieddatalibrary.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestAirloadPlanTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AirloadPlans.Tuple(context.TODO(), unifieddatalibrary.AirloadPlanTupleParams{
		Columns:     "columns",
		EstDepTime:  time.Now(),
		FirstResult: unifieddatalibrary.Int(0),
		MaxResults:  unifieddatalibrary.Int(0),
