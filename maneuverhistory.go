...
func (r *ManeuverHistoryService) List(ctx context.Context, query ManeuverHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[ManeuverFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *ManeuverHistoryService) ListAutoPaging(ctx context.Context, query ManeuverHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[ManeuverFull] {
