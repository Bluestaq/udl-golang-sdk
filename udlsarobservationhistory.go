...
// UdlSarobservationHistoryService contains methods and other services that help
// with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlSarobservationHistoryService] method instead.
type UdlSarobservationHistoryService struct {
	Options []option.RequestOption
}

// NewUdlSarobservationHistoryService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewUdlSarobservationHistoryService(opts ...option.RequestOption) (r UdlSarobservationHistoryService) {
	r = UdlSarobservationHistoryService{}
	r.Options = opts
	return
}
...
type SarobservationFull struct {
	...
	DataMode SarobservationFullDataMode `json:"dataMode,required"`
...
func (r SarobservationFull) RawJSON() string { return r.JSON.raw }
func (r *SarobservationFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type SarobservationFullDataMode string

const (
	SarobservationFullDataModeReal      SarobservationFullDataMode = "REAL"
	SarobservationFullDataModeTest      SarobservationFullDataMode = "TEST"
	SarobservationFullDataModeSimulated SarobservationFullDataMode = "SIMULATED"
	SarobservationFullDataModeExercise  SarobservationFullDataMode = "EXERCISE"
)
