...
type LaserdeconflictrequestListResponse struct {
	...
	DataMode LaserdeconflictrequestListResponseDataMode `json:"dataMode" api:"required"`
	...
	IDLaserEmitters []string `json:"idLaserEmitters" api:"required"`
	// The number of targets included in this request.
	NumTargets int64 `json:"numTargets" api:"required"`
	...
	RequestTs time.Time `json:"requestTs" api:"required" format:"date-time"`
	// Source of the data.
...
type LaserdeconflictrequestGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaserdeconflictrequestGetResponseDataMode `json:"dataMode" api:"required"`
	// End date of the time windows associated with this LaserDeconflictRequest, in ISO
	// 8601 UTC format with millisecond precision.
	EndDate time.Time `json:"endDate" api:"required" format:"date-time"`
	// A list containing the id strings of the LaserEmitter records in UDL detailing
...
type LaserdeconflictrequestTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaserdeconflictrequestTupleResponseDataMode `json:"dataMode" api:"required"`
	// End date of the time windows associated with this LaserDeconflictRequest, in ISO
	// 8601 UTC format with millisecond precision.
	EndDate time.Time `json:"endDate" api:"required" format:"date-time"`
	// A list containing the id strings of the LaserEmitter records in UDL detailing
...
type LaserdeconflictrequestNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaserdeconflictrequestNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// End date of the time windows associated with this LaserDeconflictRequest, in ISO
	// 8601 UTC format with millisecond precision.
	EndDate time.Time `json:"endDate" api:"required" format:"date-time"`
	// A list containing the id strings of the LaserEmitter records in UDL detailing
	...
	// creating a LaserDeconflictRequest. Users should create new LaserEmitter records
	// for non-existent emitters and update existing records for any modifications.
	IDLaserEmitters []string `json:"idLaserEmitters,omitzero" api:"required"`
	// The number of targets included in this request.
	NumTargets int64 `json:"numTargets" api:"required"`
	// External identifier for this LaserDeconflictRequest record.
	RequestID string `json:"requestId" api:"required"`
...
type LaserdeconflictrequestUnvalidatedPublishParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode LaserdeconflictrequestUnvalidatedPublishParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// End date of the time windows associated with this LaserDeconflictRequest, in ISO
	// 8601 UTC format with millisecond precision.
	EndDate time.Time `json:"endDate" api:"required" format:"date-time"`
	// A list containing the id strings of the LaserEmitter records in UDL detailing
