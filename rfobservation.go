...
// RfobservationService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewRfobservationService] method instead.
type RfobservationService struct {
	Options []option.RequestOption
	History RfobservationHistoryService
}

// NewRfobservationService generates a new service that applies the given options
// to each request. These options are applied after the parent client's options (if
// there is one), and before any request-specific options.
func NewRfobservationService(opts ...option.RequestOption) (r RfobservationService) {
	r = RfobservationService{}
	r.Options = opts
	r.History = NewRfobservationHistoryService(opts...)
	return
}
...
// mechanism.
func (r *RfobservationService) New(ctx context.Context, body RfobservationNewParams, opts ...option.RequestOption) (err error) {
...
func (r *RfobservationService) List(ctx context.Context, query RfobservationListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[RfobservationListResponse], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *RfobservationService) ListAutoPaging(ctx context.Context, query RfobservationListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[RfobservationListResponse] {
...
func (r *RfobservationService) Count(ctx context.Context, query RfobservationCountParams, opts ...option.RequestOption) (res *string, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *RfobservationService) NewBulk(ctx context.Context, body RfobservationNewBulkParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// path parameter.
func (r *RfobservationService) Get(ctx context.Context, id string, query RfobservationGetParams, opts ...option.RequestOption) (res *RfobservationdetailsFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
func (r *RfobservationService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// hours ago.
func (r *RfobservationService) Tuple(ctx context.Context, query RfobservationTupleParams, opts ...option.RequestOption) (res *[]RfobservationTupleResponse, err error) {
	opts = append(r.Options[:], opts...)
...
func (r *RfobservationService) UnvalidatedPublish(ctx context.Context, body RfobservationUnvalidatedPublishParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// frequencies[0]).
type RfobservationListResponse struct {
	...
	DataMode RfobservationListResponseDataMode `json:"dataMode,required"`
	...
	//
	// Any of "H", "V", "R", "L".
	PolarityType RfobservationListResponsePolarityType `json:"polarityType"`
	...
	JSON struct {
		...
		BaudRate              resp.Field
		BitErrorRate          resp.Field
		CarrierStandard       resp.Field
		Channel               resp.Field
		...
		FrequencyShift        resp.Field
		IDOnOrbit             resp.Field
		IDSensor              resp.Field
		Incoming              resp.Field
		InnerCodingRate       resp.Field
		MaxPsd                resp.Field
		MinPsd                resp.Field
		Modulation            resp.Field
		NoisePwrDensity       resp.Field
		NominalBandwidth      resp.Field
		NominalEirp           resp.Field
		NominalFrequency      resp.Field
		NominalPowerOverNoise resp.Field
		NominalSnr            resp.Field
		Origin                resp.Field
		OrigNetwork           resp.Field
		OrigObjectID          resp.Field
		OrigSensorID          resp.Field
		OuterCodingRate       resp.Field
		Peak                  resp.Field
		Pgri                  resp.Field
		Polarity              resp.Field
		PolarityType          resp.Field
		PowerOverNoise        resp.Field
		Range                 resp.Field
		...
		ReferenceLevel        resp.Field
		RelativeCarrierPower  resp.Field
		RelativeNoiseFloor    resp.Field
		ResolutionBandwidth   resp.Field
		SatNo                 resp.Field
		Senalt                resp.Field
		Senlat                resp.Field
		Senlon                resp.Field
		Snr                   resp.Field
		SourceDl              resp.Field
		SpectrumAnalyzerPower resp.Field
		StartFrequency        resp.Field
		SwitchPoint           resp.Field
		SymbolToNoiseRatio    resp.Field
		TaskID                resp.Field
		TrackID               resp.Field
		TrackRange            resp.Field
		TransactionID         resp.Field
		TransmitFilterRollOff resp.Field
		TransmitFilterType    resp.Field
		Transponder           resp.Field
		Uct                   resp.Field
		URL                   resp.Field
		VideoBandwidth        resp.Field
...
func (r RfobservationListResponse) RawJSON() string { return r.JSON.raw }
func (r *RfobservationListResponse) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type RfobservationListResponseDataMode string

const (
	RfobservationListResponseDataModeReal      RfobservationListResponseDataMode = "REAL"
	RfobservationListResponseDataModeTest      RfobservationListResponseDataMode = "TEST"
	RfobservationListResponseDataModeSimulated RfobservationListResponseDataMode = "SIMULATED"
	RfobservationListResponseDataModeExercise  RfobservationListResponseDataMode = "EXERCISE"
)
...
// R - (Right Hand Circularly Polarized) Rotating right relative to the earth's
// surface.
type RfobservationListResponsePolarityType string

const (
	RfobservationListResponsePolarityTypeH RfobservationListResponsePolarityType = "H"
	RfobservationListResponsePolarityTypeV RfobservationListResponsePolarityType = "V"
	RfobservationListResponsePolarityTypeR RfobservationListResponsePolarityType = "R"
	RfobservationListResponsePolarityTypeL RfobservationListResponsePolarityType = "L"
)
...
// have consistent indexing across arrays (e.g. powers[0] is the measured power at
// frequencies[0]).
type RfobservationTupleResponse struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfobservationTupleResponseDataMode `json:"dataMode,required"`
	// Ob detection time in ISO 8601 UTC with microsecond precision.
	ObTime time.Time `json:"obTime,required" format:"date-time"`
	// Source of the data.
	Source string `json:"source,required"`
	...
	//
	// Any of "H", "V", "R", "L".
	PolarityType RfobservationTupleResponsePolarityType `json:"polarityType"`
	// Measured carrier power over noise (dBW/Hz).
	PowerOverNoise float64 `json:"powerOverNoise"`
	// Target range in km.
	Range float64 `json:"range"`
...
// Returns the unmodified JSON received from the API
func (r RfobservationTupleResponse) RawJSON() string { return r.JSON.raw }
func (r *RfobservationTupleResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type RfobservationTupleResponseDataMode string

const (
	RfobservationTupleResponseDataModeReal      RfobservationTupleResponseDataMode = "REAL"
	RfobservationTupleResponseDataModeTest      RfobservationTupleResponseDataMode = "TEST"
	RfobservationTupleResponseDataModeSimulated RfobservationTupleResponseDataMode = "SIMULATED"
	RfobservationTupleResponseDataModeExercise  RfobservationTupleResponseDataMode = "EXERCISE"
)
...
// R - (Right Hand Circularly Polarized) Rotating right relative to the earth's
// surface.
type RfobservationTupleResponsePolarityType string

const (
	RfobservationTupleResponsePolarityTypeH RfobservationTupleResponsePolarityType = "H"
	RfobservationTupleResponsePolarityTypeV RfobservationTupleResponsePolarityType = "V"
	RfobservationTupleResponsePolarityTypeR RfobservationTupleResponsePolarityType = "R"
	RfobservationTupleResponsePolarityTypeL RfobservationTupleResponsePolarityType = "L"
)

type RfobservationNewParams struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode RfobservationNewParamsDataMode `json:"dataMode,omitzero,required"`
	// Ob detection time in ISO 8601 UTC with microsecond precision.
	ObTime time.Time `json:"obTime,required" format:"date-time"`
	// Source of the data.
	Source string `json:"source,required"`
	...
	//
	// Any of "H", "V", "R", "L".
	PolarityType RfobservationNewParamsPolarityType `json:"polarityType,omitzero"`
...
func (f RfobservationNewParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

func (r RfobservationNewParams) MarshalJSON() (data []byte, err error) {
	type shadow RfobservationNewParams
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type RfobservationNewParamsDataMode string

const (
	RfobservationNewParamsDataModeReal      RfobservationNewParamsDataMode = "REAL"
	RfobservationNewParamsDataModeTest      RfobservationNewParamsDataMode = "TEST"
	RfobservationNewParamsDataModeSimulated RfobservationNewParamsDataMode = "SIMULATED"
	RfobservationNewParamsDataModeExercise  RfobservationNewParamsDataMode = "EXERCISE"
)
...
// R - (Right Hand Circularly Polarized) Rotating right relative to the earth's
// surface.
type RfobservationNewParamsPolarityType string

const (
	RfobservationNewParamsPolarityTypeH RfobservationNewParamsPolarityType = "H"
	RfobservationNewParamsPolarityTypeV RfobservationNewParamsPolarityType = "V"
	RfobservationNewParamsPolarityTypeR RfobservationNewParamsPolarityType = "R"
	RfobservationNewParamsPolarityTypeL RfobservationNewParamsPolarityType = "L"
)

type RfobservationListParams struct {
	// Ob detection time in ISO 8601 UTC with microsecond precision.
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationListParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [RfobservationListParams]'s query parameters as
// `url.Values`.
func (r RfobservationListParams) URLQuery() (v url.Values, err error) {
...
type RfobservationCountParams struct {
	// Ob detection time in ISO 8601 UTC with microsecond precision.
	// (YYYY-MM-DDTHH:MM:SS.ssssssZ)
	ObTime      time.Time        `query:"obTime,required" format:"date-time" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationCountParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [RfobservationCountParams]'s query parameters as
// `url.Values`.
func (r RfobservationCountParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type RfobservationNewBulkParams struct {
	Body []RfobservationNewBulkParamsBody
	paramObj
}

// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationNewBulkParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

func (r RfobservationNewBulkParams) MarshalJSON() (data []byte, err error) {
...
// required.
type RfobservationNewBulkParamsBody struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationNewBulkParamsBody) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }
func (r RfobservationNewBulkParamsBody) MarshalJSON() (data []byte, err error) {
	type shadow RfobservationNewBulkParamsBody
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[RfobservationNewBulkParamsBody](
...
type RfobservationGetParams struct {
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationGetParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [RfobservationGetParams]'s query parameters as `url.Values`.
func (r RfobservationGetParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type RfobservationTupleParams struct {
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationTupleParams) IsPresent() bool { return !param.IsOmitted(f) && !f.IsNull() }

// URLQuery serializes [RfobservationTupleParams]'s query parameters as
// `url.Values`.
func (r RfobservationTupleParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type RfobservationUnvalidatedPublishParams struct {
	Body []RfobservationUnvalidatedPublishParamsBody
	paramObj
}

// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationUnvalidatedPublishParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

func (r RfobservationUnvalidatedPublishParams) MarshalJSON() (data []byte, err error) {
	return json.Marshal(r.Body)
}
...
// The properties ClassificationMarking, DataMode, ObTime, Source, Type are
// required.
type RfobservationUnvalidatedPublishParamsBody struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f RfobservationUnvalidatedPublishParamsBody) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}
func (r RfobservationUnvalidatedPublishParamsBody) MarshalJSON() (data []byte, err error) {
	type shadow RfobservationUnvalidatedPublishParamsBody
	return param.MarshalObject(r, (*shadow)(&r))
}

func init() {
	apijson.RegisterFieldValidator[RfobservationUnvalidatedPublishParamsBody](
		"DataMode", false, "REAL", "TEST", "SIMULATED", "EXERCISE",
	)
	apijson.RegisterFieldValidator[RfobservationUnvalidatedPublishParamsBody](
		"PolarityType", false, "H", "V", "R", "L",
