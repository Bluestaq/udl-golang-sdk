...
// UdlSkyimageryHistoryService contains methods and other services that help with
// interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlSkyimageryHistoryService] method instead.
type UdlSkyimageryHistoryService struct {
	Options []option.RequestOption
}

// NewUdlSkyimageryHistoryService generates a new service that applies the given
// options to each request. These options are applied after the parent client's
// options (if there is one), and before any request-specific options.
func NewUdlSkyimageryHistoryService(opts ...option.RequestOption) (r UdlSkyimageryHistoryService) {
	r = UdlSkyimageryHistoryService{}
	r.Options = opts
	return
}
...
type SkyimageryFull struct {
	...
	DataMode SkyimageryFullDataMode `json:"dataMode,required"`
...
func (r SkyimageryFull) RawJSON() string { return r.JSON.raw }
func (r *SkyimageryFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type SkyimageryFullDataMode string

const (
	SkyimageryFullDataModeReal      SkyimageryFullDataMode = "REAL"
	SkyimageryFullDataModeTest      SkyimageryFullDataMode = "TEST"
	SkyimageryFullDataModeSimulated SkyimageryFullDataMode = "SIMULATED"
	SkyimageryFullDataModeExercise  SkyimageryFullDataMode = "EXERCISE"
)
