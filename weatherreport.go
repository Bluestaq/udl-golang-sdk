...
func (r *WeatherReportService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (res *WeatherReportQueryhelpResponse, err error) {
	opts = append(r.Options[:], opts...)
...
type WeatherReportQueryhelpResponse struct {
	AodrSupported         bool                                      `json:"aodrSupported"`
	ClassificationMarking string                                    `json:"classificationMarking"`
	Description           string                                    `json:"description"`
	HistorySupported      bool                                      `json:"historySupported"`
	Name                  string                                    `json:"name"`
	Parameters            []WeatherReportQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r WeatherReportQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *WeatherReportQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type WeatherReportQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r WeatherReportQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *WeatherReportQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
