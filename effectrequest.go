...
type EffectRequestQueryHelpResponse struct {
	...
	Parameters            []EffectRequestQueryHelpResponseParameter `json:"parameters"`
...
type EffectRequestQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r EffectRequestQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *EffectRequestQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
