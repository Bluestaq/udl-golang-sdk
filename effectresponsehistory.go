...
type EffectResponseHistoryListResponse struct {
	...
	ActionsList []EffectResponseHistoryListResponseActionsList `json:"actionsList"`
	...
	CoaMetrics []EffectResponseHistoryListResponseCoaMetric `json:"coaMetrics"`
...
type EffectResponseHistoryListResponseActionsList struct {
	// The record ID, depending on the type identified in actorSrcType, of the
	...
	ActionMetrics []EffectResponseHistoryListResponseActionsListActionMetric `json:"actionMetrics"`
...
// Returns the unmodified JSON received from the API
func (r EffectResponseHistoryListResponseActionsList) RawJSON() string { return r.JSON.raw }
func (r *EffectResponseHistoryListResponseActionsList) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type EffectResponseHistoryListResponseActionsListActionMetric struct {
...
// Returns the unmodified JSON received from the API
func (r EffectResponseHistoryListResponseActionsListActionMetric) RawJSON() string { return r.JSON.raw }
func (r *EffectResponseHistoryListResponseActionsListActionMetric) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type EffectResponseHistoryListResponseCoaMetric struct {
	// The metric score specific to its domain.
	DomainValue float64 `json:"domainValue"`
	// The type of the metric (e.g. CollateralDamage, GoalAchievement, OpportunityCost,
	// Timeliness, Unavailable, etc.).
...
// Returns the unmodified JSON received from the API
func (r EffectResponseHistoryListResponseCoaMetric) RawJSON() string { return r.JSON.raw }
func (r *EffectResponseHistoryListResponseCoaMetric) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
