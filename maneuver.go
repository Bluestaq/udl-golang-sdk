...
// parameter.
func (r *ManeuverService) Get(ctx context.Context, id string, query ManeuverGetParams, opts ...option.RequestOption) (res *ManeuverFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
...
// hours ago.
func (r *ManeuverService) Tuple(ctx context.Context, query ManeuverTupleParams, opts ...option.RequestOption) (res *[]ManeuverFull, err error) {
	opts = append(r.Options[:], opts...)
