...
type ManeuverListResponse struct {
	...
	DataMode ManeuverListResponseDataMode `json:"dataMode" api:"required"`
...
type ManeuverGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ManeuverGetResponseDataMode `json:"dataMode" api:"required"`
	// Maneuver event start time in ISO 8601 UTC with microsecond precision. For
	// maneuvers without start and end times, the start time is considered to be the
	// maneuver event time.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
...
type ManeuverTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ManeuverTupleResponseDataMode `json:"dataMode" api:"required"`
	// Maneuver event start time in ISO 8601 UTC with microsecond precision. For
	// maneuvers without start and end times, the start time is considered to be the
	// maneuver event time.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
...
type ManeuverNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode ManeuverNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Maneuver event start time in ISO 8601 UTC with microsecond precision. For
	// maneuvers without start and end times, the start time is considered to be the
	// maneuver event time.
	EventStartTime time.Time `json:"eventStartTime" api:"required" format:"date-time"`
