...
type ManeuverQueryhelpResponse struct {
	...
	Parameters            []ManeuverQueryhelpResponseParameter `json:"parameters"`
...
type ManeuverQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ManeuverQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ManeuverQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
