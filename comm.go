...
type CommAbridged struct {
	...
	DataMode CommAbridgedDataMode `json:"dataMode" api:"required"`
...
type CommAbridgedParam struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CommAbridgedDataMode `json:"dataMode,omitzero" api:"required"`
	// Name of the Comm entity.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
...
type CommNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode CommNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Name of the Comm entity.
	Name string `json:"name" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
