...
// the [NewBeamService] method instead.
type BeamService struct {
	Options []option.RequestOption
}

// NewBeamService generates a new service that applies the given options to each
// request. These options are applied after the parent client's options (if there
// is one), and before any request-specific options.
func NewBeamService(opts ...option.RequestOption) (r BeamService) {
	r = BeamService{}
	r.Options = opts
	return
}
...
// parameter.
func (r *BeamService) Get(ctx context.Context, id string, query BeamGetParams, opts ...option.RequestOption) (res *BeamFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
		err = errors.New("missing required id parameter")
		return
	}
	path := fmt.Sprintf("udl/beam/%s", id)
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *BeamService) ListAutoPaging(ctx context.Context, query BeamListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[BeamAbridged] {
...
// hours ago.
func (r *BeamService) Tuple(ctx context.Context, query BeamTupleParams, opts ...option.RequestOption) (res *[]BeamFull, err error) {
	opts = append(r.Options[:], opts...)
	path := "udl/beam/tuple"
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, query, &res, opts...)
	return
...
type BeamAbridged struct {
	...
	DataMode BeamAbridgedDataMode `json:"dataMode,required"`
	// Source of the data.
...
func (r BeamAbridged) RawJSON() string { return r.JSON.raw }
func (r *BeamAbridged) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type BeamAbridgedDataMode string

const (
	BeamAbridgedDataModeReal      BeamAbridgedDataMode = "REAL"
	BeamAbridgedDataModeTest      BeamAbridgedDataMode = "TEST"
	BeamAbridgedDataModeSimulated BeamAbridgedDataMode = "SIMULATED"
	BeamAbridgedDataModeExercise  BeamAbridgedDataMode = "EXERCISE"
)
...
type BeamQueryHelpResponse struct {
	AodrSupported         bool                             `json:"aodrSupported"`
	ClassificationMarking string                           `json:"classificationMarking"`
	Description           string                           `json:"description"`
	HistorySupported      bool                             `json:"historySupported"`
	Name                  string                           `json:"name"`
	Parameters            []BeamQueryHelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r BeamQueryHelpResponse) RawJSON() string { return r.JSON.raw }
func (r *BeamQueryHelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type BeamQueryHelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r BeamQueryHelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *BeamQueryHelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type BeamNewParams struct {
	// The antenna beam ID of the particular beam for this channel. beamName is not
	// unique across payloads.
	BeamName string `json:"beamName,required"`
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BeamNewParamsDataMode `json:"dataMode,omitzero,required"`
	// Source of the data.
	Source string `json:"source,required"`
	// Unique identifier of the record, auto-generated by the system.
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type BeamNewParamsDataMode string

const (
	BeamNewParamsDataModeReal      BeamNewParamsDataMode = "REAL"
	BeamNewParamsDataModeTest      BeamNewParamsDataMode = "TEST"
	BeamNewParamsDataModeSimulated BeamNewParamsDataMode = "SIMULATED"
	BeamNewParamsDataModeExercise  BeamNewParamsDataMode = "EXERCISE"
)

type BeamGetParams struct {
...
type BeamUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode BeamUpdateParamsDataMode `json:"dataMode,omitzero,required"`
	// Source of the data.
	Source string `json:"source,required"`
	// Unique identifier of the record, auto-generated by the system.
	ID param.Opt[string] `json:"id,omitzero"`
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type BeamUpdateParamsDataMode string

const (
	BeamUpdateParamsDataModeReal      BeamUpdateParamsDataMode = "REAL"
	BeamUpdateParamsDataModeTest      BeamUpdateParamsDataMode = "TEST"
	BeamUpdateParamsDataModeSimulated BeamUpdateParamsDataMode = "SIMULATED"
	BeamUpdateParamsDataModeExercise  BeamUpdateParamsDataMode = "EXERCISE"
)

type BeamListParams struct {
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
	MaxResults  param.Opt[int64] `query:"maxResults,omitzero" json:"-"`
	paramObj
}
