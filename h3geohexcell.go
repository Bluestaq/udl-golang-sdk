...
type H3GeoHexCellListResponse struct {
	...
	DataMode H3GeoHexCellListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type H3GeoHexCellTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode H3GeoHexCellTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type H3GeoHexCellListParams struct {
	...
	IDH3Geo     string           `query:"idH3Geo" api:"required" json:"-"`
