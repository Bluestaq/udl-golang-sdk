...
func (r *LinkStatusHistoryService) List(ctx context.Context, query LinkStatusHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[LinkStatusFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *LinkStatusHistoryService) ListAutoPaging(ctx context.Context, query LinkStatusHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[LinkStatusFull] {
