...
type OnorbiteventListResponse struct {
	...
	DataMode OnorbiteventListResponseDataMode `json:"dataMode" api:"required"`
...
type OnorbiteventGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbiteventGetResponseDataMode `json:"dataMode" api:"required"`
	// Date/Time of the event. See eventTimeNotes for remarks on the accuracy of the
	// date time.
	EventTime time.Time `json:"eventTime" api:"required" format:"date-time"`
	// Source of the data.
...
type OnorbiteventTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbiteventTupleResponseDataMode `json:"dataMode" api:"required"`
	// Date/Time of the event. See eventTimeNotes for remarks on the accuracy of the
	// date time.
	EventTime time.Time `json:"eventTime" api:"required" format:"date-time"`
	// Source of the data.
...
type OnorbiteventNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbiteventNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Date/Time of the event. See eventTimeNotes for remarks on the accuracy of the
	// date time.
	EventTime time.Time `json:"eventTime" api:"required" format:"date-time"`
	// Source of the data.
...
type OnorbiteventUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbiteventUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Date/Time of the event. See eventTimeNotes for remarks on the accuracy of the
	// date time.
	EventTime time.Time `json:"eventTime" api:"required" format:"date-time"`
	// Source of the data.
