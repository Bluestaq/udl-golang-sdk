...
type EmireportGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EmireportGetResponseDataMode `json:"dataMode" api:"required"`
	// Flag indicating whether the affected mission is an ISR mission.
	Isr bool `json:"isr" api:"required"`
	// User generated report identifier. This ID should remain the same on subsequent
	// updates to this report.
...
type EmireportTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EmireportTupleResponseDataMode `json:"dataMode" api:"required"`
	// Flag indicating whether the affected mission is an ISR mission.
	Isr bool `json:"isr" api:"required"`
	// User generated report identifier. This ID should remain the same on subsequent
	// updates to this report.
...
type EmireportNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode EmireportNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Flag indicating whether the affected mission is an ISR mission.
	Isr bool `json:"isr" api:"required"`
	// User generated report identifier. This ID should remain the same on subsequent
	// updates to this report.
...
type EmireportListParams struct {
	...
	ReportTime  time.Time        `query:"reportTime" api:"required" format:"date-time" json:"-"`
