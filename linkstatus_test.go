...
func TestLinkStatusNewWithOptionalParams(t *testing.T) {
	...
	err := client.LinkStatus.New(context.TODO(), unifieddatalibrary.LinkStatusNewParams{
		ClassificationMarking: "U",
		DataMode:              unifieddatalibrary.LinkStatusNewParamsDataModeTest,
		EndPoint1Lat:          45.23,
		EndPoint1Lon:          80.23,
...
func TestLinkStatusListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.LinkStatus.List(context.TODO(), unifieddatalibrary.LinkStatusListParams{
		CreatedAt:     unifieddatalibrary.Time(time.Now()),
...
func TestLinkStatusCountWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.LinkStatus.Count(context.TODO(), unifieddatalibrary.LinkStatusCountParams{
		CreatedAt:     unifieddatalibrary.Time(time.Now()),
		FirstResult:   unifieddatalibrary.Int(0),
		LinkStartTime: unifieddatalibrary.Time(time.Now()),
		LinkStopTime:  unifieddatalibrary.Time(time.Now()),
...
func TestLinkStatusGetWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.LinkStatus.Get(
		context.TODO(),
		"id",
		unifieddatalibrary.LinkStatusGetParams{
			FirstResult: unifieddatalibrary.Int(0),
			MaxResults:  unifieddatalibrary.Int(0),
		},
	)
...
func TestLinkStatusQueryhelp(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestLinkStatusTupleWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.LinkStatus.Tuple(context.TODO(), unifieddatalibrary.LinkStatusTupleParams{
		Columns:       "columns",
		CreatedAt:     unifieddatalibrary.Time(time.Now()),
		FirstResult:   unifieddatalibrary.Int(0),
		LinkStartTime: unifieddatalibrary.Time(time.Now()),
