...
type SubstatusListResponse struct {
	...
	DataMode SubstatusListResponseDataMode `json:"dataMode" api:"required"`
	...
	Status SubstatusListResponseStatus `json:"status" api:"required"`
	...
	Type SubstatusListResponseType `json:"type" api:"required"`
