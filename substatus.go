...
type SubstatusQueryhelpResponse struct {
	AodrSupported         bool                                  `json:"aodrSupported"`
	ClassificationMarking string                                `json:"classificationMarking"`
	Description           string                                `json:"description"`
	HistorySupported      bool                                  `json:"historySupported"`
	Name                  string                                `json:"name"`
	Parameters            []SubstatusQueryhelpResponseParameter `json:"parameters"`
...
// Returns the unmodified JSON received from the API
func (r SubstatusQueryhelpResponse) RawJSON() string { return r.JSON.raw }
func (r *SubstatusQueryhelpResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type SubstatusQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SubstatusQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SubstatusQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
