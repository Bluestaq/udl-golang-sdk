...
func TestAirOperationDiplomaticClearanceUnvalidatedPublish(t *testing.T) {
	...
	err := client.AirOperations.DiplomaticClearance.UnvalidatedPublish(context.TODO(), unifieddatalibrary.AirOperationDiplomaticClearanceUnvalidatedPublishParams{
		Body: []unifieddatalibrary.AirOperationDiplomaticClearanceUnvalidatedPublishParamsBody{{
			...
			DiplomaticClearanceDetails: []unifieddatalibrary.AirOperationDiplomaticClearanceUnvalidatedPublishParamsBodyDiplomaticClearanceDetail{{
			...
			DiplomaticClearanceRemarks: []unifieddatalibrary.AirOperationDiplomaticClearanceUnvalidatedPublishParamsBodyDiplomaticClearanceRemark{{
