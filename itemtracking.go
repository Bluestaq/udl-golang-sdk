...
// as a path parameter.
func (r *ItemTrackingService) Get(ctx context.Context, id string, query ItemTrackingGetParams, opts ...option.RequestOption) (res *ItemTrackingFull, err error) {
	opts = append(r.Options[:], opts...)
	if id == "" {
		err = errors.New("missing required id parameter")
		return
...
func (r *ItemTrackingService) Queryhelp(ctx context.Context, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
	opts = append([]option.RequestOption{option.WithHeader("Accept", "")}, opts...)
...
// hours ago.
func (r *ItemTrackingService) Tuple(ctx context.Context, query ItemTrackingTupleParams, opts ...option.RequestOption) (res *[]ItemTrackingFull, err error) {
	opts = append(r.Options[:], opts...)
