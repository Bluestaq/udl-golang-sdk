...
type ItemTrackingQueryhelpResponse struct {
	...
	Parameters            []ItemTrackingQueryhelpResponseParameter `json:"parameters"`
...
type ItemTrackingQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r ItemTrackingQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *ItemTrackingQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
