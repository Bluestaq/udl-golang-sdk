...
type SeraDataNavigationListResponse struct {
	...
	DataMode SeraDataNavigationListResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
...
type SeraDataNavigationGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeraDataNavigationGetResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeraDataNavigationTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeraDataNavigationTupleResponseDataMode `json:"dataMode" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeraDataNavigationNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeraDataNavigationNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
...
type SeraDataNavigationUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode SeraDataNavigationUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Seradata ID of the spacecraft (SeradataSpacecraftDetails ID).
	SpacecraftID string `json:"spacecraftId" api:"required"`
