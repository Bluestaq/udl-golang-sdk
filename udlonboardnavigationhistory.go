...
// UdlOnboardnavigationHistoryService contains methods and other services that help
// with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlOnboardnavigationHistoryService] method instead.
type UdlOnboardnavigationHistoryService struct {
	Options []option.RequestOption
}

// NewUdlOnboardnavigationHistoryService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewUdlOnboardnavigationHistoryService(opts ...option.RequestOption) (r UdlOnboardnavigationHistoryService) {
	r = UdlOnboardnavigationHistoryService{}
	r.Options = opts
	return
}
...
func (r *UdlOnboardnavigationHistoryService) List(ctx context.Context, query UdlOnboardnavigationHistoryListParams, opts ...option.RequestOption) (res *pagination.OffsetPage[OnboardnavigationFull], err error) {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *UdlOnboardnavigationHistoryService) ListAutoPaging(ctx context.Context, query UdlOnboardnavigationHistoryListParams, opts ...option.RequestOption) *pagination.OffsetPageAutoPager[OnboardnavigationFull] {
...
// (/udl/&lt;datatype&gt;/queryhelp) for more details on valid/required query
// parameter information.
func (r *UdlOnboardnavigationHistoryService) Aodr(ctx context.Context, query UdlOnboardnavigationHistoryAodrParams, opts ...option.RequestOption) (err error) {
	opts = append(r.Options[:], opts...)
...
func (r *UdlOnboardnavigationHistoryService) Count(ctx context.Context, query UdlOnboardnavigationHistoryCountParams, opts ...option.RequestOption) (res *string, err error) {
	opts = append(r.Options[:], opts...)
...
type UdlOnboardnavigationHistoryListParams struct {
	// Start time of the sensor data, in ISO 8601 UTC format.
...
func (f UdlOnboardnavigationHistoryListParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

// URLQuery serializes [UdlOnboardnavigationHistoryListParams]'s query parameters
// as `url.Values`.
func (r UdlOnboardnavigationHistoryListParams) URLQuery() (v url.Values, err error) {
...
type UdlOnboardnavigationHistoryAodrParams struct {
	// Start time of the sensor data, in ISO 8601 UTC format.
	// (YYYY-MM-DDTHH:MM:SS.ssssssZ)
	StartTime time.Time `query:"startTime,required" format:"date-time" json:"-"`
	// optional, fields for retrieval. When omitted, ALL fields are assumed. See the
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f UdlOnboardnavigationHistoryAodrParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

// URLQuery serializes [UdlOnboardnavigationHistoryAodrParams]'s query parameters
// as `url.Values`.
func (r UdlOnboardnavigationHistoryAodrParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
...
type UdlOnboardnavigationHistoryCountParams struct {
	// Start time of the sensor data, in ISO 8601 UTC format.
	// (YYYY-MM-DDTHH:MM:SS.ssssssZ)
	StartTime   time.Time        `query:"startTime,required" format:"date-time" json:"-"`
	FirstResult param.Opt[int64] `query:"firstResult,omitzero" json:"-"`
...
// IsPresent returns true if the field's value is not omitted and not the JSON
// "null". To check if this field is omitted, use [param.IsOmitted].
func (f UdlOnboardnavigationHistoryCountParams) IsPresent() bool {
	return !param.IsOmitted(f) && !f.IsNull()
}

// URLQuery serializes [UdlOnboardnavigationHistoryCountParams]'s query parameters
// as `url.Values`.
func (r UdlOnboardnavigationHistoryCountParams) URLQuery() (v url.Values, err error) {
	return apiquery.MarshalWithSettings(r, apiquery.QuerySettings{
		ArrayFormat:  apiquery.ArrayQueryFormatComma,
		NestedFormat: apiquery.NestedQueryFormatBrackets,
	})
