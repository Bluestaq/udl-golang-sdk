...
type SurfaceObstructionQueryhelpResponse struct {
	...
	Parameters            []SurfaceObstructionQueryhelpResponseParameter `json:"parameters"`
...
type SurfaceObstructionQueryhelpResponseParameter struct {
	ClassificationMarking string `json:"classificationMarking"`
...
// Returns the unmodified JSON received from the API
func (r SurfaceObstructionQueryhelpResponseParameter) RawJSON() string { return r.JSON.raw }
func (r *SurfaceObstructionQueryhelpResponseParameter) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
