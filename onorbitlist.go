...
type OnorbitlistListResponse struct {
	...
	DataMode OnorbitlistListResponseDataMode `json:"dataMode" api:"required"`
...
type OnorbitlistGetResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitlistGetResponseDataMode `json:"dataMode" api:"required"`
	// Unique name of the list.
	Name string `json:"name" api:"required"`
	// This is a list of onOrbitListItems that will be related one-to-one with an
	// onOrbit entry.
	OnOrbitListItems []OnorbitlistGetResponseOnOrbitListItem `json:"onOrbitListItems" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type OnorbitlistTupleResponse struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitlistTupleResponseDataMode `json:"dataMode" api:"required"`
	// Unique name of the list.
	Name string `json:"name" api:"required"`
	// This is a list of onOrbitListItems that will be related one-to-one with an
	// onOrbit entry.
	OnOrbitListItems []OnorbitlistTupleResponseOnOrbitListItem `json:"onOrbitListItems" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID string `json:"id"`
...
type OnorbitlistNewParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitlistNewParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique name of the list.
	Name string `json:"name" api:"required"`
	// This is a list of onOrbitListItems that will be related one-to-one with an
	// onOrbit entry.
	OnOrbitListItems []OnorbitlistNewParamsOnOrbitListItem `json:"onOrbitListItems,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
...
type OnorbitlistUpdateParams struct {
	...
	//
	// Any of "REAL", "TEST", "SIMULATED", "EXERCISE".
	DataMode OnorbitlistUpdateParamsDataMode `json:"dataMode,omitzero" api:"required"`
	// Unique name of the list.
	Name string `json:"name" api:"required"`
	// This is a list of onOrbitListItems that will be related one-to-one with an
	// onOrbit entry.
	OnOrbitListItems []OnorbitlistUpdateParamsOnOrbitListItem `json:"onOrbitListItems,omitzero" api:"required"`
	// Source of the data.
	Source string `json:"source" api:"required"`
	// Unique identifier of the record, auto-generated by the system.
	ID param.Opt[string] `json:"id,omitzero"`
