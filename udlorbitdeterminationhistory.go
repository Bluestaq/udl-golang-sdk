...
// UdlOrbitdeterminationHistoryService contains methods and other services that
// help with interacting with the unifieddatalibrary API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewUdlOrbitdeterminationHistoryService] method instead.
type UdlOrbitdeterminationHistoryService struct {
	Options []option.RequestOption
}

// NewUdlOrbitdeterminationHistoryService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewUdlOrbitdeterminationHistoryService(opts ...option.RequestOption) (r UdlOrbitdeterminationHistoryService) {
	r = UdlOrbitdeterminationHistoryService{}
	r.Options = opts
	return
}
...
type OrbitdeterminationFull struct {
	...
	DataMode OrbitdeterminationFullDataMode `json:"dataMode,required"`
	...
	AprioriElset OrbitdeterminationFullAprioriElset `json:"aprioriElset"`
	...
	// provider.
	AprioriStateVector OrbitdeterminationFullAprioriStateVector `json:"aprioriStateVector"`
...
func (r OrbitdeterminationFull) RawJSON() string { return r.JSON.raw }
func (r *OrbitdeterminationFull) UnmarshalJSON(data []byte) error {
...
// requirements, and for validating technical, functional, and performance
// characteristics.
type OrbitdeterminationFullDataMode string

const (
	OrbitdeterminationFullDataModeReal      OrbitdeterminationFullDataMode = "REAL"
	OrbitdeterminationFullDataModeTest      OrbitdeterminationFullDataMode = "TEST"
	OrbitdeterminationFullDataModeSimulated OrbitdeterminationFullDataMode = "SIMULATED"
	OrbitdeterminationFullDataModeExercise  OrbitdeterminationFullDataMode = "EXERCISE"
)
...
// order to predict the motion of a satellite. The element set, or elset for short,
// consists of identification data, the classical elements and drag parameters.
type OrbitdeterminationFullAprioriElset struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r OrbitdeterminationFullAprioriElset) RawJSON() string { return r.JSON.raw }
func (r *OrbitdeterminationFullAprioriElset) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// the 'Discover' tab in the storefront to confirm coordinate frames by data
// provider.
type OrbitdeterminationFullAprioriStateVector struct {
	// Classification marking of the data in IC/CAPCO Portion-marked format.
	ClassificationMarking string `json:"classificationMarking,required"`
	// Indicator of whether the data is EXERCISE, REAL, SIMULATED, or TEST data:
	//
...
// Returns the unmodified JSON received from the API
func (r OrbitdeterminationFullAprioriStateVector) RawJSON() string { return r.JSON.raw }
func (r *OrbitdeterminationFullAprioriStateVector) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
